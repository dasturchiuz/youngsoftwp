...
!function (e) {
    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        var a = !1, s = {
            ...
            TRANSITION_END: "bsTransitionEnd", getUID: function (e) {
                ...
                for (var r in o)if (o.hasOwnProperty(r)) {
                    var a = o[r], s = i[r], l = s && n(s) ? "element" : t(s);
                    if (!new RegExp(a).test(l))throw new Error(e.toUpperCase() + ': Option "' + r + '" provided type "' + l + '" but expected type "' + a + '".')
                }
            }
        };
        return function () {
            a = o(), e.fn.emulateTransitionEnd = r, l.supportsTransitionEnd() && (e.event.special[l.TRANSITION_END] = i())
        }(), l
    }(jQuery), a = (function (e) {
        var t = "alert", i = e.fn[t], a = {DISMISS: '[data-dismiss="alert"]'}, s = {
            CLOSE: "close.bs.alert",
            CLOSED: "closed.bs.alert",
            CLICK_DATA_API: "click.bs.alert.data-api"
        }, l = {ALERT: "alert", FADE: "fade", SHOW: "show"}, u = function () {
            function t(e) {
            ...
            return t.prototype.close = function (e) {
                ...
                var n = this;
                if (e(t).removeClass(l.SHOW), !r.supportsTransitionEnd() || !e(t).hasClass(l.FADE))return void this._destroyElement(t);
        ...
        e(document).on(s.CLICK_DATA_API, a.DISMISS, u._handleDismiss(new u)), e.fn[t] = u._jQueryInterface, e.fn[t].Constructor = u, e.fn[t].noConflict = function () {
            return e.fn[t] = i, u._jQueryInterface
        }, u
    }(jQuery), function (e) {
        var t = "button", i = e.fn[t], r = {
            ACTIVE: "active",
            BUTTON: "btn",
            FOCUS: "focus"
        }, a = {
            ...
            return t.prototype.toggle = function () {
                var t = !0, n = !0, i = e(this._element).closest(a.DATA_TOGGLE)[0];
                if (i) {
                    var o = e(this._element).find(a.INPUT)[0];
                    if (o) {
                        if ("radio" === o.type)if (o.checked && e(this._element).hasClass(r.ACTIVE))t = !1; else {
        ...
        e(document).on(s.CLICK_DATA_API, a.DATA_TOGGLE_CARROT, function (t) {
            ...
            e(e(t.target).closest(a.BUTTON)[0]).toggleClass(r.FOCUS, /^focus(in)?$/.test(t.type))
        }), e.fn[t] = l._jQueryInterface, e.fn[t].Constructor = l, e.fn[t].noConflict = function () {
            return e.fn[t] = i, l._jQueryInterface
        }, l
    }(jQuery), function (e) {
        var t = "carousel", a = "bs.carousel", s = "." + a, l = e.fn[t], u = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            wrap: "boolean"
        }, d = {NEXT: "next", PREV: "prev", LEFT: "left", RIGHT: "right"}, f = {
            SLIDE: "slide" + s,
            SLID: "slid" + s,
            KEYDOWN: "keydown" + s,
            ...
            return l.prototype.next = function () {
                ...
                return n = e.extend({}, u, n), r.typeCheckConfig(t, n, c), n
                ...
                var n = e === d.NEXT, i = e === d.PREV, o = this._getItemIndex(t), r = this._items.length - 1;
                if ((i && 0 === o || n && o === r) && !this._config.wrap)return t;
                var a = e === d.PREV ? -1 : 1, s = (o + a) % this._items.length;
                return s === -1 ? this._items[this._items.length - 1] : this._items[s]
            }, l.prototype._triggerSlideEvent = function (t, n) {
                var i = this._getItemIndex(t), o = this._getItemIndex(e(this._element).find(p.ACTIVE_ITEM)[0]), r = e.Event(f.SLIDE, {
                    relatedTarget: t,
                    direction: n,
                    from: o,
                    to: i
                ...
                var i = this, o = e(this._element).find(p.ACTIVE_ITEM)[0], a = this._getItemIndex(o), s = n || o && this._getItemByDirection(t, o), l = this._getItemIndex(s), u = Boolean(this._interval), c = void 0, m = void 0, g = void 0;
                if (t === d.NEXT ? (c = h.LEFT, m = h.NEXT, g = d.LEFT) : (c = h.RIGHT, m = h.PREV, g = d.RIGHT), s && e(s).hasClass(h.ACTIVE))return void(this._isSliding = !1);
                if (!this._triggerSlideEvent(s, g).isDefaultPrevented() && o && s) {
                    this._isSliding = !0, u && this.pause(), this._setActiveIndicatorElement(s);
                    var v = e.Event(f.SLID, {relatedTarget: s, direction: g, from: a, to: l});
                    r.supportsTransitionEnd() && e(this._element).hasClass(h.SLIDE) ? (e(s).addClass(m), r.reflow(s), e(o).addClass(c), e(s).addClass(c), e(o).one(r.TRANSITION_END, function () {
                        e(s).removeClass(c + " " + m).addClass(h.ACTIVE), e(o).removeClass(h.ACTIVE + " " + m + " " + c), i._isSliding = !1, setTimeout(function () {
                            return e(i._element).trigger(v)
                        }, 0)
                    }).emulateTransitionEnd(600)) : (e(o).removeClass(h.ACTIVE), e(s).addClass(h.ACTIVE), this._isSliding = !1, e(this._element).trigger(v)), u && this.cycle()
                }
            }, l._jQueryInterface = function (t) {
                return this.each(function () {
                    var n = e(this).data(a), o = e.extend({}, u, e(this).data());
                ...
                if (n) {
                    ...
                    if (i && e(i).hasClass(h.CAROUSEL)) {
                        var o = e.extend({}, e(i).data(), e(this).data()), s = this.getAttribute("data-slide-to");
        ...
        e(document).on(f.CLICK_DATA_API, p.DATA_SLIDE, m._dataApiClickHandler), e(window).on(f.LOAD_DATA_API, function () {
        ...
        var t = "collapse", a = "bs.collapse", s = e.fn[t], l = {toggle: !0, parent: ""}, u = {
            toggle: "boolean",
            parent: "string"
        }, c = {
            SHOW: "show." + a,
            ...
            function s(t, i) {
                ...
                for (var o = e(h.DATA_TOGGLE), a = 0; a < o.length; a++) {
                    var l = o[a], u = r.getSelectorFromElement(l);
            ...
            return s.prototype.toggle = function () {
                ...
                if (!this._isTransitioning && !e(this._element).hasClass(d.SHOW)) {
                    ...
                    if (this._parent && (n = e.makeArray(e(this._parent).children().children(h.ACTIVES)), n.length || (n = null)), !(n && (i = e(n).data(a)) && i._isTransitioning)) {
                        ...
                        if (e(this._element).trigger(o), !o.isDefaultPrevented()) {
                            ...
                            var u = function () {
                                e(t._element).removeClass(d.COLLAPSING).addClass(d.COLLAPSE).addClass(d.SHOW), t._element.style[l] = "", t.setTransitioning(!1), e(t._element).trigger(c.SHOWN)
                            };
                            if (!r.supportsTransitionEnd())return void u();
                            var f = l[0].toUpperCase() + l.slice(1), p = "scroll" + f;
                            e(this._element).one(r.TRANSITION_END, u).emulateTransitionEnd(600), this._element.style[l] = this._element[p] + "px"
                        }
                    }
                }
                ...
                if (!this._isTransitioning && e(this._element).hasClass(d.SHOW)) {
                    ...
                    if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
                        ...
                        if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", r.reflow(this._element), e(this._element).addClass(d.COLLAPSING).removeClass(d.COLLAPSE).removeClass(d.SHOW), this._triggerArray.length)for (var o = 0; o < this._triggerArray.length; o++) {
                            var a = this._triggerArray[o], s = r.getSelectorFromElement(a);
                            if (null !== s) {
                                var l = e(s);
                                l.hasClass(d.SHOW) || e(a).addClass(d.COLLAPSED).attr("aria-expanded", !1)
                            }
                        }
                        ...
                        if (this._element.style[i] = "", !r.supportsTransitionEnd())return void u();
                        e(this._element).one(r.TRANSITION_END, u).emulateTransitionEnd(600)
                    }
                }
                ...
                return n = e.extend({}, l, n), n.toggle = Boolean(n.toggle), r.typeCheckConfig(t, n, u), n
                ...
                return this.each(function () {
                    var n = e(this), o = n.data(a), r = e.extend({}, l, n.data(), "object" === (void 0 === t ? "undefined" : i(t)) && t);
        ...
        e(document).on(c.CLICK_DATA_API, h.DATA_TOGGLE, function (t) {
            ...
            var n = e(this);
            e(r.getSelectorFromElement(this)).each(function () {
                var t = e(this), i = t.data(a), o = i ? "toggle" : n.data();
        ...
        var t = "dropdown", a = "bs.dropdown", s = "." + a, l = e.fn[t], u = new RegExp("38|40|27"), c = {
            HIDE: "hide" + s,
            HIDDEN: "hidden" + s,
            SHOW: "show" + s,
            SHOWN: "shown" + s,
        ...
        }, p = {placement: h.BOTTOM, offset: 0, flip: !0}, m = {
            placement: "string",
            ...
            return l.prototype.toggle = function () {
                if (!this._element.disabled && !e(this._element).hasClass(d.DISABLED)) {
                    var t = l._getParentFromElement(this._element), n = e(this._menu).hasClass(d.SHOW);
                    if (l._clearMenus(), !n) {
                        var i = {relatedTarget: this._element}, o = e.Event(c.SHOW, i);
                        if (e(t).trigger(o), !o.isDefaultPrevented()) {
                            var r = this._element;
                            e(t).hasClass(d.DROPUP) && (e(this._menu).hasClass(d.MENULEFT) || e(this._menu).hasClass(d.MENURIGHT)) && (r = t), this._popper = new Popper(r, this._menu, this._getPopperConfig()), "ontouchstart" in document.documentElement && !e(t).closest(f.NAVBAR_NAV).length && e("body").children().on("mouseover", null, e.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), e(this._menu).toggleClass(d.SHOW), e(t).toggleClass(d.SHOW).trigger(e.Event(c.SHOWN, i))
                        }
                    }
                }
            }, l.prototype.dispose = function () {
                ...
                return this.each(function () {
                    var n = e(this).data(a), o = "object" === (void 0 === t ? "undefined" : i(t)) ? t : null;
                ...
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))for (var n = e.makeArray(e(f.DATA_TOGGLE)), i = 0; i < n.length; i++) {
                    var o = l._getParentFromElement(n[i]), r = e(n[i]).data(a), s = {relatedTarget: n[i]};
                    if (r) {
                        var u = r._menu;
                        if (e(o).hasClass(d.SHOW) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && e.contains(o, t.target))) {
                            var h = e.Event(c.HIDE, s);
                            e(o).trigger(h), h.isDefaultPrevented() || ("ontouchstart" in document.documentElement && e("body").children().off("mouseover", null, e.noop), n[i].setAttribute("aria-expanded", "false"), e(u).removeClass(d.SHOW), e(o).removeClass(d.SHOW).trigger(e.Event(c.HIDDEN, s)))
                        }
                    }
                }
                ...
                if (!(!u.test(t.which) || /button/i.test(t.target.tagName) && 32 === t.which || /input|textarea/i.test(t.target.tagName) || (t.preventDefault(), t.stopPropagation(), this.disabled || e(this).hasClass(d.DISABLED)))) {
                    var n = l._getParentFromElement(this), i = e(n).hasClass(d.SHOW);
                    if (!i && (27 !== t.which || 32 !== t.which) || i && (27 === t.which || 32 === t.which)) {
                        if (27 === t.which) {
                            e(e(n).find(f.DATA_TOGGLE)[0]).trigger("focus")
                        }
                        return void e(this).trigger("click")
                    }
                    var o = e(n).find(f.VISIBLE_ITEMS).get();
                    if (o.length) {
        ...
        e(document).on(c.KEYDOWN_DATA_API, f.DATA_TOGGLE, g._dataApiKeydownHandler).on(c.KEYDOWN_DATA_API, f.MENU, g._dataApiKeydownHandler).on(c.CLICK_DATA_API + " " + c.KEYUP_DATA_API, g._clearMenus).on(c.CLICK_DATA_API, f.DATA_TOGGLE, function (t) {
            t.preventDefault(), t.stopPropagation(), g._jQueryInterface.call(e(this), "toggle")
        }).on(c.CLICK_DATA_API, f.FORM_CHILD, function (e) {
            e.stopPropagation()
        }), e.fn[t] = g._jQueryInterface, e.fn[t].Constructor = g, e.fn[t].noConflict = function () {
            return e.fn[t] = l, g._jQueryInterface
        }, g
    }(jQuery), function (e) {
        var t = "modal", a = ".bs.modal", s = e.fn[t], l = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
            ...
            function s(t, i) {
                n(this, s), this._config = this._getConfig(i), this._element = t, this._dialog = e(t).find(f.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0
            }
            ...
            return s.prototype.toggle = function (e) {
                ...
                if (!this._isTransitioning) {
                    ...
                    e(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), e(document.body).addClass(d.OPEN), this._setEscapeEvent(), this._setResizeEvent(), e(this._element).on(c.CLICK_DISMISS, f.DATA_DISMISS, function (e) {
                        return n.hide(e)
                ...
                if (t && t.preventDefault(), !this._isTransitioning && this._isShown) {
                    ...
                    e(this._element).trigger(o), this._isShown && !o.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), e(document).off(c.FOCUSIN), e(this._element).removeClass(d.SHOW), e(this._element).off(c.CLICK_DISMISS), e(this._dialog).off(c.MOUSEDOWN_DISMISS), i ? e(this._element).one(r.TRANSITION_END, function (e) {
                ...
                return n = e.extend({}, l, n), r.typeCheckConfig(t, n, u), n
            }, s.prototype._showElement = function (t) {
                var n = this, i = r.supportsTransitionEnd() && e(this._element).hasClass(d.FADE);
                ...
                var o = e.Event(c.SHOWN, {relatedTarget: t}), a = function () {
                ...
                var n = this, i = e(this._element).hasClass(d.FADE) ? d.FADE : "";
                if (this._isShown && this._config.backdrop) {
                    var o = r.supportsTransitionEnd() && i;
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = d.BACKDROP, i && e(this._backdrop).addClass(i), e(this._backdrop).appendTo(document.body), e(this._element).on(c.CLICK_DISMISS, function (e) {
                ...
                }), e(f.NAVBAR_TOGGLER).each(function (t, n) {
                ...
                return this.each(function () {
                    var o = e(this).data("bs.modal"), r = e.extend({}, s.Default, e(this).data(), "object" === (void 0 === t ? "undefined" : i(t)) && t);
        ...
        var t = "scrollspy", a = e.fn[t], s = {offset: 10, method: "auto", target: ""}, l = {
            offset: "number",
            method: "string",
        ...
        }, f = {OFFSET: "offset", POSITION: "position"}, h = function () {
            function a(t, i) {
                var o = this;
            ...
            return a.prototype.refresh = function () {
                var t = this, n = this._scrollElement !== this._scrollElement.window ? f.POSITION : f.OFFSET, i = "auto" === this._config.method ? n : this._config.method, o = i === f.POSITION ? this._getScrollTop() : 0;
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), e.makeArray(e(this._selector)).map(function (t) {
                    var n = void 0, a = r.getSelectorFromElement(t);
                    if (a && (n = e(a)[0]), n) {
                ...
                var i = e(n.join(","));
                i.hasClass(c.DROPDOWN_ITEM) ? (i.closest(d.DROPDOWN).find(d.DROPDOWN_TOGGLE).addClass(c.ACTIVE), i.addClass(c.ACTIVE)) : (i.addClass(c.ACTIVE), i.parents(d.NAV_LIST_GROUP).prev(d.NAV_LINKS + ", " + d.LIST_ITEMS).addClass(c.ACTIVE)), e(this._scrollElement).trigger(u.ACTIVATE, {relatedTarget: t})
            }, a.prototype._clear = function () {
                e(this._selector).filter(d.ACTIVE).removeClass(c.ACTIVE)
            }, a._jQueryInterface = function (t) {
                return this.each(function () {
                    var n = e(this).data("bs.scrollspy"), o = "object" === (void 0 === t ? "undefined" : i(t)) && t;
        ...
        var t = e.fn.tab, i = {
            ...
            return t.prototype.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(a.ACTIVE) || e(this._element).hasClass(a.DISABLED))) {
                    var n = void 0, o = void 0, l = e(this._element).closest(s.NAV_LIST_GROUP)[0], u = r.getSelectorFromElement(this._element);
                    l && (o = e.makeArray(e(l).find(s.ACTIVE)), o = o[o.length - 1]);
                    var c = e.Event(i.HIDE, {relatedTarget: this._element}), d = e.Event(i.SHOW, {relatedTarget: o});
                    if (o && e(o).trigger(c), e(this._element).trigger(d), !d.isDefaultPrevented() && !c.isDefaultPrevented()) {
                        u && (n = e(u)[0]), this._activate(this._element, l);
                        var f = function () {
                            var n = e.Event(i.HIDDEN, {relatedTarget: t._element}), r = e.Event(i.SHOWN, {relatedTarget: o});
                ...
                var o = this, l = e(n).find(s.ACTIVE)[0], u = i && r.supportsTransitionEnd() && l && e(l).hasClass(a.FADE), c = function () {
                    return o._transitionComplete(t, l, u, i)
                };
                l && u ? e(l).one(r.TRANSITION_END, c).emulateTransitionEnd(150) : c(), l && e(l).removeClass(a.SHOW)
                ...
                if (e(t).addClass(a.ACTIVE), t.setAttribute("aria-expanded", !0), i ? (r.reflow(t), e(t).addClass(a.SHOW)) : e(t).removeClass(a.FADE), t.parentNode && e(t.parentNode).hasClass(a.DROPDOWN_MENU)) {
                    ...
                    u && e(u).find(s.DROPDOWN_TOGGLE).addClass(a.ACTIVE), t.setAttribute("aria-expanded", !0)
                }
                o && o()
            }, t._jQueryInterface = function (n) {
                return this.each(function () {
        ...
        var t = "tooltip", a = ".bs.tooltip", s = e.fn[t], l = new RegExp("(^|\\s)bs-tooltip\\S+", "g"), u = {
            animation: "boolean",
            template: "string",
            ...
            return s.prototype.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var c = this.config.container === !1 ? document.body : e(this.config.container);
                ...
                var n = this, i = this.getTipElement(), o = e.Event(this.constructor.Event.HIDE), a = function () {
                    n._hoverState !== f.SHOW && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), e(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), t && t()
                };
                ...
                this.config.trigger.split(" ").forEach(function (n) {
                    if ("click" === n)e(t.element).on(t.constructor.Event.CLICK, t.config.selector, function (e) {
                        ...
                        var i = n === g.HOVER ? t.constructor.Event.MOUSEENTER : t.constructor.Event.FOCUSIN, o = n === g.HOVER ? t.constructor.Event.MOUSELEAVE : t.constructor.Event.FOCUSOUT;
                ...
                var i = this.constructor.DATA_KEY;
                if (n = n || e(t.currentTarget).data(i), n || (n = new this.constructor(t.currentTarget, this._getDelegateConfig()), e(t.currentTarget).data(i, n)), t && (n._activeTrigger["focusout" === t.type ? g.FOCUS : g.HOVER] = !1), !n._isWithActiveTrigger()) {
                ...
                return this.each(function () {
                    var n = e(this).data("bs.tooltip"), o = "object" === (void 0 === t ? "undefined" : i(t)) && t;
    ...
    !function (r) {
        var s = "popover", l = ".bs.popover", u = r.fn[s], c = new RegExp("(^|\\s)bs-popover\\S+", "g"), d = r.extend({}, a.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), f = r.extend({}, a.DefaultType, {content: "(string|element|function)"}), h = {
            FADE: "fade",
            SHOW: "show"
        }, p = {TITLE: ".popover-header", CONTENT: ".popover-body"}, m = {
            HIDE: "hide" + l,
            HIDDEN: "hidden" + l,
            SHOW: "show" + l,
            SHOWN: "shown" + l,
            ...
            return t(u, a), u.prototype.isWithContent = function () {
                ...
                this.setElementContent(e.find(p.TITLE), this.getTitle()), this.setElementContent(e.find(p.CONTENT), this._getContent()), e.removeClass(h.FADE + " " + h.SHOW)
            }, u.prototype._getContent = function () {
                return this.element.getAttribute("data-content") || ("function" == typeof this.config.content ? this.config.content.call(this.element) : this.config.content)
            }, u.prototype._cleanTipClass = function () {
                var e = r(this.getTipElement()), t = e.attr("class").match(c);
                null !== t && t.length > 0 && e.removeClass(t.join(""))
            }, u._jQueryInterface = function (e) {
                return this.each(function () {
                    var t = r(this).data("bs.popover"), n = "object" === (void 0 === e ? "undefined" : i(e)) ? e : null;
                    if ((t || !/destroy|hide/.test(e)) && (t || (t = new u(this, n), r(this).data("bs.popover", t)), "string" == typeof e)) {
        ...
        r.fn[s] = g._jQueryInterface, r.fn[s].Constructor = g, r.fn[s].noConflict = function () {
            return r.fn[s] = u, g._jQueryInterface
        }, g
    }(jQuery)
    ...
    return function (e, t, n, i) {
        ...
        function l(e, n, i, o) {
            ...
            function h(t) {
                ...
                --o;
                var a = (t - k[o]) / (k[o + 1] - k[o]), s = n + a * x, l = u(s, e, i);
            ...
            var m = 4, g = .001, v = 1e-7, y = 10, b = 11, x = 1 / (b - 1), w = "Float32Array" in t;
            if (4 !== arguments.length)return !1;
            for (var C = 0; 4 > C; ++C)if ("number" != typeof arguments[C] || isNaN(arguments[C]) || !isFinite(arguments[C]))return !1;
            e = Math.min(e, 1), i = Math.min(i, 1), e = Math.max(e, 0), i = Math.max(i, 0);
            var k = w ? new Float32Array(b) : new Array(b), T = !1, _ = function (t) {
                return T || p(), e === n && i === o ? t : 0 === t ? 0 : 1 === t ? 1 : l(h(t), n, o)
            };
        ...
        function d(e, t) {
            ...
            for (var n = b.State.calls[e][0], o = b.State.calls[e][1], r = b.State.calls[e][2], s = b.State.calls[e][4], l = !1, u = 0, c = n.length; c > u; u++) {
                var d = n[u].element;
                if (t || r.loop || ("none" === r.display && w.setPropertyValue(d, "display", r.display), "hidden" === r.visibility && w.setPropertyValue(d, "visibility", r.visibility)), r.loop !== !0 && (f.queue(d)[1] === i || !/\.velocityQueueEntryFlag/i.test(f.queue(d)[1])) && a(d)) {
                    a(d).isAnimating = !1, a(d).rootPropertyValueCache = {};
                    var h = !1;
                    f.each(w.Lists.transforms3D, function (e, t) {
                        var n = /^scale/.test(t) ? 1 : 0, o = a(d).transformCache[t];
                        a(d).transformCache[t] !== i && new RegExp("^\\(" + n + "[^.]").test(o) && (h = !0, delete a(d).transformCache[t])
                    }), r.mobileHA && (h = !0, delete a(d).transformCache.translate3d), h && w.flushTransformCache(d), w.Values.removeClass(d, "velocity-animating")
                }
                ...
                s && r.loop !== !0 && s(o), a(d) && r.loop === !0 && !t && (f.each(a(d).tweensContainer, function (e, t) {
                    /^rotate/.test(e) && 360 === parseFloat(t.endValue) && (t.endValue = 0, t.startValue = 360), /^backgroundPosition/.test(e) && 100 === parseFloat(t.endValue) && "%" === t.unitType && (t.endValue = 0, t.startValue = 100)
                }), b(d, "reverse", {loop: !0, delay: r.delay})), r.queue !== !1 && f.dequeue(d, r.queue)
            }
            b.State.calls[e] = !1;
            for (var p = 0, m = b.State.calls.length; m > p; p++)if (b.State.calls[p] !== !1) {
                l = !0;
                break
            }
        ...
        var w = b.CSS = {
            ...
            Hooks: {
                templates: {
                    ...
                    var n, i, o;
                    if (h)for (n in w.Hooks.templates) {
                        i = w.Hooks.templates[n], o = i[0].split(" ");
                        var r = i[1].match(w.RegEx.valueSplit);
                        "Color" === o[0] && (o.push(o.shift()), r.push(r.shift()), w.Hooks.templates[n] = [o.join(" "), r.join(" ")])
                    }
            ...
            getPropertyValue: function (e, n, o, r) {
                function s(e, n) {
                    ...
                    var l = 0;
                    if (8 >= h)l = f.css(e, n); else {
                        var u = !1;
                        if (/^(width|height)$/.test(n) && 0 === w.getPropertyValue(e, "display") && (u = !0, w.setPropertyValue(e, "display", w.Values.getDisplayType(e))), !r) {
                        ...
                        var p;
                        p = a(e) === i ? t.getComputedStyle(e, null) : a(e).computedStyle ? a(e).computedStyle : a(e).computedStyle = t.getComputedStyle(e, null), "borderColor" === n && (n = "borderTopColor"), l = 9 === h && "filter" === n ? p.getPropertyValue(n) : p[n], ("" === l || null === l) && (l = e.style[n]), o()
                    }
                ...
                if (!/^[\d-]/.test(l))if (a(e) && a(e).isSVG && w.Names.SVGAttribute(n))if (/^(height|width)$/i.test(n))try {
                    l = e.getBBox()[n]
                } catch (e) {
                    l = 0
                } else l = e.getAttribute(n); else l = s(e, w.Names.prefixCheck(n)[0]);
                return w.Values.isCSSNullValue(l) && (l = 0), b.debug >= 2 && console.log("Get " + n + ": " + l), l
            },
            setPropertyValue: function (e, n, i, o, r) {
                var s = n;
                if ("scroll" === n)r.container ? r.container["scroll" + r.direction] = i : "Left" === r.direction ? t.scrollTo(i, r.alternateValue) : t.scrollTo(r.alternateValue, i); else if (w.Normalizations.registered[n] && "transform" === w.Normalizations.registered[n]("name", e))w.Normalizations.registered[n]("inject", e, i), s = "transform", i = a(e).transformCache[n]; else {
                    if (w.Hooks.registered[n]) {
                        var l = n, u = w.Hooks.getRoot(n);
            ...
            flushTransformCache: function (e) {
                ...
                if ((h || b.State.isAndroid && !b.State.isChrome) && a(e).isSVG) {
                    ...
                    f.each(a(e).transformCache, function (t) {
                        return o = a(e).transformCache[t], "transformPerspective" === t ? (r = o, !0) : (9 === h && "rotateZ" === t && (t = "rotate"), void(n += t + o + " "))
                    }), r && (n = "perspective" + r + " " + n)
                }
        ...
        var C = function () {
            ...
            function o() {
                function e(e) {
                    function d(e, t) {
                        var n = i, o = i, a = i;
                        return m.isArray(e) ? (n = e[0], !m.isArray(e[1]) && /^[\d-]/.test(e[1]) || m.isFunction(e[1]) || w.RegEx.isHex.test(e[1]) ? a = e[1] : (m.isString(e[1]) && !w.RegEx.isHex.test(e[1]) || m.isArray(e[1])) && (o = t ? e[1] : u(e[1], s.duration), e[2] !== i && (a = e[2]))) : n = e, t || (o = o || s.easing), m.isFunction(n) && (n = n.call(r, T, k)), m.isFunction(a) && (a = a.call(r, T, k)), [n || 0, o, a]
                    }
                    ...
                    if ("scroll" === A) {
                        var v, x, C, _ = /^x$/i.test(s.axis) ? "Left" : "Top", S = parseFloat(s.offset) || 0;
                        s.container ? m.isWrapped(s.container) || m.isNode(s.container) ? (s.container = s.container[0] || s.container, v = s.container["scroll" + _], C = v + f(r).position()[_.toLowerCase()] + S) : s.container = null : (v = b.State.scrollAnchor[b.State["scrollProperty" + _]], x = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === _ ? "Top" : "Left")]], C = f(r).offset()[_.toLowerCase()] + S), l = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: v,
                                currentValue: v,
                                ...
                                unitType: "",
                                easing: s.easing,
                                scrollData: {container: s.container, direction: _, alternateValue: x}
                            }, element: r
                        }, b.debug && console.log("tweensContainer (scroll): ", l.scroll, r)
                    } else if ("reverse" === A) {
                        if (!a(r).tweensContainer)return void f.dequeue(r, s.queue);
                        "none" === a(r).opts.display && (a(r).opts.display = "auto"), "hidden" === a(r).opts.visibility && (a(r).opts.visibility = "visible"), a(r).opts.loop = !1, a(r).opts.begin = null, a(r).opts.complete = null, y.easing || delete s.easing, y.duration || delete s.duration, s = f.extend({}, a(r).opts, s);
                        var I = f.extend(!0, {}, a(r).tweensContainer);
                        for (var D in I)if ("element" !== D) {
                            var O = I[D].startValue;
                            I[D].startValue = I[D].currentValue = I[D].endValue, I[D].endValue = O, m.isEmptyObject(y) || (I[D].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(I[D]), r)
                        }
                        l = I
                    } else if ("start" === A) {
                        var I;
                        a(r).tweensContainer && a(r).isAnimating === !0 && (I = a(r).tweensContainer), f.each(g, function (e, t) {
                            if (RegExp("^" + w.Lists.colors.join("$|^") + "$").test(e)) {
                                var n = d(t, !0), o = n[0], r = n[1], a = n[2];
                                if (w.RegEx.isHex.test(o)) {
                                    for (var s = ["Red", "Green", "Blue"], l = w.Values.hexToRgb(o), u = a ? w.Values.hexToRgb(a) : i, c = 0; c < s.length; c++) {
                                        var f = [l[c]];
                                        r && f.push(r), u !== i && f.push(u[c]), g[e + s[c]] = f
                                    }
                                    delete g[e]
                                }
                            }
                        ...
                        for (var P in g) {
                            var M = d(g[P]), N = M[0], R = M[1], W = M[2];
                            P = w.Names.camelCase(P);
                            var H = w.Hooks.getRoot(P), V = !1;
                            if (a(r).isSVG || "tween" === H || w.Names.prefixCheck(H)[1] !== !1 || w.Normalizations.registered[H] !== i) {
                                (s.display !== i && null !== s.display && "none" !== s.display || s.visibility !== i && "hidden" !== s.visibility) && /opacity|filter/.test(P) && !W && 0 !== N && (W = 0), s._cacheValues && I && I[P] ? (W === i && (W = I[P].endValue + I[P].unitType), V = a(r).rootPropertyValueCache[H]) : w.Hooks.registered[P] ? W === i ? (V = w.getPropertyValue(r, H), W = w.getPropertyValue(r, P, V)) : V = w.Hooks.templates[H][1] : W === i && (W = w.getPropertyValue(r, P));
                                var j, B, z, q = !1;
                                if (j = h(P, W), W = j[0], z = j[1], j = h(P, N), N = j[0].replace(/^([+-\/*])=/, function (e, t) {
                                        return q = t, ""
                                    }), B = j[1], W = parseFloat(W) || 0, N = parseFloat(N) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(P) ? (N /= 100, B = "em") : /^scale/.test(P) ? (N /= 100, B = "") : /(Red|Green|Blue)$/i.test(P) && (N = N / 100 * 255, B = "")), /[\/*]/.test(q))B = z; else if (z !== B && 0 !== W)if (0 === N)B = z; else {
                                    o = o || function () {
                                            var e = {
                                            ...
                                            return null === L.remToPx && (L.remToPx = parseFloat(w.getPropertyValue(n.body, "fontSize")) || 16), null === L.vwToPx && (L.vwToPx = parseFloat(t.innerWidth) / 100, L.vhToPx = parseFloat(t.innerHeight) / 100), l.remToPx = L.remToPx, l.vwToPx = L.vwToPx, l.vhToPx = L.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), r), l
                                        }();
                                ...
                                l[P] = {
                                    ...
                                    unitType: B,
                                    easing: R
                                }, b.debug && console.log("tweensContainer (" + P + "): " + JSON.stringify(l[P]), r)
                            } else b.debug && console.log("Skipping [" + H + "] due to a lack of browser support.")
                        }
                        l.element = r
                    }
                    l.element && (w.Values.addClass(r, "velocity-animating"), F.push(l), "" === s.queue && (a(r).tweensContainer = l, a(r).opts = s), a(r).isAnimating = !0, T === k - 1 ? (b.State.calls.push([F, p, s, null, E.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, c())) : T++)
                }

                var o, r = this, s = f.extend({}, b.defaults, y), l = {};
                switch (a(r) === i && b.init(r), parseFloat(s.delay) && s.queue !== !1 && f.queue(r, s.queue, function (e) {
                ...
                b.mock !== !1 && (b.mock === !0 ? s.duration = s.delay = 1 : (s.duration *= parseFloat(b.mock) || 1, s.delay *= parseFloat(b.mock) || 1)), s.easing = u(s.easing, s.duration), s.begin && !m.isFunction(s.begin) && (s.begin = null), s.progress && !m.isFunction(s.progress) && (s.progress = null), s.complete && !m.isFunction(s.complete) && (s.complete = null), s.display !== i && null !== s.display && (s.display = s.display.toString().toLowerCase(), "auto" === s.display && (s.display = b.CSS.Values.getDisplayType(r))), s.visibility !== i && null !== s.visibility && (s.visibility = s.visibility.toString().toLowerCase()), s.mobileHA = s.mobileHA && b.State.isMobile && !b.State.isGingerbread, s.queue === !1 ? s.delay ? setTimeout(e, s.delay) : e() : f.queue(r, s.queue, function (t, n) {
            ...
            if (m.isWrapped(this) ? (s = !1, h = 0, p = this, l = this) : (s = !0, h = 1,
                    p = x ? arguments[0].elements || arguments[0].e : arguments[0]), p = r(p)) {
                    ...
                    case"stop":
                        ...
                        return f.each(b.State.calls, function (e, t) {
                            t && f.each(t[1], function (n, o) {
                                var r = y === i ? "" : y;
                                return r !== !0 && t[2].queue !== r && (y !== i || t[2].queue !== !1) || void f.each(p, function (n, i) {
                                        i === o && ((y === !0 || m.isString(y)) && (f.each(f.queue(i, m.isString(y) ? y : ""), function (e, t) {
                                            m.isFunction(t) && t(null, !0)
                                        }), f.queue(i, m.isString(y) ? y : "", [])), "stop" === g ? (a(i) && a(i).tweensContainer && r !== !1 && f.each(a(i).tweensContainer, function (e, t) {
                    ...
                    default:
                        if (!f.isPlainObject(g) || m.isEmptyObject(g)) {
                            if (m.isString(g) && b.Redirects[g]) {
                                var D = f.extend({}, y), O = D.duration, P = D.delay || 0;
                                return D.backwards === !0 && (p = f.extend(!0, [], p).reverse()), f.each(p, function (e, t) {
                                    parseFloat(D.stagger) ? D.delay = P + parseFloat(D.stagger) * e : m.isFunction(D.stagger) && (D.delay = P + D.stagger.call(t, e, k)), D.drag && (D.duration = parseFloat(O) || (/^(callout|transition)/.test(g) ? 1e3 : v), D.duration = Math.max(D.duration * (D.backwards ? 1 - e / k : (e + 1) / k), .75 * D.duration, 200)), b.Redirects[g].call(t, t, D || {}, e, k, p, E.promise ? E : i)
                                }), e()
                            }
                ...
                var N, D = f.extend({}, b.defaults, y);
                if (D.loop = parseInt(D.loop), N = 2 * D.loop - 1, D.loop)for (var R = 0; N > R; R++) {
                    var W = {delay: D.delay, progress: D.progress};
                    R === N - 1 && (W.display = D.display, W.visibility = D.visibility, W.complete = D.complete), C(p, "reverse", W)
                }
                return e()
            }
        };
        ...
        return b.State.isMobile || n.hidden === i || n.addEventListener("visibilitychange", function () {
            ...
            b.Redirects["slide" + t] = function (e, n, o, r, a, s) {
                var l = f.extend({}, n), u = l.begin, c = l.complete, d = {
                    height: "",
                    marginTop: "",
                    marginBottom: "",
                    paddingTop: "",
    ...
    return function e(t, n, i) {
        ...
        1: [function (e, t, n) {
            ...
            function i(e) {
                if (e) {
                    var t = [0, 0, 0], n = 1, i = e.match(/^#([a-fA-F0-9]{3})$/);
                    if (i) {
                        i = i[1];
                        for (var o = 0; o < t.length; o++)t[o] = parseInt(i[o] + i[o], 16)
                    } else if (i = e.match(/^#([a-fA-F0-9]{6})$/)) {
                        i = i[1];
                        for (var o = 0; o < t.length; o++)t[o] = parseInt(i.slice(2 * o, 2 * o + 2), 16)
                    } else if (i = e.match(/^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/)) {
                        for (var o = 0; o < t.length; o++)t[o] = parseInt(i[o + 1]);
                        n = parseFloat(i[4])
                    } else if (i = e.match(/^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/)) {
                        for (var o = 0; o < t.length; o++)t[o] = Math.round(2.55 * parseFloat(i[o + 1]));
                        n = parseFloat(i[4])
                    } else if (i = e.match(/(\w+)/)) {
                        if ("transparent" == i[1])return [0, 0, 0, 0];
                        if (!(t = x[i[1]]))return
                    }
                    for (var o = 0; o < t.length; o++)t[o] = y(t[o], 0, 255);
            ...
            var i = e(5), o = e(2), r = function (e) {
                ...
                var t;
                "string" == typeof e ? (t = o.getRgba(e), t ? this.setValues("rgb", t) : (t = o.getHsla(e)) ? this.setValues("hsl", t) : (t = o.getHwb(e)) && this.setValues("hwb", t)) : "object" == typeof e && (t = e, void 0 !== t.r || void 0 !== t.red ? this.setValues("rgb", t) : void 0 !== t.l || void 0 !== t.lightness ? this.setValues("hsl", t) : void 0 !== t.v || void 0 !== t.value ? this.setValues("hsv", t) : void 0 !== t.w || void 0 !== t.whiteness ? this.setValues("hwb", t) : void 0 === t.c && void 0 === t.cyan || this.setValues("cmyk", t))
            };
            r.prototype = {
                isValid: function () {
                    return this.valid
                    ...
                    var n = this, i = e, o = void 0 === t ? .5 : t, r = 2 * o - 1, a = n.alpha() - i.alpha(), s = ((r * a == -1 ? r : (r + a) / (1 + r * a)) + 1) / 2, l = 1 - s;
                    ...
                    for (var a in i)i.hasOwnProperty(a) && (e = i[a], t = {}.toString.call(e), "[object Array]" === t ? o[a] = e.slice(0) : "[object Number]" === t ? o[a] = e : console.error("unexpected color value:", e));
                    return n
                }
            }, r.prototype.spaces = {
                rgb: ["red", "green", "blue"],
                ...
                var n, o = this.values, r = this.spaces, a = this.maxes, s = 1;
                if (this.valid = !0, "alpha" === e)s = t; else if (t.length)o[e] = t.slice(0, e.length), s = t[e.length]; else if (void 0 !== t[e.charAt(0)]) {
                ...
                var u;
                for (n = 0; n < e.length; n++)u = Math.max(0, Math.min(a[e][n], o[e][n])), o[e][n] = Math.round(u);
                for (var c in r)c !== e && (o[c] = i[e][c](o[e]));
                return !0
            ...
            function i(e) {
                var t, n, i, o = e[0] / 255, r = e[1] / 255, a = e[2] / 255, s = Math.min(o, r, a), l = Math.max(o, r, a), u = l - s;
                return l == s ? t = 0 : o == l ? t = (r - a) / u : r == l ? t = 2 + (a - o) / u : a == l && (t = 4 + (o - r) / u), t = Math.min(60 * t, 360), t < 0 && (t += 360), i = (s + l) / 2, n = l == s ? 0 : i <= .5 ? u / (l + s) : u / (2 - l - s), [t, 100 * n, 100 * i]
            }

            function o(e) {
                var t, n, i, o = e[0], r = e[1], a = e[2], s = Math.min(o, r, a), l = Math.max(o, r, a), u = l - s;
                return n = 0 == l ? 0 : u / l * 1e3 / 10, l == s ? t = 0 : o == l ? t = (r - a) / u : r == l ? t = 2 + (a - o) / u : a == l && (t = 4 + (o - r) / u), t = Math.min(60 * t, 360), t < 0 && (t += 360), i = l / 255 * 1e3 / 10, [t, n, i]
            }

            function a(e) {
                var t = e[0], n = e[1], o = e[2], r = i(e)[0], a = 1 / 255 * Math.min(t, Math.min(n, o)), o = 1 - 1 / 255 * Math.max(t, Math.max(n, o));
                return [r, 100 * a, 100 * o]
            }

            function s(e) {
                var t, n, i, o, r = e[0] / 255, a = e[1] / 255, s = e[2] / 255;
            ...
            function c(e) {
                var t, n, i, o = u(e), r = o[0], a = o[1], s = o[2];
            ...
            function f(e) {
                ...
                for (var u = 0; u < 3; u++)i = a + 1 / 3 * -(u - 1), i < 0 && i++, i > 1 && i--, r = 6 * i < 1 ? t + 6 * (n - t) * i : 2 * i < 1 ? n : 3 * i < 2 ? t + (n - t) * (2 / 3 - i) * 6 : t, o[u] = 255 * r;
                return o
            }
            ...
            function y(e) {
                var t = e[0] / 60, n = e[1] / 100, i = e[2] / 100, o = Math.floor(t) % 6, r = t - Math.floor(t), a = 255 * i * (1 - n), s = 255 * i * (1 - n * r), l = 255 * i * (1 - n * (1 - r)), i = 255 * i;
                switch (o) {
                    case 0:
                        return [i, l, a];
                    case 1:
            ...
            function T(e) {
                ...
                switch (u > 1 && (s /= u, l /= u), t = Math.floor(6 * a), n = 1 - l, i = 6 * a - t, 0 != (1 & t) && (i = 1 - i), o = s + i * (n - s), t) {
                    default:
                    case 6:
                    case 0:
                        r = n, g = o, b = s;
            ...
            function I(e) {
                var t, n, i, o = e[0] / 100, r = e[1] / 100, a = e[2] / 100, s = e[3] / 100;
            ...
            function R(e) {
                ...
                return r <= 8 ? (n = 100 * r / 903.3, o = n / 100 * 7.787 + 16 / 116) : (n = 100 * Math.pow((r + 16) / 116, 3), o = Math.pow(n / 100, 1 / 3)), t = t / 95.047 <= .008856 ? t = 95.047 * (a / 500 + o - 16 / 116) / 7.787 : 95.047 * Math.pow(a / 500 + o, 3), i = i / 108.883 <= .008859 ? i = 108.883 * (o - s / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(o - s / 200, 3), [t, n, i]
            }

            function W(e) {
                var t, n, i, o = e[0], r = e[1], a = e[2];
                return t = Math.atan2(a, r), n = 360 * t / 2 / Math.PI, n < 0 && (n += 360), i = Math.sqrt(r * r + a * a), [o, i, n]
            }
            ...
            function V(e) {
                var t, n, i, o = e[0], r = e[1], a = e[2];
                return i = a / 360 * 2 * Math.PI, t = r * Math.cos(i), n = r * Math.sin(i), [o, t, n]
            }
            ...
            for (var Z in G)K[JSON.stringify(G[Z])] = Z
        }, {}], 5: [function (e, t, n) {
                ...
                e.defaults.bar = {
                    ...
                    dataElementType: e.elements.Rectangle, initialize: function () {
                        ...
                        e._xScale = o.getScaleForId(a.xAxisID), e._yScale = o.getScaleForId(a.yAxisID), e._datasetIndex = o.index, e._index = n, e._model = {
                            ...
                            backgroundColor: l.backgroundColor ? l.backgroundColor : t.getValueAtIndexOrDefault(s.backgroundColor, n, u.backgroundColor),
                            borderColor: l.borderColor ? l.borderColor : t.getValueAtIndexOrDefault(s.borderColor, n, u.borderColor),
                            borderWidth: l.borderWidth ? l.borderWidth : t.getValueAtIndexOrDefault(s.borderWidth, n, u.borderWidth)
                        }, o.updateElementGeometry(e, n, i), e.pivot()
                    }, updateElementGeometry: function (e, t, n) {
                        var i = this, o = e._model, r = i.getValueScale(), a = r.getBasePixel(), s = r.isHorizontal(), l = i._ruler || i.getRuler(), u = i.calculateBarValuePixels(i.index, t), c = i.calculateBarIndexPixels(i.index, t, l);
                        ...
                        var t, n, i = this, o = i.chart, r = i.getIndexScale(), a = r.options.stacked, s = void 0 === e ? o.data.datasets.length : e + 1, l = [];
                        for (t = 0; t < s; ++t)n = o.getDatasetMeta(t), n.bar && o.isDatasetVisible(t) && (a === !1 || a === !0 && l.indexOf(n.stack) === -1 || void 0 === a && (void 0 === n.stack || l.indexOf(n.stack) === -1)) && l.push(n.stack);
                        return l.length
                    }, getStackIndex: function (e) {
                        return this.getStackCount(e) - 1
                    }, getRuler: function () {
                        var e = this, n = e.getIndexScale(), i = n.options, o = e.getStackCount(), r = n.isHorizontal() ? n.width : n.height, a = r / n.ticks.length, s = a * i.categoryPercentage, l = s / o, u = l * i.barPercentage;
                        return u = Math.min(t.getValueOrDefault(i.barThickness, u), t.getValueOrDefault(i.maxBarThickness, 1 / 0)), {
                            stackCount: o,
                            tickSize: a,
                            categorySize: s,
                            categorySpacing: a - s,
                        ...
                        var n, i, o, r, a, s, l = this, u = l.chart, c = l.getMeta(), d = l.getValueScale(), f = u.data.datasets, h = Number(f[e].data[t]), p = d.options.stacked, m = c.stack, g = 0;
                        if (p || void 0 === p && void 0 !== m)for (n = 0; n < e; ++n)i = u.getDatasetMeta(n),
                        i.bar && i.stack === m && i.controller.getValueScaleId() === d.id && u.isDatasetVisible(n) && (o = Number(f[n].data[t]), (h < 0 && o < 0 || h >= 0 && o > 0) && (g += o));
                        return r = d.getPixelForValue(g), a = d.getPixelForValue(g + h), s = (a - r) / 2, {
                            size: s,
                            base: r,
                            head: a,
                            center: a + s / 2
                        ...
                        var i = this, o = n.scale, r = i.chart.isCombo, a = i.getStackIndex(e), s = o.getPixelForValue(null, t, e, r), l = n.barSize;
                        ...
                        var e, n = this, i = n.chart, o = n.getMeta().data, r = n.getDataset(), a = o.length, s = 0;
                        for (t.canvas.clipArea(i.ctx, i.chartArea); s < a; ++s)null === (e = r.data[s]) || void 0 === e || isNaN(e) || o[s].draw();
                        t.canvas.unclipArea(i.ctx)
                    }, setHoverStyle: function (e) {
                        var n = this.chart.data.datasets[e._datasetIndex], i = e._index, o = e.custom || {}, r = e._model;
                        ...
                        var n = this.chart.data.datasets[e._datasetIndex], i = e._index, o = e.custom || {}, r = e._model, a = this.chart.options.elements.rectangle;
            ...
            t.exports = function (e) {
                ...
                e.defaults.bubble = {
                    ...
                    update: function (e) {
                        var n = this, i = n.getMeta(), o = i.data;
                        t.each(o, function (t, i) {
                            n.updateElement(t, i, e)
                        })
                    },
                    updateElement: function (n, i, o) {
                        var r = this, a = r.getMeta(), s = r.getScaleForId(a.xAxisID), l = r.getScaleForId(a.yAxisID), u = n.custom || {}, c = r.getDataset(), d = c.data[i], f = r.chart.options.elements.point, h = r.index;
                        t.extend(n, {
                            _xScale: s,
                            _yScale: l,
                            _datasetIndex: h,
                            _index: i,
                            _model: {
                                x: o ? s.getPixelForDecimal(.5) : s.getPixelForValue("object" == typeof d ? d : NaN, i, h, r.chart.isCombo),
                                y: o ? l.getBasePixel() : l.getPixelForValue(d, i, h),
                                radius: o ? 0 : u.radius ? u.radius : r.getRadius(d),
                                hitRadius: u.hitRadius ? u.hitRadius : t.getValueAtIndexOrDefault(c.hitRadius, i, f.hitRadius)
                            }
                        }), e.DatasetController.prototype.removeHoverStyle.call(r, n, f);
                        var p = n._model;
                    ...
                    setHoverStyle: function (n) {
                        ...
                        var o = i.chart.data.datasets[n._datasetIndex], r = n._index, a = n.custom || {};
                    ...
                    removeHoverStyle: function (t) {
                        ...
                        var i = n.chart.data.datasets[t._datasetIndex].data[t._index], o = t.custom || {};
            ...
            t.exports = function (e) {
                ...
                n.doughnut = {
                        ...
                        labels: {
                            generateLabels: function (e) {
                                ...
                                return n.labels.length && n.datasets.length ? n.labels.map(function (i, o) {
                                    var r = e.getDatasetMeta(0), a = n.datasets[0], s = r.data[o], l = s && s.custom || {}, u = t.getValueAtIndexOrDefault, c = e.options.elements.arc;
                                    return {
                                        text: i,
                                        fillStyle: l.backgroundColor ? l.backgroundColor : u(a.backgroundColor, o, c.backgroundColor),
                                        strokeStyle: l.borderColor ? l.borderColor : u(a.borderColor, o, c.borderColor),
                                        lineWidth: l.borderWidth ? l.borderWidth : u(a.borderWidth, o, c.borderWidth),
                    ...
                    tooltips: {
                        callbacks: {
                            title: function () {
                                ...
                                var i = n.labels[e.index], o = ": " + n.datasets[e.datasetIndex].data[e.index];
                                return t.isArray(i) ? (i = i.slice(), i[0] += o) : i += o, i
                            }
                        }
                    }
                }, n.pie = t.clone(n.doughnut), t.extend(n.pie, {cutoutPercentage: 0}), e.controllers.doughnut = e.controllers.pie = e.DatasetController.extend({
                    ...
                    update: function (e) {
                        var n = this, i = n.chart, o = i.chartArea, r = i.options, a = r.elements.arc, s = o.right - o.left - a.borderWidth, l = o.bottom - o.top - a.borderWidth, u = Math.min(s, l), c = {
                            x: 0,
                            y: 0
                        }, d = n.getMeta(), f = r.cutoutPercentage, h = r.circumference;
                        if (h < 2 * Math.PI) {
                            var p = r.rotation % (2 * Math.PI);
                            p += 2 * Math.PI * (p >= Math.PI ? -1 : p < -Math.PI ? 1 : 0);
                            var m = p + h, g = {x: Math.cos(p), y: Math.sin(p)}, v = {
                                x: Math.cos(m),
                                y: Math.sin(m)
                            }, y = p <= 0 && 0 <= m || p <= 2 * Math.PI && 2 * Math.PI <= m, b = p <= .5 * Math.PI && .5 * Math.PI <= m || p <= 2.5 * Math.PI && 2.5 * Math.PI <= m, x = p <= -Math.PI && -Math.PI <= m || p <= Math.PI && Math.PI <= m, w = p <= .5 * -Math.PI && .5 * -Math.PI <= m || p <= 1.5 * Math.PI && 1.5 * Math.PI <= m, C = f / 100, k = {
                            ...
                            }, _ = {width: .5 * (T.x - k.x), height: .5 * (T.y - k.y)};
                            u = Math.min(s / _.width, l / _.height), c = {x: (T.x + k.x) * -.5, y: (T.y + k.y) * -.5}
                        }
                        i.borderWidth = n.getMaxBorderWidth(d.data), i.outerRadius = Math.max((u - i.borderWidth) / 2, 0), i.innerRadius = Math.max(f ? i.outerRadius / 100 * f : 0, 0), i.radiusLength = (i.outerRadius - i.innerRadius) / i.getVisibleDatasetCount(), i.offsetX = c.x * i.outerRadius, i.offsetY = c.y * i.outerRadius, d.total = n.calculateTotal(), n.outerRadius = i.outerRadius - i.radiusLength * n.getRingIndex(n.index), n.innerRadius = Math.max(n.outerRadius - i.radiusLength, 0), t.each(d.data, function (t, i) {
                            n.updateElement(t, i, e)
                        })
                    },
                    updateElement: function (e, n, i) {
                        var o = this, r = o.chart, a = r.chartArea, s = r.options, l = s.animation, u = (a.left + a.right) / 2, c = (a.top + a.bottom) / 2, d = s.rotation, f = s.rotation, h = o.getDataset(), p = i && l.animateRotate ? 0 : e.hidden ? 0 : o.calculateCircumference(h.data[n]) * (s.circumference / (2 * Math.PI)), m = i && l.animateScale ? 0 : o.innerRadius, g = i && l.animateScale ? 0 : o.outerRadius, v = t.getValueAtIndexOrDefault;
                        t.extend(e, {
                            ...
                            _model: {
                                ...
                                outerRadius: g,
                                innerRadius: m,
                                label: v(h.label, n, r.data.labels[n])
                            }
                        });
                        var y = e._model;
                    ...
                    calculateTotal: function () {
                        var e, n = this.getDataset(), i = this.getMeta(), o = 0;
                    ...
                    getMaxBorderWidth: function (e) {
                        for (var t, n, i = 0, o = this.index, r = e.length, a = 0; a < r; a++)t = e[a]._model ? e[a]._model.borderWidth : 0, n = e[a]._chart ? e[a]._chart.config.data.datasets[o].hoverBorderWidth : 0, i = t > i ? t : i, i = n > i ? n : i;
                        return i
                    }
                })
            }
            ...
            t.exports = function (e) {
                ...
                e.defaults.line = {
                    ...
                    dataElementType: e.elements.Point,
                    update: function (e) {
                        var i, o, r, a = this, s = a.getMeta(), l = s.dataset, u = s.data || [], c = a.chart.options, d = c.elements.line, f = a.getScaleForId(s.yAxisID), h = a.getDataset(), p = t(h, c);
                        for (p && (r = l.custom || {}, void 0 !== h.tension && void 0 === h.lineTension && (h.lineTension = h.tension), l._scale = f, l._datasetIndex = a.index, l._children = u, l._model = {
                            spanGaps: h.spanGaps ? h.spanGaps : c.spanGaps,
                            tension: r.tension ? r.tension : n.getValueOrDefault(h.lineTension, d.tension),
                            backgroundColor: r.backgroundColor ? r.backgroundColor : h.backgroundColor || d.backgroundColor,
                            borderWidth: r.borderWidth ? r.borderWidth : h.borderWidth || d.borderWidth,
                            borderColor: r.borderColor ? r.borderColor : h.borderColor || d.borderColor,
                            borderCapStyle: r.borderCapStyle ? r.borderCapStyle : h.borderCapStyle || d.borderCapStyle,
                            borderDash: r.borderDash ? r.borderDash : h.borderDash || d.borderDash,
                            borderDashOffset: r.borderDashOffset ? r.borderDashOffset : h.borderDashOffset || d.borderDashOffset,
                            borderJoinStyle: r.borderJoinStyle ? r.borderJoinStyle : h.borderJoinStyle || d.borderJoinStyle,
                            fill: r.fill ? r.fill : void 0 !== h.fill ? h.fill : d.fill,
                            steppedLine: r.steppedLine ? r.steppedLine : n.getValueOrDefault(h.steppedLine, d.stepped),
                            cubicInterpolationMode: r.cubicInterpolationMode ? r.cubicInterpolationMode : n.getValueOrDefault(h.cubicInterpolationMode, d.cubicInterpolationMode)
                        }, l.pivot()), i = 0, o = u.length; i < o; ++i)a.updateElement(u[i], i, e);
                        for (p && 0 !== l._model.tension && a.updateBezierControlPoints(), i = 0, o = u.length; i < o; ++i)u[i].pivot()
                    },
                    getPointBackgroundColor: function (e, t) {
                        var i = this.chart.options.elements.point.backgroundColor, o = this.getDataset(), r = e.custom || {};
                    ...
                    getPointBorderColor: function (e, t) {
                        var i = this.chart.options.elements.point.borderColor, o = this.getDataset(), r = e.custom || {};
                    ...
                    getPointBorderWidth: function (e, t) {
                        var i = this.chart.options.elements.point.borderWidth, o = this.getDataset(), r = e.custom || {};
                    ...
                    updateElement: function (e, t, i) {
                        var o, r, a = this, s = a.getMeta(), l = e.custom || {}, u = a.getDataset(), c = a.index, d = u.data[t], f = a.getScaleForId(s.yAxisID), h = a.getScaleForId(s.xAxisID), p = a.chart.options.elements.point, m = a.chart.data.labels || [], g = 1 === m.length || 1 === u.data.length || a.chart.isCombo;
                        void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius), void 0 !== u.hitRadius && void 0 === u.pointHitRadius && (u.pointHitRadius = u.hitRadius), o = h.getPixelForValue("object" == typeof d ? d : NaN, t, c, g), r = i ? f.getBasePixel() : a.calculatePointY(d, t, c), e._xScale = h, e._yScale = f, e._datasetIndex = c, e._index = t, e._model = {
                            x: o,
                            y: r,
                            skip: l.skip || isNaN(o) || isNaN(r),
                            radius: l.radius || n.getValueAtIndexOrDefault(u.pointRadius, t, p.radius),
                            pointStyle: l.pointStyle || n.getValueAtIndexOrDefault(u.pointStyle, t, p.pointStyle),
                            ...
                            hitRadius: l.hitRadius || n.getValueAtIndexOrDefault(u.pointHitRadius, t, p.hitRadius)
                        }
                    },
                    calculatePointY: function (e, t, n) {
                        var i, o, r, a = this, s = a.chart, l = a.getMeta(), u = a.getScaleForId(l.yAxisID), c = 0, d = 0;
                        if (u.options.stacked) {
                            for (i = 0; i < n; i++)if (o = s.data.datasets[i], r = s.getDatasetMeta(i), "line" === r.type && r.yAxisID === u.id && s.isDatasetVisible(i)) {
                                var f = Number(u.getRightValue(o.data[t]));
                                f < 0 ? d += f || 0 : c += f || 0
                            }
                            var h = Number(u.getRightValue(e));
                            return h < 0 ? u.getPixelForValue(d + h) : u.getPixelForValue(c + h)
                        }
                    ...
                    updateBezierControlPoints: function () {
                        ...
                        var t, i, o, r, a, s = this, l = s.getMeta(), u = s.chart.chartArea, c = l.data || [];
                        if (l.dataset._model.spanGaps && (c = c.filter(function (e) {
                                return !e._model.skip
                            })), "monotone" === l.dataset._model.cubicInterpolationMode)n.splineCurveMonotone(c); else for (t = 0, i = c.length; t < i; ++t)o = c[t], r = o._model, a = n.splineCurve(n.previousItem(c, t)._model, r, n.nextItem(c, t)._model, l.dataset._model.tension), r.controlPointPreviousX = a.previous.x, r.controlPointPreviousY = a.previous.y, r.controlPointNextX = a.next.x, r.controlPointNextY = a.next.y;
                        if (s.chart.options.elements.line.capBezierPoints)for (t = 0, i = c.length; t < i; ++t)r = c[t]._model, r.controlPointPreviousX = e(r.controlPointPreviousX, u.left, u.right), r.controlPointPreviousY = e(r.controlPointPreviousY, u.top, u.bottom), r.controlPointNextX = e(r.controlPointNextX, u.left, u.right), r.controlPointNextY = e(r.controlPointNextY, u.top, u.bottom)
                    },
                    draw: function () {
                        var n = this, i = n.chart, o = n.getMeta(), r = o.data || [], a = i.chartArea, s = r.length, l = 0;
                    ...
                    setHoverStyle: function (e) {
                        var t = this.chart.data.datasets[e._datasetIndex], i = e._index, o = e.custom || {}, r = e._model;
                    ...
                    removeHoverStyle: function (e) {
                        var t = this, i = t.chart.data.datasets[e._datasetIndex], o = e._index, r = e.custom || {}, a = e._model;
            ...
            t.exports = function (e) {
                ...
                e.defaults.polarArea = {
                    ...
                    legend: {
                        labels: {
                            generateLabels: function (e) {
                                var n = e.data;
                                return n.labels.length && n.datasets.length ? n.labels.map(function (i, o) {
                                    var r = e.getDatasetMeta(0), a = n.datasets[0], s = r.data[o], l = s.custom || {}, u = t.getValueAtIndexOrDefault, c = e.options.elements.arc;
                                    return {
                                        text: i,
                                        fillStyle: l.backgroundColor ? l.backgroundColor : u(a.backgroundColor, o, c.backgroundColor),
                                        strokeStyle: l.borderColor ? l.borderColor : u(a.borderColor, o, c.borderColor),
                    ...
                    linkScales: t.noop,
                    update: function (e) {
                        var n = this, i = n.chart, o = i.chartArea, r = n.getMeta(), a = i.options, s = a.elements.arc, l = Math.min(o.right - o.left, o.bottom - o.top);
                    ...
                    updateElement: function (e, n, i) {
                        for (var o = this, r = o.chart, a = o.getDataset(), s = r.options, l = s.animation, u = r.scale, c = t.getValueAtIndexOrDefault, d = r.data.labels, f = o.calculateCircumference(a.data[n]), h = u.xCenter, p = u.yCenter, m = 0, g = o.getMeta(), v = 0; v < n; ++v)isNaN(a.data[v]) || g.data[v].hidden || ++m;
                        var y = s.startAngle, b = e.hidden ? 0 : u.getDistanceFromCenterForValue(a.data[n]), x = y + f * m, w = x + (e.hidden ? 0 : f), C = l.animateScale ? 0 : u.getDistanceFromCenterForValue(a.data[n]);
                        t.extend(e, {
                            _datasetIndex: o.index,
                            _index: n,
                            _scale: u,
                    ...
                    countVisibleElements: function () {
                        var e = this.getDataset(), n = this.getMeta(), i = 0;
            ...
            t.exports = function (e) {
                ...
                e.defaults.radar = {
                    ...
                    linkScales: t.noop,
                    update: function (e) {
                        var n = this, i = n.getMeta(), o = i.dataset, r = i.data, a = o.custom || {}, s = n.getDataset(), l = n.chart.options.elements.line, u = n.chart.scale;
                    ...
                    updateElement: function (e, n, i) {
                        var o = this, r = e.custom || {}, a = o.getDataset(), s = o.chart.scale, l = o.chart.options.elements.point, u = s.getPointPositionForValue(n, a.data[n]);
                    ...
                    updateBezierControlPoints: function () {
                        var e = this.chart.chartArea, n = this.getMeta();
                        t.each(n.data, function (i, o) {
                            var r = i._model, a = t.splineCurve(t.previousItem(n.data, o, !0)._model, r, t.nextItem(n.data, o, !0)._model, r.tension);
                    ...
                    setHoverStyle: function (e) {
                        var n = this.chart.data.datasets[e._datasetIndex], i = e.custom || {}, o = e._index, r = e._model;
                    ...
                    removeHoverStyle: function (e) {
                        var n = this.chart.data.datasets[e._datasetIndex], i = e.custom || {}, o = e._index, r = e._model, a = this.chart.options.elements.point;
            ...
            t.exports = function (e) {
                ...
                e.defaults.global.animation = {
                    ...
                    advance: function (e) {
                        for (var n, i, o = this.animations, r = 0; r < o.length;)n = o[r], i = n.chart, n.currentStep = (n.currentStep || 0) + e, n.currentStep = Math.min(n.currentStep, n.numSteps), t.callback(n.render, [i, n], i), t.callback(n.onAnimationProgress, [n], i), n.currentStep >= n.numSteps ? (t.callback(n.onAnimationComplete, [n], i), i.animating = !1, o.splice(r, 1)) : ++r
                    }
            ...
            t.exports = function (e) {
                ...
                t.drawPoint = function (t, n, i, o, r) {
                    var a, s, l, u, c, d;
                    if ("object" == typeof n && ("[object HTMLImageElement]" === (a = n.toString()) || "[object HTMLCanvasElement]" === a))return void t.drawImage(n, o - n.width / 2, r - n.height / 2, n.width, n.height);
                    if (!(isNaN(i) || i <= 0)) {
                        switch (n) {
                            default:
                                t.beginPath(), t.arc(o, r, i, 0, 2 * Math.PI), t.closePath(), t.fill();
                                break;
                            case"triangle":
                                t.beginPath(), s = 3 * i / Math.sqrt(3), c = s * Math.sqrt(3) / 2, t.moveTo(o - s / 2, r + c / 3), t.lineTo(o + s / 2, r + c / 3), t.lineTo(o, r - 2 * c / 3), t.closePath(), t.fill();
                                break;
                            case"rect":
                                d = 1 / Math.SQRT2 * i, t.beginPath(), t.fillRect(o - d, r - d, 2 * d, 2 * d), t.strokeRect(o - d, r - d, 2 * d, 2 * d);
                                break;
                            case"rectRounded":
                                var f = i / Math.SQRT2, h = o - f, p = r - f, m = Math.SQRT2 * i;
                                e.helpers.drawRoundedRectangle(t, h, p, m, m, i / 2), t.fill();
                                break;
                            case"rectRot":
                                d = 1 / Math.SQRT2 * i, t.beginPath(), t.moveTo(o - d, r), t.lineTo(o, r + d), t.lineTo(o + d, r), t.lineTo(o, r - d), t.closePath(), t.fill();
                                break;
                            case"cross":
                                t.beginPath(), t.moveTo(o, r + i), t.lineTo(o, r - i), t.moveTo(o - i, r), t.lineTo(o + i, r), t.closePath();
                                break;
                            case"crossRot":
                                t.beginPath(), l = Math.cos(Math.PI / 4) * i, u = Math.sin(Math.PI / 4) * i, t.moveTo(o - l, r - u), t.lineTo(o + l, r + u), t.moveTo(o - l, r + u), t.lineTo(o + l, r - u), t.closePath();
                                break;
                            case"star":
                                t.beginPath(), t.moveTo(o, r + i), t.lineTo(o, r - i), t.moveTo(o - i, r), t.lineTo(o + i, r), l = Math.cos(Math.PI / 4) * i, u = Math.sin(Math.PI / 4) * i, t.moveTo(o - l, r - u), t.lineTo(o + l, r + u), t.moveTo(o - l, r + u), t.lineTo(o + l, r - u), t.closePath();
                                break;
                            case"line":
                                t.beginPath(), t.moveTo(o - i, r), t.lineTo(o + i, r), t.closePath();
                                break;
                            case"dash":
                                t.beginPath(), t.moveTo(o, r), t.lineTo(o + i, r), t.closePath()
                        }
                        t.stroke()
                    }
            ...
            t.exports = function (e) {
                ...
                var o = e.helpers, r = e.plugins, a = e.platform;
                e.types = {}, e.instances = {}, e.controllers = {}, o.extend(e.prototype, {
                    construct: function (n, i) {
                        var r = this;
                        i = t(i);
                        var s = a.acquireContext(n, i), l = s && s.canvas, u = l && l.height, c = l && l.width;
                        if (r.id = o.uid(), r.ctx = s, r.canvas = l, r.config = i, r.width = c, r.height = u, r.aspectRatio = u ? c / u : null, r.options = i.options, r._bufferedRender = !1, r.chart = r, r.controller = r, e.instances[r.id] = r, Object.defineProperty(r, "data", {
                                get: function () {
                        ...
                        var t = this, n = t.options, i = t.canvas, a = n.maintainAspectRatio && t.aspectRatio || null, s = Math.floor(o.getMaximumWidth(i)), l = Math.floor(a ? s / a : o.getMaximumHeight(i));
                        if ((t.width !== s || t.height !== l) && (i.width = t.width = s, i.height = t.height = l, i.style.width = s + "px", i.style.height = l + "px", o.retinaScale(t), !e)) {
                            ...
                            r.notify(t, "resize", [u]), t.options.onResize && t.options.onResize(t, u), t.stop(), t.update(t.options.responsiveAnimationDuration)
                        }
                        ...
                        var t = this, n = t.options, r = t.scales = {}, a = [];
                        n.scales && (a = a.concat((n.scales.xAxes || []).map(function (e) {
                            ...
                            var a = n.options, s = o.getValueOrDefault(a.type, n.dtype), l = e.scaleService.getScaleConstructor(s);
                            if (l) {
                                i(a.position) !== i(n.dposition) && (a.position = n.dposition);
                                var u = new l({id: a.id, options: a, ctx: t.ctx, chart: t});
                                r[u.id] = u, n.isDefault && (t.scale = u)
                            }
                        ...
                        if (o.each(t.data.datasets, function (o, r) {
                                ...
                                if (a.type || (a.type = o.type || t.config.type), n.push(a.type), a.controller)a.controller.updateIndex(r); else {
                            ...
                            }, t), n.length > 1)for (var r = 1; r < n.length; r++)if (n[r] !== n[r - 1]) {
                            t.isCombo = !0;
                            break
                        }
                        return i
                        ...
                        var t = this;
                        r.notify(t, "beforeLayout") !== !1 && (e.layoutService.update(this, this.width, this.height), r.notify(t, "afterScaleUpdate"), r.notify(t, "afterLayout"))
                        ...
                        var t = this, n = t.getDatasetMeta(e), i = {meta: n, index: e};
                        r.notify(t, "beforeDatasetUpdate", [i]) !== !1 && (n.controller.update(), r.notify(t, "afterDatasetUpdate", [i]))
                    }, render: function (t, n) {
                        var i = this;
                        if (r.notify(i, "beforeRender") !== !1) {
                            var a = i.options.animation, s = function (e) {
                            ...
                            if (a && (void 0 !== t && 0 !== t || void 0 === t && 0 !== a.duration)) {
                                var l = new e.Animation({
                                    ...
                                    easing: a.easing,
                                    render: function (e, t) {
                                        var n = o.easingEffects[t.easing], i = t.currentStep, r = i / t.numSteps;
                                        e.draw(n(r), r, i)
                                    },
                            ...
                            } else i.draw(), s(new e.Animation({numSteps: 0, chart: i}));
                            return i
                        }
                    }, draw: function (e) {
                        var t = this;
                        t.clear(), void 0 !== e && null !== e || (e = 1), t.transition(e), r.notify(t, "beforeDraw", [e]) !== !1 && (o.each(t.boxes, function (e) {
                            e.draw(t.chartArea)
                        ...
                        var t = this;
                        if (r.notify(t, "beforeDatasetsDraw", [e]) !== !1) {
                            for (var n = (t.data.datasets || []).length - 1; n >= 0; --n)t.isDatasetVisible(n) && t.drawDataset(n, e);
                            r.notify(t, "afterDatasetsDraw", [e])
                        }
                    }, drawDataset: function (e, t) {
                        var n = this, i = n.getDatasetMeta(e), o = {meta: i, index: e, easingValue: t};
                        r.notify(n, "beforeDatasetDraw", [o]) !== !1 && (i.controller.draw(t), r.notify(n, "afterDatasetDraw", [o]))
                    }, getElementAtEvent: function (t) {
                        return e.Interaction.modes.single(this, t)
                    }, getElementsAtEvent: function (t) {
                        return e.Interaction.modes.label(this, t, {intersect: !0})
                    }, getElementsAtXAxis: function (t) {
                        return e.Interaction.modes["x-axis"](this, t, {intersect: !0})
                    }, getElementsAtEventForMode: function (t, n, i) {
                        var o = e.Interaction.modes[n];
                        return "function" == typeof o ? o(this, t, i) : []
                    }, getDatasetAtEvent: function (t) {
                        return e.Interaction.modes.dataset(this, t, {intersect: !0})
                    }, getDatasetMeta: function (e) {
                        var t = this, n = t.data.datasets[e];
                        n._meta || (n._meta = {});
                        var i = n._meta[t.id];
                        ...
                        var t = this, n = t.options || {}, i = n.hover, r = !1;
            ...
            t.exports = function (e) {
                ...
                function n(e, t) {
                    ...
                    if (n) {
                        ...
                        r !== -1 && i.splice(r, 1), i.length > 0 || (o.forEach(function (t) {
                            delete e[t]
                        }), delete e._chartjs)
                    }
                }

                var i = e.helpers, o = ["push", "pop", "shift", "splice", "unshift"];
                e.DatasetController = function (e, t) {
                    ...
                    buildOrUpdateElements: function () {
                        var e = this, i = e.getDataset(), o = i.data || (i.data = []);
                    ...
                    removeHoverStyle: function (e, t) {
                        var n = this.chart.data.datasets[e._datasetIndex], o = e._index, r = e.custom || {}, a = i.getValueAtIndexOrDefault, s = e._model;
                    ...
                    setHoverStyle: function (e) {
                        var t = this.chart.data.datasets[e._datasetIndex], n = e._index, o = e.custom || {}, r = i.getValueAtIndexOrDefault, a = i.getHoverColor, s = e._model;
                    ...
                    resyncElements: function () {
                        var e = this, t = e.getMeta(), n = e.getDataset().data, i = t.data.length, o = n.length;
            ...
            t.exports = function (e) {
                function t(e, t, n, o) {
                    var r, a, s, l, u, c, d, f, h, p = Object.keys(n);
                    for (r = 0, a = p.length; r < a; ++r)if (s = p[r], c = n[s], t.hasOwnProperty(s) || (t[s] = c), (l = t[s]) !== c && "_" !== s[0]) {
                        if (e.hasOwnProperty(s) || (e[s] = l), u = e[s], (d = typeof c) === typeof u)if ("string" === d) {
                            if (f = i(u), f.valid && (h = i(c), h.valid)) {
                                t[s] = h.mix(f, o).rgbString();
                                continue
                            }
                ...
                e.elements = {}, e.Element = function (e) {
                    ...
                    initialize: function () {
                        ...
                        var n = this, i = n._model, o = n._start, r = n._view;
            ...
            t.exports = function (e) {
                ...
                function o(e, i, o) {
                    var r = document.defaultView, a = e.parentNode, s = r.getComputedStyle(e)[i], l = r.getComputedStyle(a)[i], u = n(s), c = n(l), d = Number.POSITIVE_INFINITY;
                ...
                r.each = function (e, t, n, i) {
                    var o, a;
                    if (r.isArray(e))if (a = e.length, i)for (o = a - 1; o >= 0; o--)t.call(n, e[o], o); else for (o = 0; o < a; o++)t.call(n, e[o], o); else if ("object" == typeof e) {
                        var s = Object.keys(e);
                    ...
                    return r.each(Array.prototype.slice.call(arguments, 1), function (t) {
                        r.each(t, function (t, i) {
                            var o = n.hasOwnProperty(i), a = o ? n[i] : {};
                    ...
                    return r.each(n, function (t, n) {
                        "xAxes" === n || "yAxes" === n ? i.hasOwnProperty(n) ? r.each(t, function (t, o) {
                            var a = r.getValueOrDefault(t.type, "xAxes" === n ? "category" : "linear"), s = e.scaleService.getScaleDefaults(a);
                    ...
                    var o = e.skip ? t : e, r = t, a = n.skip ? t : n, s = Math.sqrt(Math.pow(r.x - o.x, 2) + Math.pow(r.y - o.y, 2)), l = Math.sqrt(Math.pow(a.x - r.x, 2) + Math.pow(a.y - r.y, 2)), u = s / (s + l), c = l / (s + l);
                    u = isNaN(u) ? 0 : u, c = isNaN(c) ? 0 : c;
                    var d = i * u, f = i * c;
                    return {
                        previous: {x: r.x - d * (a.x - o.x), y: r.y - d * (a.y - o.y)},
                        next: {x: r.x + f * (a.x - o.x), y: r.y + f * (a.y - o.y)}
                    }
                    ...
                    for (t = 0; t < s; ++t)if (i = a[t], !i.model.skip) {
                    ...
                    var u, c, d, f;
                    for (t = 0; t < s - 1; ++t)i = a[t], o = a[t + 1], i.model.skip || o.model.skip || (r.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = o.mK = 0 : (u = i.mK / i.deltaK, c = o.mK / i.deltaK, (f = Math.pow(u, 2) + Math.pow(c, 2)) <= 9 || (d = 3 / Math.sqrt(f), i.mK = u * d * i.deltaK, o.mK = c * d * i.deltaK)));
                    var h;
                    for (t = 0; t < s; ++t)i = a[t], i.model.skip || (n = t > 0 ? a[t - 1] : null, o = t < s - 1 ? a[t + 1] : null, n && !n.model.skip && (h = (i.model.x - n.model.x) / 3, i.model.controlPointPreviousX = i.model.x - h, i.model.controlPointPreviousY = i.model.y - h * i.mK), o && !o.model.skip && (h = (o.model.x - i.model.x) / 3, i.model.controlPointNextX = i.model.x + h, i.model.controlPointNextY = i.model.y + h * i.mK))
                ...
                r.requestAnimFrame = function () {
                    ...
                    var n, i, o = e.originalEvent || e, a = e.currentTarget || e.srcElement, s = a.getBoundingClientRect(), l = o.touches;
                    l && l.length > 0 ? (n = l[0].clientX, i = l[0].clientY) : (n = o.clientX, i = o.clientY);
                    var u = parseFloat(r.getStyle(a, "padding-left")), c = parseFloat(r.getStyle(a, "padding-top")), d = parseFloat(r.getStyle(a, "padding-right")), f = parseFloat(r.getStyle(a, "padding-bottom")), h = s.right - s.left - u - d, p = s.bottom - s.top - c - f;
                    return n = Math.round((n - s.left - u) / h * a.width / t.currentDevicePixelRatio), i = Math.round((i - s.top - c) / p * a.height / t.currentDevicePixelRatio), {
                        x: n,
                        y: i
                    }
                    ...
                    var t = e.parentNode, n = parseInt(r.getStyle(t, "padding-left"), 10), i = parseInt(r.getStyle(t, "padding-right"), 10), o = t.clientWidth - n - i, a = r.getConstraintWidth(e);
                    return isNaN(a) ? o : Math.min(o, a)
                }, r.getMaximumHeight = function (e) {
                    var t = e.parentNode, n = parseInt(r.getStyle(t, "padding-top"), 10), i = parseInt(r.getStyle(t, "padding-bottom"), 10), o = t.clientHeight - n - i, a = r.getConstraintHeight(e);
                    return isNaN(a) ? o : Math.min(o, a)
                    ...
                    if (1 !== t) {
                        var n = e.canvas, i = e.height, o = e.width;
                    ...
                    i = i || {};
                    var o = i.data = i.data || {}, a = i.garbageCollect = i.garbageCollect || [];
                    i.font !== t && (o = i.data = {}, a = i.garbageCollect = [], i.font = t), e.font = t;
                    var s = 0;
                    r.each(n, function (t) {
                        void 0 !== t && null !== t && r.isArray(t) !== !0 ? s = r.measureText(e, o, a, s, t) : r.isArray(t) && r.each(t, function (t) {
                    ...
                    for (n = 0, i = e.length; n < i; ++n)if (o = e[n], a = t[n], o instanceof Array && a instanceof Array) {
        ...
        }, {3: 3}], 27: [function (e, t, n) {
            "use strict";
            t.exports = function (e) {
                function t(e, t) {
                    return e.native ? {x: e.x, y: e.y} : a.getRelativePosition(e, t)
                }

                function n(e, t) {
                    var n, i, o, r, a, s = e.data.datasets;
                    for (i = 0, r = s.length; i < r; ++i)if (e.isDatasetVisible(i))for (n = e.getDatasetMeta(i), o = 0, a = n.data.length; o < a; ++o) {
                        var l = n.data[o];
                        l._view.skip || t(l)
                    }
                }
                ...
                function o(e, t, i, o) {
                    ...
                    return o || (o = a.distanceBetweenPoints), n(e, function (e) {
                        if (!i || e.inRange(t.x, t.y)) {
                            var n = e.getCenterPoint(), a = o(t, n);
                ...
                function r(e, n, r) {
                    var a = t(n, e), s = function (e, t) {
                        return Math.abs(e.x - t.x)
                    }, l = r.intersect ? i(e, a) : o(e, a, !1, s), u = [];
                    return l.length ? (e.data.datasets.forEach(function (t, n) {
                        if (e.isDatasetVisible(n)) {
                            var i = e.getDatasetMeta(n), o = i.data[l[0]._index];
                            o && !o._view.skip && u.push(o)
                        }
                    }), u) : []
                }
                ...
                e.Interaction = {
                    modes: {
                        single: function (e, i) {
                        ...
                        }, label: r, index: r, dataset: function (e, n, r) {
                            var a = t(n, e), s = r.intersect ? i(e, a) : o(e, a, !1);
                            ...
                            var r = t(n, e), a = o(e, r, i.intersect);
                            return a.length > 1 && a.sort(function (e, t) {
                                var n = e.getArea(), i = t.getArea(), o = n - i;
                ...
                e.layoutService = {
                    defaults: {}, addBox: function (e, t) {
                        ...
                        function a(e) {
                            ...
                            n ? (t = e.update(e.fullWidth ? w : E, S), A -= t.height) : (t = e.update(_, T), E -= t.width), I.push({
                                horizontal: n,
                                minSize: t,
                                box: e
                            })
                        ...
                        function s(e) {
                            ...
                            if (t)if (e.isHorizontal()) {
                                var n = {left: Math.max(L, D), right: Math.max(F, O), top: 0, bottom: 0};
                        ...
                        function l(e) {
                            var t = i.findNextWhere(I, function (t) {
                                return t.box === e
                            }), n = {left: 0, right: 0, top: N, bottom: R};
                            t && e.update(t.minSize.width, A, n)
                        }

                        function u(e) {
                            e.isHorizontal() ? (e.left = e.fullWidth ? f : L, e.right = e.fullWidth ? o - h : L + E, e.top = z, e.bottom = z + e.height, z = e.bottom) : (e.left = B, e.right = B + e.width, e.top = N, e.bottom = N + A, B = e.right)
                        }

                        if (e) {
                            var c = e.options.layout, d = c ? c.padding : null, f = 0, h = 0, p = 0, m = 0;
                            isNaN(d) ? (f = d.left || 0, h = d.right || 0, p = d.top || 0, m = d.bottom || 0) : (f = d, h = d, p = d, m = d);
                            var g = t(e.boxes, "left"), v = t(e.boxes, "right"), y = t(e.boxes, "top"), b = t(e.boxes, "bottom"), x = t(e.boxes, "chartArea");
                            n(g, !0), n(v, !1), n(y, !0), n(b, !1);
                            var w = o - f - h, C = r - p - m, k = w / 2, T = C / 2, _ = (o - k) / (g.length + v.length), S = (r - T) / (y.length + b.length), E = w, A = C, I = [];
                            ...
                            i.each(g.concat(v), s), i.each(g, function (e) {
                                ...
                                R += e.height
                            }), i.each(g.concat(v), l), L = f, F = h, N = p, R = m, i.each(g, function (e) {
                                L += e.width
                            }), i.each(v, function (e) {
                                F += e.width
                            }), i.each(y, function (e) {
                            ...
                            L += W, F += Math.max(O - F, 0);
                            var H = Math.max(P - N, 0);
                            N += H, R += Math.max(M - R, 0);
                            var V = r - N - R, j = o - L - F;
                            ...
                            var B = f + W, z = p + H;
                            i.each(g.concat(y), u), B += E, z += A, i.each(v, u), i.each(b, u), e.chartArea = {
                                left: L,
                                top: N,
                                right: L + E,
                                bottom: N + A
            ...
            t.exports = function (e) {
                ...
                e.defaults.global.plugins = {}, e.plugins = {
                    _plugins: [], _cacheId: 0, register: function (e) {
                        ...
                        for (i = 0; i < u; ++i)if (o = l[i], r = o.plugin, "function" == typeof(s = r[t]) && (a = [e].concat(n || []), a.push(o.options), s.apply(r, a) === !1))return !1;
                        return !0
                    }, descriptors: function (n) {
                        var i = n._plugins || (n._plugins = {});
                        if (i.id === this._cacheId)return i.descriptors;
                        var o = [], r = [], a = n && n.config || {}, s = e.defaults.global.plugins, l = a.options && a.options.plugins || {};
                        return this._plugins.concat(a.plugins || []).forEach(function (e) {
                            if (o.indexOf(e) === -1) {
                                var n = e.id, i = l[n];
                                i !== !1 && (i === !0 && (i = t.clone(s[n])), o.push(e), r.push({
                                    plugin: e,
                                    options: i || {}
                                }))
                            }
            ...
            t.exports = function (e) {
                ...
                function n(t) {
                    var n = i.getValueOrDefault, o = e.defaults.global, r = n(t.fontSize, o.defaultFontSize), a = n(t.fontStyle, o.defaultFontStyle), s = n(t.fontFamily, o.defaultFontFamily);
                    return {size: r, style: a, family: s, font: i.fontString(r, a, s)}
                }
                ...
                e.defaults.scale = {
                    ...
                    calculateTickRotation: function () {
                        var e = this, t = e.ctx, o = e.options.ticks, r = n(o);
                        t.font = r.font;
                        var a = o.minRotation || 0;
                        if (e.options.display && e.isHorizontal())for (var s, l = i.longestText(t, r.font, e.ticks, e.longestTextCache), u = l, c = e.getPixelForTick(1) - e.getPixelForTick(0) - 6; u > c && a < o.maxRotation;) {
                            var d = i.toRadians(a);
                    ...
                    fit: function () {
                        var e = this, o = e.minSize = {
                            width: 0,
                            height: 0
                        }, r = e.options, a = r.ticks, s = r.scaleLabel, l = r.gridLines, u = r.display, c = e.isHorizontal(), d = n(a), f = 1.5 * n(s).size, h = r.gridLines.tickMarkLength;
                        if (o.width = c ? e.isFullWidth() ? e.maxWidth - e.margins.left - e.margins.right : e.maxWidth : u && l.drawTicks ? h : 0, o.height = c ? u && l.drawTicks ? h : 0 : e.maxHeight, s.display && u && (c ? o.height += f : o.width += f), a.display && u) {
                            var p = i.longestText(e.ctx, d.font, e.ticks, e.longestTextCache), m = i.numberOfLabelLines(e.ticks), g = .5 * d.size;
                            if (c) {
                                e.longestLabelWidth = p
                                ;
                                var v = i.toRadians(e.labelRotation), y = Math.cos(v), b = Math.sin(v), x = b * p + d.size * m + g * m;
                                o.height = Math.min(e.maxHeight, o.height + x), e.ctx.font = d.font;
                                var w = e.ticks[0], C = t(e.ctx, w, d.font), k = e.ticks[e.ticks.length - 1], T = t(e.ctx, k, d.font);
                                0 !== e.labelRotation ? (e.paddingLeft = "bottom" === r.position ? y * C + 3 : y * g + 3, e.paddingRight = "bottom" === r.position ? y * g + 3 : y * T + 3) : (e.paddingLeft = C / 2 + 3, e.paddingRight = T / 2 + 3)
                    ...
                    getPixelForTick: function (e, t) {
                        var n = this;
                        if (n.isHorizontal()) {
                            var i = n.width - (n.paddingLeft + n.paddingRight), o = i / Math.max(n.ticks.length - (n.options.gridLines.offsetGridLines ? 0 : 1), 1), r = o * e + n.paddingLeft;
                            t && (r += o / 2);
                            var a = n.left + Math.round(r);
                    ...
                    getPixelForDecimal: function (e) {
                        var t = this;
                        if (t.isHorizontal()) {
                            var n = t.width - (t.paddingLeft + t.paddingRight), i = n * e + t.paddingLeft, o = t.left + Math.round(i);
                    ...
                    getBaseValue: function () {
                        var e = this, t = e.min, n = e.max;
                        return e.beginAtZero ? 0 : t < 0 && n < 0 ? n : t > 0 && n > 0 ? t : 0
                    },
                    draw: function (t) {
                        var o = this, r = o.options;
                        if (r.display) {
                            var a, s, l = o.ctx, u = e.defaults.global, c = r.ticks, d = r.gridLines, f = r.scaleLabel, h = 0 !== o.labelRotation, p = c.autoSkip, m = o.isHorizontal();
                            c.maxTicksLimit && (s = c.maxTicksLimit);
                            var g = i.getValueOrDefault(c.fontColor, u.defaultFontColor), v = n(c), y = d.drawTicks ? d.tickMarkLength : 0, b = i.getValueOrDefault(f.fontColor, u.defaultFontColor), x = n(f), w = i.toRadians(o.labelRotation), C = Math.cos(w), k = o.longestLabelWidth * C;
                            l.fillStyle = g;
                            var T = [];
                            if (m) {
                                if (a = !1, (k + c.autoSkipPadding) * o.ticks.length > o.width - (o.paddingLeft + o.paddingRight) && (a = 1 + Math.floor((k + c.autoSkipPadding) * o.ticks.length / (o.width - (o.paddingLeft + o.paddingRight)))), s && o.ticks.length > s)for (; !a || o.ticks.length / (a || 1) > s;)a || (a = 1), a += 1;
                                p || (a = !1)
                            }
                            var _ = "right" === r.position ? o.left : o.right - y, S = "right" === r.position ? o.left + y : o.right, E = "bottom" === r.position ? o.top : o.bottom - y, A = "bottom" === r.position ? o.top + y : o.bottom;
                            if (i.each(o.ticks, function (e, n) {
                                    if (void 0 !== e && null !== e) {
                                        var s = o.ticks.length === n + 1;
                                        if ((!(a > 1 && n % a > 0 || n % a == 0 && n + a >= o.ticks.length) || s) && void 0 !== e && null !== e) {
                                            var l, f, p, g;
                                            n === (void 0 !== o.zeroLineIndex ? o.zeroLineIndex : 0) ? (l = d.zeroLineWidth, f = d.zeroLineColor, p = d.zeroLineBorderDash, g = d.zeroLineBorderDashOffset) : (l = i.getValueAtIndexOrDefault(d.lineWidth, n), f = i.getValueAtIndexOrDefault(d.color, n), p = i.getValueOrDefault(d.borderDash, u.borderDash), g = i.getValueOrDefault(d.borderDashOffset, u.borderDashOffset));
                                            var v, b, x, C, k, I, D, O, P, M, L = "middle", F = "middle";
                                            if (m) {
                                                "bottom" === r.position ? (F = h ? "middle" : "top", L = h ? "right" : "center", M = o.top + y) : (F = h ? "middle" : "bottom", L = h ? "left" : "center", M = o.bottom - y);
                                                var N = o.getPixelForTick(n) + i.aliasPixel(l);
                                                P = o.getPixelForTick(n, d.offsetGridLines) + c.labelOffset, v = x = k = D = N, b = E, C = A, I = t.top, O = t.bottom
                                            } else {
                                                var R, W = "left" === r.position, H = c.padding;
                                                c.mirror ? (L = W ? "left" : "right", R = H) : (L = W ? "right" : "left", R = y + H), P = W ? o.right - R : o.left + R;
                                    ...
                                    if (d.display && (l.save(), l.lineWidth = e.glWidth, l.strokeStyle = e.glColor, l.setLineDash && (l.setLineDash(e.glBorderDash), l.lineDashOffset = e.glBorderDashOffset), l.beginPath(), d.drawTicks && (l.moveTo(e.tx1, e.ty1), l.lineTo(e.tx2, e.ty2)), d.drawOnChartArea && (l.moveTo(e.x1, e.y1), l.lineTo(e.x2, e.y2)), l.stroke(), l.restore()), c.display) {
                                        ...
                                        var t = e.label;
                                        if (i.isArray(t))for (var n = 0, o = 0; n < t.length; ++n)l.fillText("" + t[n], 0, o), o += 1.5 * v.size; else l.fillText(t, 0, 0);
                                        l.restore()
                                    }
                                }), f.display) {
                                var I, D, O = 0;
                                if (m)I = o.left + (o.right - o.left) / 2, D = "bottom" === r.position ? o.bottom - x.size / 2 : o.top + x.size / 2; else {
                            ...
                            if (d.drawBorder) {
                                ...
                                var M = o.left, L = o.right, F = o.top, N = o.bottom, R = i.aliasPixel(l.lineWidth);
            ...
            t.exports = function (e) {
                var t = e.helpers;
                e.scaleService = {
                    constructors: {}, defaults: {}, registerScaleType: function (e, n, i) {
            ...
            t.exports = function (e) {
                ...
                e.Ticks = {
                    generators: {
                        linear: function (e, n) {
                            var i, o = [];
                            if (e.stepSize && e.stepSize > 0)i = e.stepSize; else {
                                var r = t.niceNum(n.max - n.min, !1);
                                i = t.niceNum(r / (e.maxTicks - 1), !0)
                            }
                            var a = Math.floor(n.min / i) * i, s = Math.ceil(n.max / i) * i;
                            ...
                            for (var u = 1; u < l; ++u)o.push(a + u * i);
                            return o.push(void 0 !== e.max ? e.max : s), o
                        }, logarithmic: function (e, n) {
                            var i, o, r = [], a = t.getValueOrDefault, s = a(e.min, Math.pow(10, Math.floor(t.log10(n.min)))), l = Math.floor(t.log10(n.max)), u = Math.ceil(n.max / Math.pow(10, l));
                            ...
                            do {
                                r.push(s), ++o, 10 === o && (o = 1, ++i), s = o * Math.pow(10, i)
                            } while (i < l || i === l && o < u);
                            var c = a(e.max, s);
                            return r.push(c), r
                        }
            ...
            t.exports = function (e) {
                ...
                function i(e) {
                    var t = e._xScale, n = e._yScale || e._scale, i = e._index, o = e._datasetIndex;
                    return {
                ...
                function o(t) {
                    var n = e.defaults.global, i = l.getValueOrDefault;
                    return {
                        xPadding: t.xPadding,
                        yPadding: t.yPadding,
                        xAlign: t.xAlign,
                ...
                function r(e, t) {
                    var n = e._chart.ctx, i = 2 * t.yPadding, o = 0, r = t.body, a = r.reduce(function (e, t) {
                        return e + t.before.length + t.lines.length + t.after.length
                    }, 0);
                    a += t.beforeBody.length + t.afterBody.length;
                    var s = t.title.length, u = t.footer.length, c = t.titleFontSize, d = t.bodyFontSize, f = t.footerFontSize;
                    i += s * c, i += s ? (s - 1) * t.titleSpacing : 0, i += s ? t.titleMarginBottom : 0, i += a * d, i += a ? (a - 1) * t.bodySpacing : 0, i += u ? t.footerMarginTop : 0, i += u * f, i += u ? (u - 1) * t.footerSpacing : 0;
                    var h = 0, p = function (e) {
                        o = Math.max(o, n.measureText(e).width + h)
                    };
                    return n.font = l.fontString(c, t._titleFontStyle, t._titleFontFamily), l.each(t.title, p), n.font = l.fontString(d, t._bodyFontStyle, t._bodyFontFamily), l.each(t.beforeBody.concat(t.afterBody), p), h = t.displayColors ? d + 2 : 0, l.each(r, function (e) {
                        l.each(e.before, p), l.each(e.lines, p), l.each(e.after, p)
                    }), h = 0, n.font = l.fontString(f, t._footerFontStyle, t._footerFontFamily), l.each(t.footer, p), o += 2 * t.xPadding, {
                        width: o,
                        height: i
                    }
                }
                ...
                function a(e, t) {
                    var n = e._model, i = e._chart, o = e._chart.chartArea, r = "center", a = "center";
                    n.y < t.height ? a = "top" : n.y > i.height - t.height && (a = "bottom");
                    var s, l, u, c, d, f = (o.left + o.right) / 2, h = (o.top + o.bottom) / 2;
                ...
                function s(e, t, n) {
                    var i = e.x, o = e.y, r = e.caretSize, a = e.caretPadding, s = e.cornerRadius, l = n.xAlign, u = n.yAlign, c = r + a, d = s + a;
                    return "right" === l ? i -= t.width : "center" === l && (i -= t.width / 2), "top" === u ? o += c : o -= "bottom" === u ? t.height + c : t.height / 2, "center" === u ? "left" === l ? i += c : "right" === l && (i -= c) : "left" === l ? i -= d : "right" === l && (i += d), {
                        x: i,
                        y: o
                    }
                }
                ...
                e.defaults.global.tooltips = {
                    ...
                    callbacks: {
                        ...
                        labelColor: function (e, t) {
                            var n = t.getDatasetMeta(e.datasetIndex), i = n.data[e.index], o = i._view;
                            return {borderColor: o.borderColor, backgroundColor: o.backgroundColor}
                        },
                        afterLabel: l.noop,
                        afterBody: l.noop,
                        beforeFooter: l.noop,
                    ...
                    initialize: function () {
                        ...
                        var e = this, t = e._options, i = t.callbacks, o = i.beforeTitle.apply(e, arguments), r = i.title.apply(e, arguments), a = i.afterTitle.apply(e, arguments), s = [];
                        ...
                        var e = this, t = e._options.callbacks, i = t.beforeFooter.apply(e, arguments), o = t.footer.apply(e, arguments), r = t.afterFooter.apply(e, arguments), a = [];
                        return a = n(a, i), a = n(a, o), a = n(a, r)
                    }, update: function (t) {
                        var n, u, c = this, d = c._options, f = c._model, h = c._model = o(d), p = c._active, m = c._data, g = {
                            xAlign: f.xAlign,
                            yAlign: f.yAlign
                        }, v = {x: f.x, y: f.y}, y = {width: f.width, height: f.height}, b = {x: f.caretX, y: f.caretY};
                        if (p.length) {
                            h.opacity = 1;
                            var x = [];
                            b = e.Tooltip.positioners[d.position](p, c._eventPosition);
                            var w = [];
                            ...
                            d.filter && (w = w.filter(function (e) {
                                ...
                                x.push(d.callbacks.labelColor.call(c, e, c._chart))
                            }), h.title = c.getTitle(w, m), h.beforeBody = c.getBeforeBody(w, m), h.body = c.getBody(w, m), h.afterBody = c.getAfterBody(w, m), h.footer = c.getFooter(w, m), h.x = Math.round(b.x), h.y = Math.round(b.y), h.caretPadding = d.caretPadding, h.labelColors = x, h.dataPoints = w, y = r(this, h), g = a(this, y), v = s(h, y, g)
                        } else h.opacity = 0;
                        return h.xAlign = g.xAlign, h.yAlign = g.yAlign, h.x = v.x, h.y = v.y, h.width = y.width, h.height = y.height, h.caretX = b.x, h.caretY = b.y, c._model = h, t && d.custom && d.custom.call(c, h), c
                    }, drawCaret: function (e, t) {
                        var n = this._chart.ctx, i = this._view, o = this.getCaretPosition(e, t, i);
                        n.lineTo(o.x1, o.y1), n.lineTo(o.x2, o.y2), n.lineTo(o.x3, o.y3)
                    }, getCaretPosition: function (e, t, n) {
                        var i, o, r, a, s, l, u = n.caretSize, c = n.cornerRadius, d = n.xAlign, f = n.yAlign, h = e.x, p = e.y, m = t.width, g = t.height;
                        if ("center" === f)s = p + g / 2, "left" === d ? (i = h, o = i - u, r = i, a = s + u, l = s - u) : (i = h + m, o = i + u, r = i, a = s - u, l = s + u); else if ("left" === d ? (o = h + c + u, i = o - u, r = o + u) : "right" === d ? (o = h + m - c - u, i = o - u, r = o + u) : (o = h + m / 2, i = o - u, r = o + u), "top" === f)a = p, s = a - u, l = a; else {
                            a = p + g, s = a + u, l = a;
                            var v = r;
                            r = i, i = v
                        }
                        ...
                        if (r.length) {
                            ...
                            var a = n.titleFontSize, s = n.titleSpacing;
                            i.fillStyle = t(n.titleFontColor, o), i.font = l.fontString(a, n._titleFontStyle, n._titleFontFamily);
                            var u, c;
                            for (u = 0, c = r.length; u < c; ++u)i.fillText(r[u], e.x, e.y), e.y += a + s, u + 1 === r.length && (e.y += n.titleMarginBottom - s)
                        }
                    }, drawBody: function (e, n, i, o) {
                        var r = n.bodyFontSize, a = n.bodySpacing, s = n.body;
                        i.textAlign = n._bodyAlign, i.textBaseline = "top";
                        var u = t(n.bodyFontColor, o);
                        i.fillStyle = u, i.font = l.fontString(r, n._bodyFontStyle, n._bodyFontFamily);
                        var c = 0, d = function (t) {
                            i.fillText(t, e.x + c, e.y), e.y += r + a
                        };
                        l.each(n.beforeBody, d);
                        var f = n.displayColors;
                        c = f ? r + 2 : 0, l.each(s, function (a, s) {
                            l.each(a.before, d), l.each(a.lines, function (a) {
                                f && (i.fillStyle = t(n.legendColorBackground, o), i.fillRect(e.x, e.y, r, r), i.strokeStyle = t(n.labelColors[s].borderColor, o), i.strokeRect(e.x, e.y, r, r), i.fillStyle = t(n.labelColors[s].backgroundColor, o), i.fillRect(e.x + 1, e.y + 1, r - 2, r - 2), i.fillStyle = u), d(a)
                            }), l.each(a.after, d)
                        }), c = 0, l.each(n.afterBody, d), e.y -= a
                        ...
                        var a = n.xAlign, s = n.yAlign, l = e.x, u = e.y, c = o.width, d = o.height, f = n.cornerRadius;
                        i.beginPath(), i.moveTo(l + f, u), "top" === s && this.drawCaret(e, o), i.lineTo(l + c - f, u), i.quadraticCurveTo(l + c, u, l + c, u + f), "center" === s && "right" === a && this.drawCaret(e, o), i.lineTo(l + c, u + d - f), i.quadraticCurveTo(l + c, u + d, l + c - f, u + d), "bottom" === s && this.drawCaret(e, o), i.lineTo(l + f, u + d), i.quadraticCurveTo(l, u + d, l, u + d - f), "center" === s && "left" === a && this.drawCaret(e, o), i.lineTo(l, u + f), i.quadraticCurveTo(l, u, l + f, u), i.closePath(), i.fill(), n.borderWidth > 0 && i.stroke()
                    }, draw: function () {
                        var e = this._chart.ctx, t = this._view;
                        if (0 !== t.opacity) {
                            var n = {width: t.width, height: t.height}, i = {
                                x: t.x,
                                y: t.y
                            }, o = Math.abs(t.opacity < .001) ? 0 : t.opacity, r = t.title.length || t.beforeBody.length || t.body.length || t.afterBody.length || t.footer.length;
                    ...
                    average: function (e) {
                        ...
                        var n, i, o, r = t.x, a = t.y, s = Number.POSITIVE_INFINITY;
                        for (i = 0, o = e.length; i < o; ++i) {
                            var u = e[i];
                            if (u && u.hasValue()) {
                                var c = u.getCenterPoint(), d = l.distanceBetweenPoints(t, c);
                                d < s && (s = d, n = u)
                            }
                        }
                        if (n) {
            ...
            "use strict";
            t.exports = function (e) {
                var t = e.helpers, n = e.defaults.global;
                n.elements.arc = {
                    ...
                    inLabelRange: function (e) {
                        ...
                        if (i) {
                            ...
                            for (; r > l;)r -= 2 * Math.PI;
                            for (; r < s;)r += 2 * Math.PI;
                            var u = r >= s && r <= l, c = a >= i.innerRadius && a <= i.outerRadius;
                            return u && c
                        }
                        return !1
            ...
            t.exports = function (e) {
                ...
                e.defaults.global.elements.line = {
                    ...
                    draw: function () {
                        var e, i, o, r, a = this, s = a._view, l = a._chart.ctx, u = s.spanGaps, c = a._children.slice(), d = n.elements.line, f = -1;
                        for (a._loop && c.length && c.push(c[0]), l.save(), l.lineCap = s.borderCapStyle || d.borderCapStyle, l.setLineDash && l.setLineDash(s.borderDash || d.borderDash), l.lineDashOffset = s.borderDashOffset || d.borderDashOffset, l.lineJoin = s.borderJoinStyle || d.borderJoinStyle, l.lineWidth = s.borderWidth || d.borderWidth, l.strokeStyle = s.borderColor || n.defaultColor, l.beginPath(), f = -1, e = 0; e < c.length; ++e)i = c[e], o = t.previousItem(c, e), r = i._view, 0 === e ? r.skip || (l.moveTo(r.x, r.y), f = e) : (o = f === -1 ? o : c[f], r.skip || (f !== e - 1 && !u || f === -1 ? l.moveTo(r.x, r.y) : t.canvas.lineTo(l, o._view, i._view), f = e));
                        l.stroke(), l.restore()
                    }
                })
            }
            ...
            t.exports = function (e) {
                ...
                var i = e.helpers, o = e.defaults.global, r = o.defaultColor;
                o.elements.point = {
                    radius: 3,
                    pointStyle: "circle",
                    backgroundColor: r,
                    ...
                    inRange: function (e, t) {
                    ...
                    }, inLabelRange: t, inXRange: t, inYRange: n, getCenterPoint: function () {
                        var e = this._view;
                        return {x: e.x, y: e.y}
                    }, getArea: function () {
                        ...
                        var n = this._view, a = this._model, s = this._chart.ctx, l = n.pointStyle, u = n.radius, c = n.x, d = n.y, f = e.helpers.color, h = 0;
            ...
            t.exports = function (e) {
                ...
                function n(e) {
                    ...
                    return {left: n, top: o, right: i, bottom: r}
                }
                ...
                i.elements.rectangle = {
                    ...
                    draw: function () {
                        ...
                        var t, n, i, o, r, a, s, l = this._chart.ctx, u = this._view, c = u.borderWidth;
                        if (u.horizontal ? (t = u.base, n = u.x, i = u.y - u.height / 2, o = u.y + u.height / 2, r = n > t ? 1 : -1, a = 1, s = u.borderSkipped || "left") : (t = u.x - u.width / 2, n = u.x + u.width / 2, i = u.y, o = u.base, r = 1, a = o > i ? 1 : -1, s = u.borderSkipped || "bottom"), c) {
                            var d = Math.min(Math.abs(t - n), Math.abs(i - o));
                            c = c > d ? d : c;
                            var f = c / 2, h = t + ("left" !== s ? f * r : 0), p = n + ("right" !== s ? -f * r : 0), m = i + ("top" !== s ? f * a : 0), g = o + ("bottom" !== s ? -f * a : 0);
                            h !== p && (i = m, o = g), m !== g && (t = h, n = p)
                        }
                        l.beginPath(), l.fillStyle = u.backgroundColor, l.strokeStyle = u.borderColor, l.lineWidth = c;
                        var v = [[t, o], [t, i], [n, i], [n, o]], y = ["bottom", "left", "top", "right"], b = y.indexOf(s, 0);
                        b === -1 && (b = 0);
                        var x = e(0);
                        l.moveTo(x[0], x[1]);
            ...
            t.exports = function (e) {
                function t(e, t) {
                    var n = l.getStyle(e, t), i = n && n.match(/^(\d+)(\.\d+)?px$/);
                    return i ? Number(i[1]) : void 0
                }

                function n(e, n) {
                    var i = e.style, o = e.getAttribute("height"), r = e.getAttribute("width");
                    if (e._chartjs = {
                            initial: {
                                height: o,
                                width: r,
                    ...
                    if (null === o || "" === o)if ("" === e.style.height)e.height = e.width / (n.options.aspectRatio || 2); else {
                        var s = t(e, "height");
                        void 0 !== a && (e.height = s)
                    }
                    return e
                ...
                function o(e, t) {
                    var n = u[e.type] || e.type, o = l.getRelativePosition(e, t);
                ...
                return {
                    acquireContext: function (e, t) {
                        ...
                        var r = n._chartjs || (n._chartjs = {}), s = r.proxies || (r.proxies = {}), u = s[e.id + "_" + t] = function (t) {
                            n(o(t, e))
                        };
                        l.addEvent(i, t, u)
                        ...
                        var o = n._chartjs || {}, r = o.proxies || {}, a = r[e.id + "_" + t];
        ...
        }, {39: 39}], 41: [function (e, t, n) {
            "use strict";
            t.exports = function (e) {
                function t(e, t, n) {
                    var i, o = e._model || {}, r = o.fill;
                    if (void 0 === r && (r = !!o.backgroundColor), r === !1 || null === r)return !1;
                ...
                function o(e) {
                    ...
                    return t === !1 ? null : (isFinite(t) || (n = "boundary"), c[n](e))
                }
                ...
                function a(e, t, n, i, o) {
                    var r;
                    if (i && o) {
                        for (e.moveTo(t[0].x, t[0].y), r = 1; r < i; ++r)u.canvas.lineTo(e, t[r - 1], t[r]);
                        for (e.lineTo(n[o - 1].x, n[o - 1].y), r = o - 1; r > 0; --r)u.canvas.lineTo(e, n[r], n[r - 1], !0)
                    }
                }

                function s(e, t, n, i, o, s) {
                    var l, u, c, d, f, h, p, m = t.length, g = i.spanGaps, v = [], y = [], b = 0, x = 0;
                    for (e.beginPath(), l = 0, u = m + !!s; l < u; ++l)c = l % m, d = t[c]._view, f = n(d, c, i), h = r(d), p = r(f), h && p ? (b = v.push(d), x = y.push(f)) : b && x && (g ? (h && v.push(d), p && y.push(f)) : (a(e, v, y, b, x), b = x = 0, v = [], y = []));
                    a(e, v, y, b, x), e.closePath(), e.fillStyle = o, e.fill()
                }

                e.defaults.global.plugins.filler = {propagate: !0};
                var l = e.defaults, u = e.helpers, c = {
                    dataset: function (e) {
                        var t = e.fill, n = e.chart, i = n.getDatasetMeta(t), o = i && n.isDatasetVisible(t), r = o && i.dataset._children || [];
                        return r.length ? function (e, t) {
                            return r[t]._view || null
                        } : null
                    }, boundary: function (e) {
                ...
                return {
                    id: "filler", afterDatasetsUpdate: function (r, a) {
                        var s, l, u, c, d = (r.data.datasets || []).length, f = a.propagate, h = [];
                        for (l = 0; l < d; ++l)s = r.getDatasetMeta(l), u = s.dataset, c = null, u && u._model && u instanceof e.elements.Line && (c = {
                            visible: r.isDatasetVisible(l),
                            fill: t(u, l, d),
                            chart: r,
                            el: u
                        }), s.$filler = c, h.push(c);
                        for (l = 0; l < d; ++l)(c = h[l]) && (c.fill = i(h, l, f), c.boundary = n(c), c.mapper = o(c))
                    }, beforeDatasetDraw: function (e, t) {
                        var n = t.meta.$filler;
                        if (n) {
                            var i = n.el, o = i._view, r = i._children || [], a = n.mapper, u = o.backgroundColor || l.global.defaultColor;
                            a && u && r.length && s(e.ctx, r, a, o, u, i._loop)
                        }
                    }
                }
            }
            ...
            t.exports = function (e) {
                ...
                function n(t, n) {
                    var i = new e.Legend({ctx: t.ctx, options: n, chart: t});
                    o.configure(t, i, n), o.addBox(t, i), t.legend = i
                }

                var i = e.helpers, o = e.layoutService, r = i.noop;
                return e.defaults.global.legend = {
                    ...
                    }, beforeUpdate: r, update: function (e, t, n) {
                        var i = this;
                    ...
                    }, afterUpdate: r, beforeSetDimensions: r, setDimensions: function () {
                        var e = this;
                    ...
                    }, afterSetDimensions: r, beforeBuildLabels: r, buildLabels: function () {
                        var e = this, t = e.options.labels, n = t.generateLabels.call(e, e.chart);
                        t.filter && (n = n.filter(function (n) {
                            return t.filter(n, e.chart.data)
                        })), e.options.reverse && n.reverse(), e.legendItems = n
                    }, afterBuildLabels: r, beforeFit: r, fit: function () {
                        var n = this, o = n.options, r = o.labels, a = o.display, s = n.ctx, l = e.defaults.global, u = i.getValueOrDefault, c = u(r.fontSize, l.defaultFontSize), d = u(r.fontStyle, l.defaultFontStyle), f = u(r.fontFamily, l.defaultFontFamily), h = i.fontString(c, d, f), p = n.legendHitBoxes = [], m = n.minSize, g = n.isHorizontal();
                        if (g ? (m.width = n.maxWidth, m.height = a ? 10 : 0) : (m.width = a ? 10 : 0, m.height = n.maxHeight), a)if (s.font = h, g) {
                            var v = n.lineWidths = [0], y = n.legendItems.length ? c + r.padding : 0;
                            s.textAlign = "left", s.textBaseline = "top", i.each(n.legendItems, function (e, i) {
                                var o = t(r, c), a = o + c / 2 + s.measureText(e.text).width;
                                v[v.length - 1] + a + r.padding >= n.width && (y += c + r.padding, v[v.length] = n.left), p[i] = {
                                    left: 0,
                                    top: 0,
                                    width: a,
                                    height: c
                            ...
                            var b = r.padding, x = n.columnWidths = [], w = r.padding, C = 0, k = 0, T = c + b;
                            i.each(n.legendItems, function (e, n) {
                                var i = t(r, c), o = i + c / 2 + s.measureText(e.text).width;
                                k + T > m.height && (w += C + r.padding, x.push(C), C = 0, k = 0), C = Math.max(C, o), k += T, p[n] = {
                                    left: 0,
                                    top: 0,
                                    width: o,
                                    height: c
                    ...
                    }, afterFit: r, isHorizontal: function () {
                        return "top" === this.options.position || "bottom" === this.options.position
                    }, draw: function () {
                        var n = this, o = n.options, r = o.labels, a = e.defaults.global, s = a.elements.line, l = n.width, u = n.lineWidths;
                        if (o.display) {
                            var c, d = n.ctx, f = i.getValueOrDefault, h = f(r.fontColor, a.defaultFontColor), p = f(r.fontSize, a.defaultFontSize), m = f(r.fontStyle, a.defaultFontStyle), g = f(r.fontFamily, a.defaultFontFamily), v = i.fontString(p, m, g);
                            d.textAlign = "left", d.textBaseline = "top", d.lineWidth = .5, d.strokeStyle = h, d.fillStyle = h, d.font = v;
                            var y = t(r, p), b = n.legendHitBoxes, x = function (t, n, i) {
                                if (!(isNaN(y) || y <= 0)) {
                                    ...
                                    var r = 0 === f(i.lineWidth, s.borderWidth);
                                    if (d.setLineDash && d.setLineDash(f(i.lineDash, s.borderDash)), o.labels && o.labels.usePointStyle) {
                                        var l = p * Math.SQRT2 / 2, u = l / Math.SQRT2, c = t + u, h = n + u;
                            ...
                            c = C ? {
                                ...
                                y: n.top + r.padding,
                                line: 0
                            } : {x: n.left + r.padding, y: n.top + r.padding, line: 0};
                            var k = p + r.padding;
                            i.each(n.legendItems, function (e, t) {
                                var i = d.measureText(e.text).width, o = y + p / 2 + i, a = c.x, s = c.y;
                                C ? a + o >= l && (s = c.y += k, c.line++, a = c.x = n.left + (l - u[c.line]) / 2) : s + k > n.bottom && (a = c.x = a + n.columnWidths[c.line] + r.padding, s = c.y = n.top + r.padding, c.line++), x(a, s, e), b[t].left = a, b[t].top = s, w(a, s, e, i), C ? c.x += o + r.padding : c.y += k
                            })
                        }
                    }, handleEvent: function (e) {
                    ...
                    id: "legend", beforeInit: function (e) {
                        var t = e.options.legend;
                        t && n(e, t)
                    }, beforeUpdate: function (t) {
                        var r = t.options.legend, a = t.legend;
            ...
            t.exports = function (e) {
                function t(t, n) {
                    var o = new e.Title({ctx: t.ctx, options: n, chart: t});
                    i.configure(t, o, n), i.addBox(t, o), t.titleBlock = o
                }

                var n = e.helpers, i = e.layoutService, o = n.noop;
                return e.defaults.global.title = {
                    ...
                    beforeFit: o,
                    fit: function () {
                        var t = this, i = n.getValueOrDefault, o = t.options, r = e.defaults.global, a = o.display, s = i(o.fontSize, r.defaultFontSize), l = t.minSize;
                    ...
                    draw: function () {
                        var t = this, i = t.ctx, o = n.getValueOrDefault, r = t.options, a = e.defaults.global;
                        if (r.display) {
                            var s, l, u, c = o(r.fontSize, a.defaultFontSize), d = o(r.fontStyle, a.defaultFontStyle), f = o(r.fontFamily, a.defaultFontFamily), h = n.fontString(c, d, f), p = 0, m = t.top, g = t.left, v = t.bottom, y = t.right;
                            i.fillStyle = o(r.fontColor, a.defaultFontColor), i.font = h, t.isHorizontal() ? (s = g + (y - g) / 2, l = m + (v - m) / 2, u = y - g) : (s = "left" === r.position ? g + c / 2 : y - c / 2, l = m + (v - m) / 2, u = v - m, p = Math.PI * ("left" === r.position ? -.5 : .5)), i.save(), i.translate(s, l), i.rotate(p), i.textAlign = "center", i.textBaseline = "middle", i.fillText(r.text, 0, 0, u), i.restore()
                        }
                    }
                }), {
                    id: "title", beforeInit: function (e) {
                        var n = e.options.title;
                        n && t(e, n)
                    }, beforeUpdate: function (o) {
                        var r = o.options.title, a = o.titleBlock;
            ...
            "use strict";
            t.exports = function (e) {
                var t = e.helpers, n = {position: "bottom"}, i = e.Scale.extend({
                    getLabels: function () {
                        var e = this.chart.data;
                        return (this.isHorizontal() ? e.xLabels : e.yLabels) || e.labels
                    }, determineDataLimits: function () {
                        var e = this, n = e.getLabels();
                        ...
                        var o, r = this, a = Math.max(r.maxIndex + 1 - r.minIndex - (r.options.gridLines.offsetGridLines ? 0 : 1), 1);
                        ...
                        if (r.isHorizontal()) {
                            var u = r.width / a, c = u * (t - r.minIndex);
                            return (r.options.gridLines.offsetGridLines && i || r.maxIndex === r.minIndex && i) && (c += u / 2), r.left + Math.round(c)
                        }
                        var d = r.height / a, f = d * (t - r.minIndex);
                        return r.options.gridLines.offsetGridLines && i && (f += d / 2), r.top + Math.round(f)
                    }, getPixelForTick: function (e, t) {
                        return this.getPixelForValue(this.ticks[e], e + this.minIndex, null, t)
                    }, getValueForPixel: function (e) {
                        var t = this, n = Math.max(t.ticks.length - (t.options.gridLines.offsetGridLines ? 0 : 1), 1), i = t.isHorizontal(), o = (i ? t.width : t.height) / n;
            ...
            t.exports = function (e) {
                var t = e.helpers, n = {
                    position: "left",
                    ticks: {callback: e.Ticks.formatters.linear}
                    ...
                    determineDataLimits: function () {
                        ...
                        var n = this, i = n.options, o = n.chart, r = o.data, a = r.datasets, s = n.isHorizontal();
                        n.min = null, n.max = null;
                        var l = i.stacked;
                        if (void 0 === l && t.each(a, function (t, n) {
                                if (!l) {
                                    var i = o.getDatasetMeta(n);
                                    o.isDatasetVisible(n) && e(i) && void 0 !== i.stack && (l = !0)
                                }
                            }), i.stacked || l) {
                            var u = {};
                            t.each(a, function (r, a) {
                                var s = o.getDatasetMeta(a), l = [s.type, void 0 === i.stacked && void 0 === s.stack ? a : "", s.stack].join(".");
                                void 0 === u[l] && (u[l] = {positiveValues: [], negativeValues: []});
                                var c = u[l].positiveValues, d = u[l].negativeValues;
                                o.isDatasetVisible(a) && e(s) && t.each(r.data, function (e, t) {
                                    var o = +n.getRightValue(e);
                                    isNaN(o) || s.data[t].hidden || (c[t] = c[t] || 0, d[t] = d[t] || 0, i.relativePoints ? c[t] = 100 : o < 0 ? d[t] += o : c[t] += o)
                                })
                            }), t.each(u, function (e) {
                                var i = e.positiveValues.concat(e.negativeValues), o = t.min(i), r = t.max(i);
                                n.min = null === n.min ? o : Math.min(n.min, o), n.max = null === n.max ? r : Math.max(n.max, r)
                            })
                        } else t.each(a, function (i, r) {
                        ...
                        if (i.isHorizontal())n = Math.min(o.maxTicksLimit ? o.maxTicksLimit : 11, Math.ceil(i.width / 50)); else {
                        ...
                        var t, n = this, i = n.start, o = +n.getRightValue(e), r = n.end - i;
                        return n.isHorizontal() ? (t = n.left + n.width / r * (o - i), Math.round(t)) : (t = n.bottom - n.height / r * (o - i), Math.round(t))
                    }, getValueForPixel: function (e) {
                        var t = this, n = t.isHorizontal(), i = n ? t.width : t.height, o = (n ? e - t.left : t.bottom - e) / i;
            ...
            "use strict";
            t.exports = function (e) {
                var t = e.helpers, n = t.noop;
                e.LinearScaleBase = e.Scale.extend({
                    handleTickRangeOptions: function () {
                        var e = this, n = e.options, i = n.ticks;
                        if (i.beginAtZero) {
                            var o = t.sign(e.min), r = t.sign(e.max);
                            o < 0 && r < 0 ? e.max = 0 : o > 0 && r > 0 && (e.min = 0)
                        }
                        ...
                        var n = this, i = n.options, o = i.ticks, r = n.getTickLimit();
                        r = Math.max(2, r);
                        var a = {
                            maxTicks: r,
                            min: o.min,
                            max: o.max,
                            stepSize: t.getValueOrDefault(o.fixedStepSize, o.stepSize)
                        }, s = n.ticks = e.Ticks.generators.linear(a, n);
                        n.handleDirectionalChanges(), n.max = t.max(s), n.min = t.min(s), o.reverse ? (s.reverse(), n.start = n.max, n.end = n.min) : (n.start = n.min, n.end = n.max)
                    }, convertTicksToLabels: function () {
                        var t = this;
            ...
            t.exports = function (e) {
                var t = e.helpers, n = {
                    position: "left",
                    ticks: {callback: e.Ticks.formatters.logarithmic}
                }, i = e.Scale.extend({
                    determineDataLimits: function () {
                        function e(e) {
                            return u ? e.xAxisID === n.id : e.yAxisID === n.id
                        }

                        var n = this, i = n.options, o = i.ticks, r = n.chart, a = r.data, s = a.datasets, l = t.getValueOrDefault, u = n.isHorizontal();
                        n.min = null, n.max = null, n.minNotZero = null;
                        var c = i.stacked;
                        if (void 0 === c && t.each(s, function (t, n) {
                                if (!c) {
                            ...
                            var d = {};
                            t.each(s, function (o, a) {
                                var s = r.getDatasetMeta(a), l = [s.type, void 0 === i.stacked && void 0 === s.stack ? a : "", s.stack].join(".");
                                r.isDatasetVisible(a) && e(s) && (void 0 === d[l] && (d[l] = []), t.each(o.data, function (e, t) {
                                    var o = d[l], r = +n.getRightValue(e);
                                    isNaN(r) || s.data[t].hidden || (o[t] = o[t] || 0, i.relativePoints ? o[t] = 100 : o[t] += r)
                                }))
                            }), t.each(d, function (e) {
                                var i = t.min(e), o = t.max(e);
                                n.min = null === n.min ? i : Math.min(n.min, i), n.max = null === n.max ? o : Math.max(n.max, o)
                            })
                        } else t.each(s, function (i, o) {
                        ...
                        n.min = l(o.min, n.min), n.max = l(o.max, n.max), n.min === n.max && (0 !== n.min && null !== n.min ? (n.min = Math.pow(10, Math.floor(t.log10(n.min)) - 1), n.max = Math.pow(10, Math.floor(t.log10(n.max)) + 1)) : (n.min = 1, n.max = 10))
                    }, buildTicks: function () {
                        var n = this, i = n.options, o = i.ticks, r = {
                            min: o.min,
                            max: o.max
                        }, a = n.ticks = e.Ticks.generators.logarithmic(r, n);
                        n.isHorizontal() || a.reverse(), n.max = t.max(a), n.min = t.min(a), o.reverse ? (a.reverse(), n.start = n.max, n.end = n.min) : (n.start = n.min, n.end = n.max)
                    }, convertTicksToLabels: function () {
                        ...
                        var n, i, o, r = this, a = r.start, s = +r.getRightValue(e), l = r.options, u = l.ticks;
                        return r.isHorizontal() ? (o = t.log10(r.end) - t.log10(a), 0 === s ? i = r.left : (n = r.width, i = r.left + n / o * (t.log10(s) - t.log10(a)))) : (n = r.height, 0 !== a || u.reverse ? 0 === r.end && u.reverse ? (o = t.log10(r.start) - t.log10(r.minNotZero), i = s === r.end ? r.top : s === r.minNotZero ? r.top + .02 * n : r.top + .02 * n + .98 * n / o * (t.log10(s) - t.log10(r.minNotZero))) : 0 === s ? i = u.reverse ? r.top : r.bottom : (o = t.log10(r.end) - t.log10(a), n = r.height, i = r.bottom - n / o * (t.log10(s) - t.log10(a))) : (o = t.log10(r.end) - t.log10(r.minNotZero), i = s === a ? r.bottom : s === r.minNotZero ? r.bottom - .02 * n : r.bottom - .02 * n - .98 * n / o * (t.log10(s) - t.log10(r.minNotZero)))), i
                    }, getValueForPixel: function (e) {
                        var n, i, o = this, r = t.log10(o.end) - t.log10(o.start);
            ...
            t.exports = function (e) {
                ...
                function n(e) {
                    var t = e.options.pointLabels, n = h.getValueOrDefault(t.fontSize, p.defaultFontSize), i = h.getValueOrDefault(t.fontStyle, p.defaultFontStyle), o = h.getValueOrDefault(t.fontFamily, p.defaultFontFamily);
                    return {size: n, style: i, family: o, font: h.fontString(n, i, o)}
                }
                ...
                function r(e) {
                    var r, a, s, l = n(e), u = Math.min(e.height / 2, e.width / 2), c = {
                        r: e.width,
                        l: 0,
                        t: e.height,
                        b: 0
                    ...
                    var f = t(e);
                    for (r = 0; r < f; r++) {
                        s = e.getPointPosition(r, u), a = i(e.ctx, l.size, e.pointLabels[r] || ""), e._pointLabelSizes[r] = a;
                        var p = e.getIndexAngle(r), m = h.toDegrees(p) % 360, g = o(m, s.x, a.w, 0, 180), v = o(m, s.y, a.h, 90, 270);
                        g.start < c.l && (c.l = g.start, d.l = p), g.end > c.r && (c.r = g.end, d.r = p), v.start < c.t && (c.t = v.start, d.t = p), v.end > c.b && (c.b = v.end, d.b = p)
                    }
                ...
                function l(e, t, n, i) {
                    if (h.isArray(t))for (var o = n.y, r = 1.5 * i, a = 0; a < t.length; ++a)e.fillText(t[a], n.x, o), o += r; else e.fillText(t, n.x, n.y)
                }
                ...
                function c(e) {
                    var i = e.ctx, o = h.getValueOrDefault, r = e.options, a = r.angleLines, c = r.pointLabels;
                    i.lineWidth = a.lineWidth, i.strokeStyle = a.color;
                    var d = e.getDistanceFromCenterForValue(r.reverse ? e.min : e.max), f = n(e);
                    i.textBaseline = "top";
                    for (var m = t(e) - 1; m >= 0; m--) {
                        ...
                        if (c.display) {
                            var v = e.getPointPosition(m, d + 5), y = o(c.fontColor, p.defaultFontColor);
                            i.font = f.font, i.fillStyle = y;
                            var b = e.getIndexAngle(m), x = h.toDegrees(b);
                            i.textAlign = s(x), u(x, e._pointLabelSizes[m], v), l(i, e.pointLabels[m] || "", v, f.size)
                        }
                    }
                }
                ...
                function d(e, n, i, o) {
                    var r = e.ctx;
                    if (r.strokeStyle = h.getValueAtIndexOrDefault(n.color, o - 1), r.lineWidth = h.getValueAtIndexOrDefault(n.lineWidth, o - 1), e.options.gridLines.circular)r.beginPath(), r.arc(e.xCenter, e.yCenter, i, 0, 2 * Math.PI), r.closePath(), r.stroke(); else {
                        var a = t(e);
                        if (0 === a)return;
                        r.beginPath();
                ...
                var h = e.helpers, p = e.defaults.global, m = {
                    display: !0,
                    animate: !0,
                    position: "chartArea",
                    ...
                    setDimensions: function () {
                        ...
                        var i = h.min([e.height, e.width]), o = h.getValueOrDefault(n.fontSize, p.defaultFontSize);
                        ...
                        h.each(t.data.datasets, function (o, r) {
                            if (t.isDatasetVisible(r)) {
                                var a = t.getDatasetMeta(r);
                                h.each(o.data, function (t, o) {
                        ...
                        var e = this.options.ticks, t = h.getValueOrDefault(e.fontSize, p.defaultFontSize);
                        ...
                        var i = this, o = t.l / Math.sin(n.l), r = Math.max(t.r - i.width, 0) / Math.sin(n.r), a = -t.t / Math.cos(n.t), s = -Math.max(t.b - i.height, 0) / Math.cos(n.b);
                        o = f(o), r = f(r), a = f(a), s = f(s), i.drawingArea = Math.min(Math.round(e - (o + r) / 2), Math.round(e - (a + s) / 2)), i.setCenterPoint(o, r, a, s)
                    }, setCenterPoint: function (e, t, n, i) {
                        var o = this, r = o.width - t - o.drawingArea, a = e + o.drawingArea, s = n + o.drawingArea, l = o.height - i - o.drawingArea;
                        ...
                        var n = this, i = n.getIndexAngle(e) - Math.PI / 2;
                        return {x: Math.round(Math.cos(i) * t) + n.xCenter, y: Math.round(Math.sin(i) * t) + n.yCenter}
                        ...
                        var e = this, t = e.options, n = t.gridLines, i = t.ticks, o = h.getValueOrDefault;
                        if (t.display) {
                            var r = e.ctx, a = o(i.fontSize, p.defaultFontSize), s = o(i.fontStyle, p.defaultFontStyle), l = o(i.fontFamily, p.defaultFontFamily), u = h.fontString(a, s, l);
                            h.each(e.ticks, function (s, l) {
                                if (l > 0 || t.reverse) {
                                    var c = e.getDistanceFromCenterForValue(e.ticksAsNumbers[l]), f = e.yCenter - c;
                                    if (n.display && 0 !== l && d(e, n, c, l), i.display) {
                                        var h = o(i.fontColor, p.defaultFontColor);
                                        if (r.font = u, i.showLabelBackdrop) {
                                            var m = r.measureText(s).width;
                                            r.fillStyle = i.backdropColor, r.fillRect(e.xCenter - m / 2 - i.backdropPaddingX, f - a / 2 - i.backdropPaddingY, m + 2 * i.backdropPaddingX, a + 2 * i.backdropPaddingY)
                                        }
                                        r.textAlign = "center", r.textBaseline = "middle", r.fillStyle = h, r.fillText(s, e.xCenter, f)
                                    }
                                }
                            }), (t.angleLines.display || t.pointLabels.display) && c(e)
                        }
                    }
                });
            ...
            i = "function" == typeof i ? i : window.moment, t.exports = function (e) {
                ...
                function n(e, t, n, i) {
                    for (var o, r = Object.keys(s), a = r.length, l = r.indexOf(e); l < a; l++) {
                        o = r[l];
                        var u = s[o], c = u.steps && u.steps[u.steps.length - 1] || u.maxStep;
                        if (void 0 === c || Math.ceil((n - t) / (c * u.size)) <= i)break
                    }
                    return o
                }

                function o(e, t, n, i) {
                    var o = s[n], r = o.size, a = Math.ceil((t - e) / r), l = 1, u = t - e;
                    if (o.steps)for (var c = o.steps.length, d = 0; d < c && a > i; d++)l = o.steps[d], a = Math.ceil(u / (r * l)); else for (; a > i && i > 0;)++l, a = Math.ceil(u / (r * l));
                    return l
                }
                ...
                e.Ticks.generators.time = function (e, t) {
                    ...
                    return "week" === e.unit && a !== !1 ? (n = i(t.min).startOf("isoWeek").isoWeekday(a).valueOf(), o = i(t.max).startOf("isoWeek").isoWeekday(a), t.max - o > 0 && o.add(1, "week"), o = o.valueOf()) : (n = i(t.min).startOf(e.unit).valueOf(), o = i(t.max).startOf(e.unit), t.max - o > 0 && o.add(1, e.unit), o = o.valueOf()), r(e, t, {
                        min: n,
                        max: o
                    })
                };
                var u = e.Scale.extend({
                    initialize: function () {
                        ...
                        var e, n = this, i = n.options.time, o = Number.MAX_SAFE_INTEGER, r = Number.MIN_SAFE_INTEGER, s = n.chart.data, l = {
                            labels: [],
                            datasets: []
                        };
                        a.each(s.labels, function (a, s) {
                            var u = t(n, a);
                            u.isValid() && (i.round && u.startOf(i.round), e = u.valueOf(), o = Math.min(e, o), r = Math.max(e, r), l.labels[s] = e)
                        }), a.each(s.datasets, function (s, u) {
                            var c = [];
                            "object" == typeof s.data[0] && null !== s.data[0] && n.chart.isDatasetVisible(u) ? a.each(s.data, function (a, s) {
                                var l = t(n, n.getRightValue(a));
                                l.isValid() && (i.round && l.startOf(i.round), e = l.valueOf(), o = Math.min(e, o), r = Math.max(e, r), c[s] = e)
                            }) : c = l.labels.slice(), l.datasets[u] = c
                        }), n.dataMin = o, n.dataMax = r, n._parsedData = l
                    }, buildTicks: function () {
                        var i, r, s = this, l = s.options.time, u = s.dataMin, c = s.dataMax;
                        if (l.min) {
                            var d = t(s, l.min);
                            l.round && d.round(l.round), i = d.valueOf()
                        }
                        l.max && (r = t(s, l.max).valueOf());
                        var f = s.getLabelCapacity(i || u), h = l.unit || n(l.minUnit, i || u, r || c, f);
                        s.displayFormat = l.displayFormats[h];
                        var p = l.stepSize || o(i || u, r || c, h, f);
                        ...
                        }, {min: u, max: c}), s.max = a.max(s.ticks), s.min = a.min(s.ticks)
                    }, getLabelForIndex: function (e, n) {
                        var i = this, o = i.chart.data.labels && e < i.chart.data.labels.length ? i.chart.data.labels[e] : "", r = i.chart.data.datasets[n].data[e];
                        ...
                        var i = e.format(this.displayFormat), o = this.options.ticks, r = a.getValueOrDefault(o.callback, o.userCallback);
                        return r ? r(i, t, n) : i
                    }, convertTicksToLabels: function () {
                        var e = this;
                        ...
                        var t = this, n = t.max - t.min, i = n ? (e - t.min) / n : 0;
                        if (t.isHorizontal()) {
                            var o = t.width * i;
                        ...
                        var t = this, n = t.isHorizontal() ? t.width : t.height, o = (e - (t.isHorizontal() ? t.left : t.top)) / n;
                        return i(t.min + o * (t.max - t.min))
                    }, getLabelWidth: function (t) {
                        var n = this, i = n.options.ticks, o = n.ctx.measureText(t).width, r = Math.cos(a.toRadians(i.maxRotation)), s = Math.sin(a.toRadians(i.maxRotation));
                        ...
                        var n = t.tickFormatFunction(i(e), 0, []), o = t.getLabelWidth(n);
                        return (t.isHorizontal() ? t.width : t.height) / o
                    }
                });
                e.scaleService.registerScaleType("time", u, l)
            }
        }, {1: 1}]
    }, {}, [7])(7)
});
...
WOW.prototype._initStorageVariables = function () {
    ...
    this._animation[t] = {animationName: e.style.animationName || window.getComputedStyle(e, null).animationName}, e.style.animationName = "none", e.style.visibility = "hidden"
    ...
    return {delay: this._getDelay(e), duration: this._getDuration(e), iterations: this._getIterations(e)}
    ...
    var t = e.className.split(" "), n = t.indexOf(this._animateClass);
    ...
    var t = e.getAttribute("data-wow-offset") || this._offset, n = this._getElementOffset(e), i = n + ~~t;
    return i <= window.innerHeight + this._scrollY() && (0 === i ? 10 : i) >= this._scrollY()
}, WOW.prototype._getElementOffset = function (e) {
    var t = e.getBoundingClientRect(), n = document.body, i = this._scrollY(), o = document.documentElement.clientTop || n.clientTop || 0, r = t.top + i - o;
    return Math.round(r)
}, WOW.prototype._checkForChanges = function () {
    var e = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, t = new e(this._mutations.bind(this)), n = {
        childList: !0,
        subtree: !0
    };
...
$(window).scroll(function () {
    ...
    var c = c || {}, d = document.querySelectorAll.bind(document), f = Object.prototype.toString, h = "ontouchstart" in window, p = {
        duration: 750,
        delay: 200,
        show: function (e, t, n) {
    ...
    return c.init = function (e) {
        var t = document.body;
        e = e || {}, "duration" in e && (p.duration = e.duration), "delay" in e && (p.delay = e.delay), h && (t.addEventListener("touchstart", u, !1), t.addEventListener("touchcancel", g.registerEvent, !1), t.addEventListener("touchend", g.registerEvent, !1)), t.addEventListener("mousedown", u, !1)
    }, c.attach = function (e, t) {
        e = o(e), "[object Array]" === f.call(t) && (t = t.join(" ")), t = t ? " " + t : "";
        ...
        if (t = t || {}, t.wait = t.wait || 0, t.position = t.position || null, n)for (var i, a, s, l = {}, u = 0, c = {
            ...
            button: 1
                    ...
                    x: i.clientWidth / 2,
                    y: i.clientHeight / 2
                }, s = r(i), l.x = s.left + a.x, l.y = s.top + a.y, c.pageX = l.x, c.pageY = l.y, p.show(c, i), t.wait >= 0 && null !== t.wait) {
        ...
        e = o(e);
        for (var t = {type: "mouseup", button: 1}, n = 0, i = e.length; n < i; n++)p.hide(t, e[n])
        ...
        var t = ["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(function (e) {
            ...
            if (e.hasClass("validate")) {
                ...
                if (n && i)e.removeClass("valid").removeClass("invalid"); else {
                    var o = e.is(":valid"), r = +e.attr("length") || 0;
    ...
    e(document).ready(function () {
        e(document).on("click.card", ".card", function (t) {
            ...
            if (n.find(".card-reveal").length) {
                var i = e(t.target), o = i.is(".card-reveal .card-title"), r = i.is(".card-reveal .card-title i"), a = i.is(".card .activator"), s = i.is(".card .activator i");
                o || r ? n.find(".card-reveal").velocity({translateY: 0}, {
                    duration: 225,
                    queue: !1,
                ...
                }) : (a || s) && n.find(".card-reveal").css({display: "block"}).velocity("stop", !1).velocity({translateY: "-100%"}, {
                    duration: 300,
                    queue: !1,
                    easing: "easeInOutQuad"
                })
    ...
    function t() {
        var t = +e(this).attr("length"), n = +e(this).val().length, i = n <= t;
    ...
    e(["jquery"], function (e) {
        return function () {
            function t(e, t, n) {
                return p({type: w.error, iconClass: m().iconClasses.error, message: e, optionsOverride: n, title: t})
            }
            ...
            function i(e, t, n) {
                return p({type: w.info, iconClass: m().iconClasses.info, message: e, optionsOverride: n, title: t})
            }
            ...
            function p(t) {
                ...
                function r() {
                    t.title && (k.append(t.title).addClass(p.titleClass), C.append(k))
                }

                function a() {
                    t.message && (T.append(t.message).addClass(p.messageClass), C.append(T))
                }
                ...
                function c() {
                    (p.timeOut > 0 || p.extendedTimeOut > 0) && (w = setTimeout(u, p.extendedTimeOut), E.maxHideTime = parseFloat(p.extendedTimeOut), E.hideEta = (new Date).getTime() + E.maxHideTime)
                }
                ...
                var p = m(), y = t.iconClass || p.iconClass;
                if (void 0 !== t.optionsOverride && (p = e.extend(p, t.optionsOverride), y = t.optionsOverride.iconClass || y), !function (e, t) {
                    ...
                    x++, v = n(p, !0);
                    var w = null, C = e("<div/>"), k = e("<div/>"), T = e("<div/>"), _ = e("<div/>"), S = e(p.closeHtml), E = {
                        intervalId: null,
                        hideEta: null,
                        maxHideTime: null
                    }, A = {toastId: x, state: "visible", startTime: new Date, options: p, map: t};
                    return function () {
                        i(), r(), a(), s(), l(), o()
                    }(), function () {
                        C.hide(), C[p.showMethod]({
                            ...
                            easing: p.showEasing,
                            complete: p.onShown
                        }), p.timeOut > 0 && (w = setTimeout(u, p.timeOut), E.maxHideTime = parseFloat(p.timeOut), E.hideEta = (new Date).getTime() + E.maxHideTime, p.progressBar && (E.intervalId = setInterval(f, 10)))
                    }(), function () {
                        C.hover(d, c), !p.onclick && p.tapToDismiss && C.click(u), p.closeButton && S && S.click(function (e) {
                            e.stopPropagation ? e.stopPropagation() : void 0 !== e.cancelBubble && e.cancelBubble !== !0 && (e.cancelBubble = !0), u(!0)
    ...
    e.preventDefault();
    var t = $(this).attr("href"), n = $(this).attr("data-offset") ? $(this).attr("data-offset") : 0, i = $(this).closest("ul").attr("data-allow-hashes");
    $("body,html").animate({scrollTop: $(t).offset().top - n}, 700), void 0 !== i && i !== !1 && history.replaceState(null, null, t)
}), function (e) {
    e.fn.scrollTo = function (t) {
        ...
        this.each(function () {
            ...
            function o(t) {
                ...
                var n = window.innerHeight, o = a.innerHeight(), r = a.offset().left, c = a.offset().top - e(window).scrollTop(), d = s.alignment, f = 0, h = 0, p = 0;
                s.belowOrigin === !0 && (p = o);
                var m = 0, g = a.parent();
                if (!g.is("body") && g[0].scrollHeight > g[0].clientHeight && (m = g[0].scrollTop), r + u.innerWidth() > e(window).width() ? d = "right" : r - u.innerWidth() + a.innerWidth() < 0 && (d = "left"), c + u.innerHeight() > n)if (c + o - u.innerHeight() < 0) {
                    var v = n - c - p;
                    u.css("max-height", v)
                } else p || (p += o), p -= u.innerHeight();
                if ("left" === d)f = s.gutter, h = a.position().left + f; else if ("right" === d) {
...
dropdownSelectors.on({
    ...
    function T(e) {
        ...
        return new (t ? t : Ce ? W : ke ? j : we ? z : R)(e, _)
    }

    function _(e, t, n) {
        var i = n.pointers.length, o = n.changedPointers.length, r = t & _e && i - o == 0, a = t & (Ee | Ae) && i - o == 0;
    ...
    function S(e, t) {
        ...
        var r = n.firstInput, a = n.firstMultiple, s = a ? a.center : r.center, l = t.center = D(i);
        ...
        t.overallVelocityX = u.x, t.overallVelocityY = u.y, t.overallVelocity = me(u.x) > me(u.y) ? u.x : u.y, t.scale = a ? N(a.pointers, i) : 1, t.rotation = a ? F(a.pointers, i) : 0, t.maxPointers = n.prevInput ? t.pointers.length > n.prevInput.maxPointers ? t.pointers.length : n.prevInput.maxPointers : t.pointers.length, A(n, t);
        var c = e.element;
    ...
    function A(e, t) {
        ...
        if (t.eventType != Ae && (l > Te || s.velocity === i)) {
            var u = t.deltaX - s.deltaX, c = t.deltaY - s.deltaY, d = O(l, u, c);
            o = d.x, r = d.y, n = me(d.x) > me(d.y) ? d.x : d.y, a = P(u, c), e.lastInterval = t
    ...
    function I(e) {
        ...
        return {timeStamp: ge(), pointers: t, center: D(t), deltaX: e.deltaX, deltaY: e.deltaY}
    }
    ...
    function B(e, t) {
        ...
        if (r = n.filter(function (e) {
                return p(e.target, l)
            }), t === _e)for (o = 0; o < r.length;)i[r[o].identifier] = !0, o++;
    ...
    function Q(e) {
        this.options = ce({}, this.defaults, e || {}), this.id = w(), this.manager = null, this.options.enable = d(this.options.enable, !0), this.state = st, this.simultaneous = {}, this.requireFail = []
    }

    function G(e) {
        return e & ft ? "cancel" : e & ct ? "end" : e & ut ? "move" : e & lt ? "start" : ""
    }
    ...
    function se(e, t) {
        this.options = ce({}, ae.defaults, t || {}), this.options.inputTarget = this.options.inputTarget || e, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = e, this.input = T(this), this.touchAction = new X(this, this.options.touchAction), le(this, !0), a(this.options.recognizers, function (e) {
    ...
    var ce, de = ["", "webkit", "Moz", "MS", "ms", "o"], fe = t.createElement("div"), he = "function", pe = Math.round, me = Math.abs, ge = Date.now;
    ...
    var ve = s(function (e, t, n) {
        ...
        return ve(e, t, !0)
    }, "merge", "Use `assign`."), be = 1, xe = /mobile|tablet|ip(ad|hone|od)|android/i, we = "ontouchstart" in e, Ce = x(e, "PointerEvent") !== i, ke = we && xe.test(navigator.userAgent), Te = 25, _e = 1, Se = 2, Ee = 4, Ae = 8, Ie = 1, De = 2, Oe = 4, Pe = 8, Me = 16, Le = De | Oe, Fe = Pe | Me, Ne = Le | Fe, Re = ["x", "y"], We = ["clientX", "clientY"];
    k.prototype = {
        handler: function () {
        }, init: function () {
    ...
    var He = {mousedown: _e, mousemove: Se, mouseup: Ee}, Ve = "mousedown", je = "mousemove mouseup";
    l(R, k, {
        handler: function (e) {
            var t = He[e.type];
    ...
    var Be = {pointerdown: _e, pointermove: Se, pointerup: Ee, pointercancel: Ae, pointerout: Ae}, ze = {
        2: "touch",
        3: "pen",
        4: "mouse",
        5: "kinect"
    ...
    e.MSPointerEvent && !e.PointerEvent && (qe = "MSPointerDown", $e = "MSPointerMove MSPointerUp MSPointerCancel"), l(W, k, {
        handler: function (e) {
            var t = this.store, n = !1, i = e.type.toLowerCase().replace("ms", ""), o = Be[i], r = ze[e.pointerType] || e.pointerType, a = "touch" == r, s = v(t, e.pointerId, "pointerId");
    ...
    var Ye = {
        ...
        touchend: Ee,
        touchcancel: Ae
    }, Xe = "touchstart", Ue = "touchstart touchmove touchend touchcancel";
    l(H, k, {
        handler: function (e) {
            var t = Ye[e.type];
    ...
    l(j, k, {
        handler: function (e) {
            var t = Qe[e.type], n = B.call(this, e, t);
    ...
    var Je = x(fe.style, "touchAction"), et = Je !== i, tt = "auto", nt = "manipulation", it = "none", ot = "pan-x", rt = "pan-y", at = function () {
        if (!et)return !1;
    ...
    X.prototype = {
        set: function (e) {
            ...
            return a && r ? void 0 : o || r && n & Le || a && n & Fe ? this.preventSrc(t) : void 0
        }, preventSrc: function (e) {
            this.manager.session.prevented = !0, e.preventDefault()
        }
    };
    var st = 1, lt = 2, ut = 4, ct = 8, dt = ct, ft = 16;
    Q.prototype = {
        defaults: {}, set: function (e) {
            ...
            this.state & (dt | ft | 32) && (this.state = st), this.state = this.process(t), this.state & (lt | ut | ct | ft) && this.tryEmit(t)
        }, process: function (e) {
        ...
        defaults: {pointers: 1}, attrTest: function (e) {
            ...
            return i && (n & Ae || !o) ? t | ft : i || o ? n & Ee ? t | ct : t & lt ? t | ut : lt : 32
        }
    }), l(ee, J, {
        ...
        defaults: {event: "press", pointers: 1, time: 251, threshold: 9}, getTouchAction: function () {
            ...
            if (this._input = e, !i || !n || e.eventType & (Ee | Ae) && !r)this.reset(); else if (e.eventType & _e)this.reset(), this._timer = o(function () {
                this.state = dt, this.tryEmit()
            }, t.time, this); else if (e.eventType & Ee)return dt;
            return 32
        }, reset: function () {
        ...
        defaults: {event: "swipe", threshold: 10, velocity: .3, direction: Le | Fe, pointers: 1},
        getTouchAction: function () {
        ...
        defaults: {
            ...
            if (i && r && n) {
                ...
                var a = !this.pTime || e.timeStamp - this.pTime < t.interval, s = !this.pCenter || M(this.pCenter, e.center) < t.posThreshold;
...
!function (e) {
    var t = 240, n = 1440, i = function () {
        function i(o, r) {
            var a = this;
            _classCallCheck(this, i);
            var s = !1, l = {menuWidth: t, edge: "left", closeOnClick: !1};
            r = e.extend(l, r), this.options = r;
            var u = o;
            this.menu_id = e("#" + u.attr("data-activates"));
            var c = e("#" + this.menu_id.attr("id") + "> .sidenav-bg");
            r.menuWidth != t && (this.menu_id.css("width", r.menuWidth), c.css("width", r.menuWidth));
            var d = e('<div class="drag-target"></div>');
            e("body").append(d), "left" == r.edge ? (this.menu_id.css("transform", "translateX(-100%)"), d.css({left: 0})) : (this.menu_id.addClass("right-aligned").css("transform", "translateX(100%)"), d.css({right: 0})), this.menu_id.hasClass("fixed") && (window.innerWidth > n && this.menu_id.css("transform", "translateX(0)"), e(window).resize(function () {
                window.innerWidth > n ? e("#sidenav-overlay").length ? a.removeMenu(!0) : a.menu_id.css("transform", "translateX(0%)") : s === !1 && ("left" === r.edge ? a.menu_id.css("transform", "translateX(-100%)") : a.menu_id.css("transform", "translateX(100%)"))
            })), this.options.closeOnClick === !0 && this.menu_id.on("click", "a:not(.collapsible-header)", function () {
                sn.removeMenu()
            }), u.click(function (t) {
                if (t.preventDefault(), s === !0)s = !1, a.removeMenu(); else {
                    var n = e("body"), i = e('<div id="sidenav-overlay"></div>');
                    n.append(i), "left" === a.options.edge ? a.menu_id.velocity({translateX: [0, -1 * r.menuWidth]}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    }) : a.menu_id.velocity({translateX: [0, r.menuWidth]}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), i.click(function () {
                ...
                a.removeMenu()
            }), d.hammer({prevent_default: !1}).bind("pan", function (t) {
                if ("touch" == t.gesture.pointerType) {
                    var n = (t.gesture.direction, t.gesture.center.x), i = (t.gesture.center.y, t.gesture.velocityX, e("body")), o = i.innerWidth();
                    ...
                    if ("left" === r.edge && (n > r.menuWidth ? n = r.menuWidth : n < 0 && (n = 0)), "left" === r.edge)n < r.menuWidth / 2 ? s = !1 : n >= r.menuWidth / 2 && (s = !0), a.menu_id.css("transform", "translateX(" + (n - r.menuWidth) + "px)"); else {
                        n < window.innerWidth - r.menuWidth / 2 ? s = !0 : n >= window.innerWidth - r.menuWidth / 2 && (s = !1);
                        var u = n - r.menuWidth / 2;
                        u < 0 && (u = 0), a.menu_id.css("transform", "translateX(" + u + "px)")
                    }
                    var c;
                    "left" === r.edge ? (c = n / r.menuWidth, e("#sidenav-overlay").velocity({opacity: c}, {
                        duration: 10,
                        queue: !1,
                        easing: "easeOutQuad"
                    })) : (c = Math.abs((n - window.innerWidth) / r.menuWidth), e("#sidenav-overlay").velocity({opacity: c}, {
                        duration: 10,
                        queue: !1,
                        easing: "easeOutQuad"
                    }))
                ...
                if ("touch" == t.gesture.pointerType) {
                    var n = t.gesture.velocityX, i = t.gesture.center.x, o = i - r.menuWidth, l = i - r.menuWidth / 2;
                    o > 0 && (o = 0), l < 0 && (l = 0), "left" === r.edge ? s && n <= .3 || n < -.5 ? (0 != o && a.menu_id.velocity({translateX: [0, o]}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                        ...
                        queue: !1,
                        easing: "easeOutQuad"
                    }), d.css({width: "10px", right: "", left: 0})) : (!s || n > .3) && (e("body").css({
                        overflow: "",
                        width: ""
                    }), a.menu_id.velocity({translateX: [-1 * r.menuWidth - 10, o]}, {
                        duration: 200,
                        queue: !1,
                        easing: "easeOutQuad"
                        ...
                        right: "",
                        left: 0
                    })) : s && n >= -.3 || n > .5 ? (a.menu_id.velocity({translateX: [0, l]}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), e("#sidenav-overlay").velocity({opacity: 1}, {
                        ...
                        queue: !1,
                        easing: "easeOutQuad"
                    }), d.css({width: "50%", right: "", left: 0})) : (!s || n < -.3) && (e("body").css({
                        overflow: "",
                        width: ""
                    }), a.menu_id.velocity({translateX: [r.menuWidth + 10, l]}, {
                        duration: 200,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), e("#sidenav-overlay").velocity({opacity: 0}, {
        ...
        return _createClass(i, [{
            key: "removeMenu", value: function (t) {
                ...
                e("body").css({
                    ...
                    easing: "easeOutCubic",
                    complete: function () {
                        t === !0 && (n.menu_id.removeAttr("style"), n.menu_id.css("width", n.options.menuWidth))
                    }
    ...
    e.fn.collapsible = function (t) {
        ...
        return t = e.extend(n, t), this.each(function () {
            ...
            var a = e(this), s = e(this).find("> li > .collapsible-header"), l = a.data("collapsible");
    ...
    var t = function (e, t) {
        ...
        this.getCanvas = function () {
            ...
            t.scaleColor || t.trackColor ? o.getImageData && o.putImageData ? n ? o.putImageData(n, 0, 0) : (c(), n = o.getImageData(0, 0, t.size * r, t.size * r)) : (this.clear(), c()) : this.clear(), o.lineCap = t.lineCap;
            var i;
            ...
            t.onStart(e, n);
            var o = function () {
                var r = Math.min(Date.now() - i, t.animate.duration), a = t.easing(this, r, e, n - e, t.animate.duration);
                this.draw(a), t.onStep(e, n, a), r >= t.animate.duration ? t.onStop(e, n) : u(o)
            }.bind(this);
            u(o)
        }.bind(this)
    }, n = function (e, n) {
    ...
    var t = "input[type=range]", n = !1, i = void 0, o = function () {
    ...
    e(t).each(o), e(document).on("change", t, function (t) {
        ...
        var r = e(this), a = r.siblings(".thumb"), s = (a.find(".value"), r.outerWidth());
        (!a.length && o(), a.find(".value").html(r.val()), n = !0, r.addClass("active"), a.hasClass("active") || a.velocity({
            height: "30px",
            width: "30px",
            top: "-20px",
            marginLeft: "-15px"
            ...
            duration: 300,
            easing: "easeOutExpo"
        }), "input" !== t.type) && (i = void 0 === t.pageX || null === t.pageX ? t.originalEvent.touches[0].pageX - e(this).offset().left : t.pageX - e(this).offset().left, i < 0 ? i = 0 : i > s && (i = s), a.addClass("active").css("left", i));
        ...
        if (!n) {
            ...
            i.hasClass("active") && i.velocity({
                ...
                top: "10px",
                marginLeft: "-6px"
            }, {duration: 100}), i.removeClass("active")
        }
    })
}(jQuery), function (e) {
    e(document).on("change", '.file-field input[type="file"]', function (t) {
        for (var n = e(t.target), i = n.closest(".file-field"), o = i.find("input.file-path"), r = n[0].files, a = [], s = 0; s < r.length; s++) {
            var l = r[s].name;
            a.push(l)
        }
        o.val(a.join(", ")), o.trigger("change")
    })
}(jQuery), function (e) {
    e.fn.material_select = function (t) {
        ...
        e(this).each(function () {
            ...
            if (!i.hasClass("browser-default")) {
                var r = !!i.attr("multiple"), a = !1, s = !1, l = i.data("select-id");
                if (l && (i.parent().find("span.caret").remove(), i.parent().find("input").remove(), i.unwrap(), e("ul#select-options-" + l).remove()), "destroy" === t)return void i.data("select-id", null).removeClass("initialized");
                var u = o();
                i.data("select-id", u);
                var c = e('<div class="select-wrapper"></div>');
                c.addClass(i.attr("class"));
                var d = e('<ul id="select-options-' + u + '" class="dropdown-content select-dropdown ' + (r ? "multiple-select-dropdown" : "") + '"></ul>'), f = i.children("option, optgroup"), h = [], p = !1, m = i.find("option:selected").html() || i.find("option:first").html() || "", g = function () {
                ...
                v && function () {
                    var t = i.attr("searchable"), n = e('<span class="search-wrap"><input type="text" class="search" placeholder="' + t + '"></span>');
                ...
                var y = function (t, n, i) {
                    ...
                    var l = n.data("icon"), u = n.attr("class");
                    if (l) {
                        var c = "";
                        return u && (c = ' class="' + u + '"'), "multiple" === i ? d.append(e('<li class="' + o + '"><img alt="" src="' + l + '"' + c + '><span class="filtrable"><input type="checkbox"' + o + "/><label></label>" + n.html() + "</span></li>")) : d.append(e('<li class="' + o + r + '"><img alt="" src="' + l + '"' + c + '><span class="filtrable">' + n.html() + "</span></li>")), !0
                    }
                ...
                f.length && f.each(function () {
                    if (e(this).is("option"))r ? y(i, e(this), "multiple") : y(i, e(this)); else if (e(this).is("optgroup")) {
                    ...
                    e(this).click(function (l) {
                        if (!e(this).hasClass("disabled") && !e(this).hasClass("optgroup")) {
                            ...
                            r && a ? (e('input[type="checkbox"]', this).prop("checked", function (e, t) {
                                return !t
                            }), u = n(h, e(this).index(), i)) : r && s ? (e('input[type="checkbox"]', this).prop("checked", function (e, t) {
                                return !t
                            }), u = n(h, e(this).index() - 1, i), w.trigger("focus")) : r ? (e('input[type="checkbox"]', this).prop("checked", function (e, t) {
                                return !t
                            }), u = n(h, e(this).index(), i), w.trigger("focus")) : (d.find("li").removeClass("active"), e(this).toggleClass("active"), w.val(e(this).text())), C(d, e(this)), i.find("option").eq(o).prop("selected", u), i.trigger("change"), void 0 !== t && t()
                        }
                        l.stopPropagation()
                    })
                }), i.wrap(c);
                ...
                var x = m.replace(/"/g, "&quot;"), w = e('<input type="text" class="select-dropdown" readonly="true" ' + (i.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + u + '" value="' + x + '"/>');
                ...
                var C = function (t, n) {
                    ...
                    if (9 == t.which)return void w.trigger("close");
                    if (40 == t.which && !d.is(":visible"))return void w.trigger("open");
                    if (13 != t.which || d.is(":visible")) {
                        t.preventDefault();
                        var n = String.fromCharCode(t.which).toLowerCase(), i = [9, 13, 27, 38, 40];
                        if (n && i.indexOf(t.which) === -1) {
                            k.push(n);
                            var o = k.join(""), a = d.find("li").filter(function () {
    ...
    function t(r, a, l, f) {
        ...
        function p() {
            _.data(a, E).addClass(T.input).val(_.data("value") ? E.get("select", k.format) : r.value), k.editable || _.on("focus." + C.id + " click." + C.id, function (e) {
                e.preventDefault(), E.open()
            }).on("keydown." + C.id, x), o(r, {haspopup: !0, expanded: !1, readonly: !1, owns: r.id + "_root"})
        }
        ...
        function g() {
            E.$holder.on({
                keydown: x, "focus.toOpen": b, blur: function () {
                ...
                var t = e(this), n = t.data(), i = t.hasClass(T.navDisabled) || t.hasClass(T.disabled), o = s();
                o = o && (o.type || o.href), (i || o && !e.contains(E.$root[0], o)) && E.$holder[0].focus(), !i && n.nav ? E.set("highlight", E.component.item.highlight, {nav: n.nav}) : !i && "pick" in n ? (E.set("select", n.pick), k.closeOnSelect && E.close(!0)) : n.clear ? (E.clear(), k.closeOnClear && E.close(!0)) : n.close && E.close(!0)
            })
        }

        function v() {
            var t;
            k.hiddenName === !0 ? (t = r.name, r.name = "") : (t = ["string" == typeof k.hiddenPrefix ? k.hiddenPrefix : "", "string" == typeof k.hiddenSuffix ? k.hiddenSuffix : "_submit"], t = t[0] + r.name + t[1]), E._hidden = e('<input type=hidden name="' + t + '"' + (_.data("value") || r.value ? ' value="' + E.get("select", k.formatSubmit) + '"' : "") + ">")[0], _.on("change." + C.id, function () {
                E._hidden.value = r.value ? E.get("select", k.formatSubmit) : ""
            })
        }

        function y() {
            w && d ? E.$holder.find("." + T.frame).one("transitionend", function () {
                E.$holder[0].focus()
            }) : E.$holder[0].focus()
        }
        ...
        if (!r)return t;
        var w = !1, C = {id: r.id || "P" + Math.abs(~~(Math.random() * new Date))}, k = l ? e.extend(!0, {}, l.defaults, f) : f || {}, T = e.extend({}, t.klasses(), k.klass), _ = e(r), S = function () {
            return this.start()
        }, E = S.prototype = {
            constructor: S, $node: _, start: function () {
                ...
                return t ? (E.$holder = e(h()), g(),
                    E.$root.html(E.$holder)) : E.$root.find("." + T.box).html(E.component.nodes(C.open)), E.trigger("render")
            }, stop: function () {
                return C.start ? (E.close(), E._hidden && E._hidden.parentNode.removeChild(E._hidden), E.$root.remove(), _.removeClass(T.input).removeData(a), setTimeout(function () {
                    _.off("." + C.id)
                ...
                }, 0), n !== !1 && (C.open = !0, w && c.css("overflow", "hidden").css("padding-right", "+=" + i()), y(), u.on("click." + C.id + " focusin." + C.id, function (e) {
                    var t = e.target;
                    t != r && t != document && 3 != e.which && E.close(t === E.$holder[0])
                }).on("keydown." + C.id, function (n) {
                    var i = n.keyCode, o = E.component.key[i], r = n.target;
                ...
                }, 0), C.open ? (C.open = !1, w && c.css("overflow", "").css("padding-right", "-=" + i()), u.off("." + C.id), E.trigger("close")) : E
            }, clear: function (e) {
    ...
    function i() {
        ...
        var i = e('<div style="width:100%" />').appendTo(t), o = i[0].offsetWidth;
        return t.remove(), n - o
    }

    function o(t, n, i) {
        if (e.isPlainObject(n))for (var o in n)r(t, o, n[o]); else r(t, n, i)
    }
    ...
    var l = e(window), u = e(document), c = e(document.documentElement), d = null != document.documentElement.style.transition;
    ...
    function n(e, t) {
        var n = this, i = e.$node[0], o = i.value, r = e.$node.data("value"), a = r || o, s = r ? t.formatSubmit : t.format, l = function () {
    ...
    n.prototype.set = function (e, t, n) {
        ...
        if (l || u) {
            for (u ? (r = n.year, a = n.month, s = n.date) : (r = +n[0], a = +n[1], s = +n[2]), i && i.nav && c && c.month !== a && (r = c.year, a = c.month), o = new Date(r, a + (i && i.nav ? i.nav : 0), 1), r = o.getFullYear(), a = o.getMonth(); new Date(r, a, s).getMonth() !== a;)s -= 1;
            n = [r, a, s]
        }
        return n
        ...
        var r, a, s, l, u = this, c = n, d = o && o.interval ? o.interval : 1, f = u.item.enable === -1, h = u.item.min, p = u.item.max, m = f && u.item.disable.filter(function (e) {
                if (t.isArray(e)) {
        ...
        return o = o.length && !o.filter(function (e) {
            ...
            }).length, n.item.enable === -1 ? !o : o || e.pick < n.item.min.pick || e.pick > n.item.max.pick
    }, n.prototype.parse = function (e, t, n) {
        var o = this, r = {};
        return t && "string" == typeof t ? (n && n.format || (n = n || {}, n.format = o.settings.format), o.formats.toArray(n.format).map(function (e) {
        ...
        var t = this, n = t.settings, o = t.item, r = o.now, a = o.select, s = o.highlight, l = o.view, u = o.disable, c = o.min, d = o.max, f = function (e, t) {
        ...
        }((n.showWeekdaysFull ? n.weekdaysFull : n.weekdaysShort).slice(0), n.weekdaysFull.slice(0)), h = function (e) {
            return i.node("div", " ", n.klass["nav" + (e ? "Next" : "Prev")] + (e && l.year >= d.year && l.month >= d.month || !e && l.year <= c.year && l.month <= c.month ? " " + n.klass.navDisabled : ""), "data-nav=" + (e || -1) + " " + i.ariaAttr({
                    role: "button",
            ...
            return n.selectMonths ? i.node("select", i.group({
                ...
                node: "option",
                item: function (e) {
                    return [o[e], 0, "value=" + e + (l.month == e ? " selected" : "") + (l.year == c.year && e < c.month || l.year == d.year && e > d.month ? " disabled" : "")]
                }
            }), n.klass.selectMonth, (e ? "" : "disabled") + " " + i.ariaAttr({controls: t.$node[0].id + "_table"}) + ' title="' + n.labelMonthSelect + '"') : i.node("div", o[l.month], n.klass.month)
        }, m = function () {
            var o = l.year, r = n.selectYears === !0 ? 5 : ~~(n.selectYears / 2);
            if (r) {
                var a = c.year, s = d.year, u = o - r, f = o + r;
                if (a > u && (f += a - u, u = a), s < f) {
                    var h = u - a, p = f - s;
                    u -= h > p ? p : h, f = s
                }
                return i.node("select", i.group({
                    min: u, max: f, i: 1, node: "option", item: function (e) {
                        return [e, 0, "value=" + e + (o == e ? " selected" : "")]
                    }
                }), n.klass.selectYear, (e ? "" : "disabled") + " " + i.ariaAttr({controls: t.$node[0].id + "_table"}) + ' title="' + n.labelYearSelect + '"')
            }
                    ...
                    item: function (e) {
                        ...
                        return [i.group({
                            min: 7 * e - l.day + o + 1, max: function () {
                                ...
                                var o = a && a.pick == e.pick, f = s && s.pick == e.pick, h = u && t.disabled(e) || e.pick < c.pick || e.pick > d.pick, p = i.trigger(t.formats.toString, t, [n.format, e]);
                                return [i.node("div", e.date, function (t) {
                                    return t.push(l.month == e.month ? n.klass.infocus : n.klass.outfocus), r.pick == e.pick && t.push(n.klass.now), o && t.push(n.klass.selected), f && t.push(n.klass.highlighted), h && t.push(n.klass.disabled), t.join(" ")
    ...
    selectMonths: !0, selectYears: 15, onRender: function () {
        var e = this.$root, t = this.get("highlight", "yyyy"), n = this.get("highlight", "dd"), i = this.get("highlight", "mmm"), o = this.get("highlight", "dddd");
    ...
    function i(i, a) {
        function l(e, t) {
            var n = d.offset(), i = /^touch/.test(e.type), o = n.left + v, r = n.top + v, l = (i ? e.originalEvent.touches[0] : e).pageX - o, c = (i ? e.originalEvent.touches[0] : e).pageY - r, f = Math.sqrt(l * l + c * c), m = !1;
            if (!t || !(f < y - x || f > y + x)) {
                e.preventDefault();
                var g = setTimeout(function () {
                    I.popover.addClass("clockpicker-moving")
                }, 200);
                u && d.append(I.canvas), I.setHand(l, c, !t, !0), s.off(h).on(h, function (e) {
                    e.preventDefault();
                    var t = /^touch/.test(e.type), n = (t ? e.originalEvent.touches[0] : e).pageX - o, i = (t ? e.originalEvent.touches[0] : e).pageY - r;
                    (m || n !== l || i !== c) && (m = !0, I.setHand(n, i, !1, !0))
                }), s.off(p).on(p, function (e) {
                    s.off(p), e.preventDefault();
                    var n = /^touch/.test(e.type), i = (n ? e.originalEvent.changedTouches[0] : e).pageX - o, u = (n ? e.originalEvent.changedTouches[0] : e).pageY - r;
                    (t || m) && i === l && u === c && I.setHand(i, u), "hours" === I.currentView ? I.toggleView("minutes", C / 2) : a.autoclose && (I.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
                        I.done()
        ...
        var c = r(k), d = c.find(".clockpicker-plate"), m = c.find(".picker__holder"), g = c.find(".clockpicker-hours"), T = c.find(".clockpicker-minutes"), _ = c.find(".clockpicker-am-pm-block"), S = "INPUT" === i.prop("tagName"), E = S ? i : i.find("input"), A = r("label[for=" + E.attr("id") + "]"), I = this;
        if (this.id = n("cp"), this.element = i, this.holder = m, this.options = a, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = S, this.input = E, this.label = A, this.popover = c, this.plate = d, this.hoursView = g, this.minutesView = T, this.amPmBlock = _, this.spanHours = c.find(".clockpicker-span-hours"), this.spanMinutes = c.find(".clockpicker-span-minutes"), this.spanAmPm = c.find(".clockpicker-span-am-pm"), this.footer = c.find(".picker__footer"), this.amOrPm = "PM", a.twelvehour) {
        ...
        if (a.twelvehour)for (O = 1; O < 13; O += 1)P = F.clone(), M = O / 6 * Math.PI, L = y, P.css("font-size", "140%"), P.css({
            left: v + Math.sin(M) * L - x,
            top: v - Math.cos(M) * L - x
        }), P.html(0 === O ? "00" : O), g.append(P), P.on(f, l); else for (O = 0; O < 24; O += 1) {
            P = F.clone(), M = O / 6 * Math.PI;
            var N = O > 0 && O < 13;
            L = N ? b : y, P.css({
                left: v + Math.sin(M) * L - x,
                top: v - Math.cos(M) * L - x
            }), N && P.css("font-size", "120%"), P.html(0 === O ? "00" : O), g.append(P), P.on(f, l)
        }
        for (O = 0; O < 60; O += 5)P = F.clone(), M = O / 30 * Math.PI, P.css({
            left: v + Math.sin(M) * y - x,
            top: v - Math.cos(M) * y - x
        }), P.css("font-size", "140%"), P.html(t(O)), T.append(P), P.on(f, l);
        if (d.on(f, function (e) {
                0 === r(e.target).closest(".clockpicker-tick").length && l(e, !0)
            }), u) {
            var R = c.find(".clockpicker-canvas"), W = e("svg");
    ...
    var r = window.jQuery, a = r(window), s = r(document), l = "http://www.w3.org/2000/svg", u = "SVGAngle" in window && function () {
    ...
    i.DEFAULTS = {
        ...
        var t = this.currentView, n = this[t], i = "hours" === t, o = Math.PI / (i ? 6 : 30), r = n * o, a = i && n > 0 && n < 13 ? b : y, s = Math.sin(r) * a, l = -Math.cos(r) * a, c = this;
        u && e ? (c.canvas.addClass("clockpicker-canvas-out"), setTimeout(function () {
            c.canvas.removeClass("clockpicker-canvas-out"), c.setHand(s, l)
        }, e)) : this.setHand(s, l)
    }, i.prototype.setHand = function (e, n, i, o) {
        var a, s = Math.atan2(e, -n), l = "hours" === this.currentView, c = Math.PI / (l || i ? 6 : 30), d = Math.sqrt(e * e + n * n), f = this.options, h = l && d < (y + b) / 2, p = h ? b : y;
        if (f.twelvehour && (p = y), s < 0 && (s = 2 * Math.PI + s), a = Math.round(s / c), s = a * c, f.twelvehour ? l ? 0 === a && (a = 12) : (i && (a *= 5), 60 === a && (a = 0)) : l ? (12 === a && (a = 0), a = h ? 0 === a ? 12 : a : 0 === a ? 0 : a + 12) : (i && (a *= 5), 60 === a && (a = 0)), l ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : a % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"), this[this.currentView] !== a && m && this.options.vibrate && (this.vibrateTimer || (navigator[m](10), this.vibrateTimer = setTimeout(r.proxy(function () {
                this.vibrateTimer = null
            }, this), 100))), this[this.currentView] = a, this[l ? "spanHours" : "spanMinutes"].html(t(a)), !u)return void this[l ? "hoursView" : "minutesView"].find(".clockpicker-tick").each(function () {
            var e = r(this);
        ...
        var g = Math.sin(s) * (p - x), v = -Math.cos(s) * (p - x), w = Math.sin(s) * p, C = -Math.cos(s) * p;
    ...
    return function (e, t, n, i) {
        var o = {
            features: null, bind: function (e, t, n, i) {
                ...
                if (i.oldIE = document.all && !document.addEventListener, i.touch = "ontouchstart" in window, window.requestAnimationFrame && (i.raf = window.requestAnimationFrame,
                ...
                for (var u, c, d = ["transform", "perspective", "animationName"], f = ["", "webkit", "Moz", "ms", "O"], h = 0; 4 > h; h++) {
                    n = f[h];
                    for (var p = 0; 3 > p; p++)u = d[p], c = n + (n ? u.charAt(0).toUpperCase() + u.slice(1) : u), !i[u] && c in t && (i[u] = c);
        ...
        o.extend(a, i);
        var s, l, u, c, d, f, h, p, m, g, v, y, b, x, w, C, k, T, _, S, E, A, I, D, O, P, M, L, F, N, R, W, H, V, j, B, z, q, $, Y, X, U, Q, G, K, Z, J, ee, te, ne, ie, oe, re, ae, se, le, ue = function () {
            return {x: 0, y: 0}
        }, ce = ue(), de = ue(), fe = ue(), he = {}, pe = 0, me = {}, ge = ue(), ve = 0, ye = !0, be = [], xe = {}, we = !1, Ce = function (e, t) {
            ...
            (!we || o && o !== r.currItem) && (i /= o ? o.fitRatio : r.currItem.fitRatio), e[A] = y + t + "px, " + n + "px" + b + " scale(" + i + ")"
        }, De = function (e) {
            te && (e && (g > r.currItem.fitRatio ? we || (ln(r.currItem, !1, !0), we = !0) : we && (ln(r.currItem), we = !1)), Ie(te, fe.x, fe.y, g))
        }, Oe = function (e) {
            ...
            if (!a.loop && t) {
                var n = c + (ge.x * pe - e) / ge.x, i = Math.round(e - pt.x);
                (0 > n && i > 0 || n >= Qt() - 1 && 0 > i) && (e = pt.x + i * a.mainScrollEndFriction)
            }
            pt.x = e, Pe(e, d)
        }, Le = function (e, t) {
            var n = mt[e] - me[e];
            ...
            Re && (o.unbind(document, "mousemove", We), o.addClass(e, "pswp--has_mouse"), a.mouseUsed = !0, Se("mouseUsed")), Re = setTimeout(function () {
                Re = null
            }, 100)
        }, He = function () {
            o.bind(document, "keydown", r), R.transform && o.bind(r.scrollWrap, "click", r), a.mouseUsed || o.bind(document, "mousemove", We), o.bind(window, "resize scroll", r), Se("bindEvents")
        }, Ve = function () {
            o.unbind(window, "resize", r), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", r), o.unbind(document, "mousemove", We), R.transform && o.unbind(r.scrollWrap, "click", r), q && o.unbind(window, h, r), Se("unbindEvents")
        }, je = function (e, t) {
            var n = on(r.currItem, he, e);
            return t && (ee = n), n
        }, Be = function (e) {
        ...
        }, Qe = {}, Ge = 0, Ke = function (e) {
            Qe[e] && (Qe[e].raf && P(Qe[e].raf), Ge--, delete Qe[e])
        }, Ze = function (e) {
            Qe[e] && Ke(e), Qe[e] || (Ge++, Qe[e] = {})
        }, Je = function () {
            ...
            var u = function () {
                if (Qe[e]) {
                    if ((s = Ee() - l) >= i)return Ke(e), r(n), void(a && a());
                    r((n - t) * o(s / i) + t), Qe[e].raf = O(u)
                }
            };
            u()
        }, tt = {
            shout: Se, listen: _e, viewportSize: he, options: a, isMainScrollAnimating: function () {
                return ne
                ...
                if (!s && !l) {
                    ...
                    Se("firstUpdate"), c = c || a.index || 0, (isNaN(c) || 0 > c || c >= Qt()) && (c = 0), r.currItem = Ut(c), (R.isOldIOSPhone || R.isOldAndroid) && (ye = !1), e.setAttribute("aria-hidden", "false"), a.modal && (ye ? e.style.position = "fixed" : (e.style.position = "absolute", e.style.top = o.getScrollY() + "px")), void 0 === N && (Se("initialLayout"), N = L = o.getScrollY());
                    var u = "pswp--open ";
                    for (a.mainClass && (u += a.mainClass + " "), a.showHideOpacity && (u += "pswp--animate_opacity "), u += D ? "pswp--touch" : "pswp--notouch", u += R.animationName ? " pswp--css_animation" : "", u += R.svg ? " pswp--svg" : "", o.addClass(e, u), r.updateSize(), f = -1, ve = null, n = 0; 3 > n; n++)Pe((n + f) * ge.x, C[n].el.style);
                    F || o.bind(r.scrollWrap, p, r), _e("initialZoomInEnd", function () {
                        r.setContent(C[0], c - 1), r.setContent(C[2], c + 1), C[0].el.style.display = C[2].el.style.display = "block", a.focus && e.focus(), He()
                    }), r.setContent(C[1], c), r.updateCurrItem(), Se("afterInit"), ye || (x = setInterval(function () {
                        Ge || q || K || g !== r.currItem.initialZoomLevel || r.updateSize()
                    }, 1e3)), o.addClass(e, "pswp--visible")
                }
            }, close: function () {
                s && (s = !1, l = !0, Se("close"), Ve(), Kt(r.currItem, null, !0, r.destroy))
            }, destroy: function () {
                Se("destroy"), qt && clearTimeout(qt), e.setAttribute("aria-hidden", "true"), e.className = M, x && clearInterval(x), o.unbind(r.scrollWrap, p, r), o.unbind(window, "scroll", r), xt(), Je(), Te = null
                ...
                e = ke(e);
                var t = e - c;
                ve = t, c = e, r.currItem = Ut(c), pe -= t, Me(ge.x * pe), Je(), ne = !1, r.updateCurrItem()
            }, next: function () {
                r.goTo(c + 1)
            }, prev: function () {
                r.goTo(c - 1)
                ...
                ee = r.currItem.bounds, v = g = r.currItem.initialZoomLevel, fe.x = ee.center.x, fe.y = ee.center.y, e && Se("afterChange")
                ...
                if (0 !== ve) {
                    var t, n = Math.abs(ve);
                    if (!(e && 2 > n)) {
                        r.currItem = Ut(c), we = !1, Se("beforeChange", ve), n >= 3 && (f += ve + (ve > 0 ? -3 : 3), n = 3);
                        for (var i = 0; n > i; i++)ve > 0 ? (t = C.shift(), C[2] = t, f++, Pe((f + 2) * ge.x, t.el.style), r.setContent(t, c - n + i + 1 + 1)) : (t = C.pop(), C.unshift(t), f--, Pe(f * ge.x, t.el.style), r.setContent(t, c + n - i - 1 - 1));
                        if (te && 1 === Math.abs(ve)) {
                            var o = Ut(k);
                            o.initialZoomLevel !== g && (on(o, he), ln(o), Oe(o))
                        }
                        ve = 0, r.updateCurrZoomItem(), k = c, Se("afterChange")
                    }
                }
                ...
                if (he.x = r.scrollWrap.clientWidth, he.y = r.scrollWrap.clientHeight, Ue(), ge.x = he.x + Math.round(he.x * a.spacing), ge.y = he.y, Me(ge.x * pe), Se("beforeResize"), void 0 !== f) {
                    for (var i, s, l, u = 0; 3 > u; u++)i = C[u], Pe((u + f) * ge.x, i.el.style), l = c + u - 1, a.loop && Qt() > 2 && (l = ke(l)), s = Ut(l), s && (w || s.needsUpdate || !s.bounds) ? (r.cleanSlide(s), r.setContent(i, l), 1 === u && (r.currItem = s, r.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === i.index && l >= 0 && r.setContent(i, l), s && s.container && (on(s, he), ln(s), Oe(s));
                    w = !1
                }
                v = g = r.currItem.initialZoomLevel, ee = r.currItem.bounds, ee && (fe.x = ee.center.x, fe.y = ee.center.y, De(!0)), Se("resize")
            }, zoomTo: function (e, t, n, i, r) {
                t && (v = g, mt.x = Math.abs(t.x) - fe.x, mt.y = Math.abs(t.y) - fe.y, Fe(de, fe));
                var a = je(e, !1), s = {};
                qe("x", a, s, e), qe("y", a, s, e);
                var l = g, u = {x: fe.x, y: fe.y};
                Ne(s);
                var c = function (t) {
                    1 === t ? (g = e, fe.x = s.x, fe.y = s.y) : (g = (e - l) * t + l, fe.x = (s.x - u.x) * t + u.x, fe.y = (s.y - u.y) * t + u.y), r && r(t), De(1 === t)
                };
                n ? et("customZoomTo", 0, 1, n, i || o.easing.sine.inOut, c) : c(1)
            }
        }, nt = {}, it = {}, ot = {}, rt = {}, at = {}, st = [], lt = {}, ut = [], ct = {}, dt = 0, ft = ue(), ht = 0, pt = ue(), mt = ue(), gt = ue(), vt = function (e, t) {
            ...
            return Tt.prevent = !kt(e.target, a.isClickableElement), Se("preventDragEvent", e, t, Tt), Tt.prevent
        }, St = function (e, t) {
            ...
            var n, i, o, s, l = fe[e] + t[e], u = t[e] > 0, c = pt.x + t.x, d = pt.x - lt.x;
            return n = l > ee.min[e] || l < ee.max[e] ? a.panEndFriction : 1, l = fe[e] + t[e] * n, !a.allowPanToNext && g !== r.currItem.initialZoomLevel || (te ? "h" !== ie || "x" !== e || Y || (u ? (l > ee.min[e] && (n = a.panEndFriction, ee.min[e] - l, i = ee.min[e] - de[e]), (0 >= i || 0 > d) && Qt() > 1 ? (s = c, 0 > d && c > lt.x && (s = lt.x)) : ee.min.x !== ee.max.x && (o = l)) : (l < ee.max[e] && (n = a.panEndFriction, l - ee.max[e], i = de[e] - ee.max[e]), (0 >= i || d > 0) && Qt() > 1 ? (s = c, d > 0 && c < lt.x && (s = lt.x)) : ee.min.x !== ee.max.x && (o = l))) : s = c, "x" !== e) ? void(ne || Q || g > r.currItem.fitRatio && (fe[e] += t[e] * n)) : (void 0 !== s && (Me(s, !0), Q = s !== lt.x), ee.min.x !== ee.max.x && (void 0 !== o ? fe.x = o : Q || (fe.x += t.x * n)), void 0 !== s)
        }, Ft = function (e) {
            if (!("mousedown" === e.type && e.button > 0)) {
                ...
                if (!z || "mousedown" !== e.type) {
                    ...
                    G = null, Je(), q && 1 !== i || (q = oe = !0, o.bind(window, h, r), j = se = re = B = Q = X = $ = Y = !1, ie = null, Se("firstTouchStart", n), Fe(de, fe), ce.x = ce.y = 0, Fe(rt, n[0]), Fe(at, rt), lt.x = ge.x * pe, ut = [{
                        x: rt.x,
                        y: rt.y
                    }], H = W = Ee(), je(g, !0), xt(), wt()), !K && i > 1 && !ne && !Q && (v = g, Y = !1, K = $ = !0, ce.y = ce.x = 0, Fe(de, fe), Fe(nt, n[0]), Fe(it, n[1]), Et(nt, it, gt), mt.x = Math.abs(gt.x) - fe.x, mt.y = Math.abs(gt.y) - fe.y, Z = J = bt(nt, it))
                }
            }
        }, Nt = function (e) {
            ...
            if (q) {
                var i = Mt(e);
                if (ie || X || K)G = i; else if (pt.x !== ge.x * pe)ie = "h"; else {
            ...
            if (G) {
                var e = G.length;
                if (0 !== e)if (Fe(nt, G[0]), ot.x = nt.x - rt.x, ot.y = nt.y - rt.y, K && e > 1) {
                    if (rt.x = nt.x, rt.y = nt.y, !ot.x && !ot.y && vt(G[1], it))return;
                    Fe(it, G[1]), Y || (Y = !0, Se("zoomGestureStarted"));
                    var t = bt(nt, it), n = Bt(t);
                    n > r.currItem.initialZoomLevel + r.currItem.initialZoomLevel / 15 && (se = !0);
                    var i = 1, o = Be(), s = ze();
                    if (o > n)if (a.pinchToClose && !se && v <= r.currItem.initialZoomLevel) {
                        var l = o - n, u = 1 - l / (o / 1.2);
                        Ae(u), Se("onPinchClose", u), re = !0
                    } else i = (o - n) / o, i > 1 && (i = 1), n = o - i * (o / 3); else n > s && (i = (n - s) / (6 * o), i > 1 && (i = 1), n = s + i * o);
                    0 > i && (i = 0), Z = t, Et(nt, it, ft), ce.x += ft.x - gt.x, ce.y += ft.y - gt.y, Fe(gt, ft), fe.x = Le("x", n), fe.y = Le("y", n), j = n > g, g = n, De()
                } else {
                    if (!ie)return;
                    ...
                    if ("v" === ie && a.closeOnVerticalDrag && !Ct()) {
                        ce.y += ot.y, fe.y += ot.y;
                        var c = It();
                        return B = !0, Se("onVerticalDrag", c), Ae(c), void De()
                    }
                    At(Ee(), nt.x, nt.y), X = !0, ee = r.currItem.bounds;
                    var d = Lt("x", ot);
                    d || (Lt("y", ot), Ne(fe), De())
                }
            }
            ...
            var s, l = Mt(e), u = l.length;
            if ("mouseup" === e.type && (u = 0), 2 === u)return G = null, !0;
            1 === u && Fe(at, l[0]), 0 !== u || ie || ne || (t || ("mouseup" === e.type ? t = {
                x: e.pageX,
                y: e.pageY,
                type: "mouse"
            ...
            var c = -1;
            if (0 === u && (q = !1, o.unbind(window, h, r), xt(), K ? c = 0 : -1 !== ht && (c = Ee() - ht)), ht = 1 === u ? Ee() : -1, s = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > u && (K = !1, 1 === u && (s = "zoomPointerUp"), Se("zoomGestureEnded")), G = null, X || Y || ne || B)if (Je(), V || (V = Ht()), V.calculateSwipeSpeed("x"), B) {
                var d = It();
                if (d < a.verticalDragRange)r.close(); else {
                    var f = fe.y, p = ae;
                    et("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (e) {
                        fe.y = (r.currItem.initialPosition.y - f) * e + f, Ae((1 - p) * e + p), De()
                    }), Se("onVerticalDrag", 1)
                }
            } else {
                if ((Q || ne) && 0 === u) {
                ...
                if (!ne)return "swipe" !== s ? void zt() : void(!Q && g > r.currItem.fitRatio && Vt(V))
            }
        }, Ht = function () {
            var e, t, n = {
                lastFlickOffset: {},
            ...
            var u;
            i && (c += i, 0 > c ? (c = a.loop ? Qt() - 1 : 0, u = !0) : c >= Qt() && (c = a.loop ? 0 : Qt() - 1, u = !0), (!u || a.loop) && (ve += i, pe -= i, n = !0));
            var d, f = ge.x * pe, h = Math.abs(f - pt.x);
            return n || f > pt.x == t.lastFlickSpeed.x > 0 ? (d = Math.abs(t.lastFlickSpeed.x) > 0 ? h / Math.abs(t.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, dt === c && (n = !1), ne = !0, Se("mainScrollAnimStart"), et("mainScroll", pt.x, f, d, o.easing.cubic.out, Me, function () {
                Je(), ne = !1, dt = -1, (n || dt !== c) && r.updateCurrItem(), Se("mainScrollAnimComplete")
        ...
        var qt, $t, Yt, Xt, Ut, Qt, Gt, Kt = function (t, n, i, s) {
            ...
            var d = i ? a.hideAnimationDuration : a.showAnimationDuration, f = function () {
                Ke("initialZoom"), i ? (r.template.removeAttribute("style"), r.bg.removeAttribute("style")) : (Ae(1), n && (n.style.display = "block"), o.addClass(e, "pswp--animated-in"), Se("initialZoom" + (i ? "OutEnd" : "InEnd"))), s && s(), Xt = !1
            };
            if (!d || !l || void 0 === l.x)return Se("initialZoom" + (i ? "Out" : "In")), g = t.initialZoomLevel, Fe(fe, t.initialPosition), De(), e.style.opacity = i ? 0 : 1, Ae(1), void(d ? setTimeout(function () {
                f()
            }, d) : f());
            !function () {
                var n = u, s = !r.currItem.src || r.currItem.loadError || a.showHideOpacity;
                t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), i || (g = l.w / t.w, fe.x = l.x, fe.y = l.y - L, r[s ? "template" : "bg"].style.opacity = .001, De()), Ze("initialZoom"), i && !n && o.removeClass(e, "pswp--animated-in"), s && (i ? o[(n ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function () {
                    o.addClass(e, "pswp--animate_opacity")
                }, 30)), qt = setTimeout(function () {
                    if (Se("initialZoom" + (i ? "Out" : "In")), i) {
                        var r = l.w / t.w, a = {x: fe.x, y: fe.y}, u = g, c = ae, h = function (t) {
                            1 === t ? (g = r, fe.x = l.x, fe.y = l.y - N) : (g = (r - u) * t + u, fe.x = (l.x - a.x) * t + a.x, fe.y = (l.y - N - a.y) * t + a.y), De(), s ? e.style.opacity = 1 - t : Ae(c - t * c)
                        };
                        n ? et("initialZoom", 0, 1, d, o.easing.cubic.out, h, f) : (h(1), qt = setTimeout(f, d + 20))
                    } else g = t.initialZoomLevel, Fe(fe, t.initialPosition), De(), Ae(1), s ? e.style.opacity = 1 : Ae(1), qt = setTimeout(f, d + 20)
                }, i ? 25 : 90)
            }()
        }, Zt = {}, Jt = [], en = {
            index: 0,
            ...
            t.loadError || i && (t.imageAppended = !0, ln(t, i, t === r.currItem && we), n.appendChild(i), a && setTimeout(function () {
        ...
        Ce("Controller", {
            publicMethods: {
                lazyLoadItem: function (e) {
                    ...
                    o.extend(a, en, !0), r.items = $t = n, Ut = r.getItemAt, Qt = a.getNumItemsFn, Gt = a.loop, Qt() < 3 && (a.loop = !1), _e("beforeChange", function (e) {
                        var t, n = a.preload, i = null === e || e >= 0, o = Math.min(n[0], Qt()), s = Math.min(n[1], Qt());
                    ...
                    }), _e("mainScrollAnimComplete", un), _e("initialZoomInEnd", un), _e("destroy", function () {
                    ...
                    if (!l.src && l.html && (l.html.tagName ? u.appendChild(l.html) : u.innerHTML = l.html), sn(l), on(l, he), !l.src || l.loadError || l.loaded)l.src && !l.loadError && (i = o.createEl("pswp__img", "img"), i.style.opacity = 1, i.src = l.src, ln(l, i), rn(0, l, u, i)); else {
                        if (l.loadComplete = function (n) {
                                if (s) {
                                    if (e && e.index === t) {
                                        if (sn(n, !0))return n.loadComplete = n.img = null, on(n, he), Oe(n), void(e.index === c && r.updateCurrZoomItem());
                            ...
                            l.msrc && (f.src = l.msrc), ln(l, f), u.appendChild(f), l.placeholder = f
                        }
                        l.loading || an(l), r.allowProgressiveImg() && (!Yt && R.transform ? Jt.push({
                            item: l,
                            baseDiv: u,
                            img: l.img,
                            index: t,
                    ...
                    Yt || t !== c ? Oe(l) : (te = u.style, Kt(l, i || l.img)), e.el.innerHTML = "", e.el.appendChild(u)
                }, cleanSlide: function (e) {
                    e.img && (e.img.onload = e.img.onerror = null), e.loaded = e.loading = e.img = e.imageAppended = !1
                }
            }
        });
        var cn, dn = {}, fn = function (e, t, n) {
        ...
        Ce("Tap", {
            publicMethods: {
                initTap: function () {
                    ...
                    if (t && !X && !$ && !Ge) {
                        var n = t;
                        if (cn && (clearTimeout(cn), cn = null, yt(n, dn)))return void Se("doubleTap", n);
                        if ("mouse" === t.type)return void fn(e, t, "mouse");
                        if ("BUTTON" === e.target.tagName.toUpperCase() || o.hasClass(e.target, "pswp__single-tap"))return void fn(e, t);
            ...
            publicMethods: {
                initDesktopZoom: function () {
                    ...
                    _e("bindEvents", function () {
                        ...
                        hn && o.unbind(e, n, r.handleMouseWheel)
                    }), r.mouseZoomedIn = !1;
                    var i, a = function () {
                    ...
                    if (g <= r.currItem.fitRatio)return a.modal && (!a.closeOnScroll || Ge || q ? e.preventDefault() : A && Math.abs(e.deltaY) > 2 && (u = !0, r.close())), !0;
                    ...
                    var n = a.getDoubleTapZoom(!0, r.currItem), i = g === n;
                    r.mouseZoomedIn = !i, r.zoomTo(i ? r.currItem.initialZoomLevel : n, t, 333), o[(i ? "remove" : "add") + "Class"](e, "pswp--zoomed-in")
                }
            }
        });
        var pn, mn, gn, vn, yn, bn, xn, wn, Cn, kn, Tn, _n, Sn = {history: !0, galleryUID: 1}, En = function () {
            ...
            if (a.galleryPIDs) {
                var r = t.pid;
                for (t.pid = 0, n = 0; n < $t.length; n++)if ($t[n].pid === r) {
                    t.pid = n;
                    break
                }
            ...
            if (gn && clearTimeout(gn), Ge || q)return void(gn = setTimeout(Dn, 500));
            vn ? clearTimeout(mn) : vn = !0;
            var e = c + 1, t = Ut(c);
            t.hasOwnProperty("pid") && (e = t.pid);
            var n = xn + "&gid=" + a.galleryUID + "&pid=" + e;
            wn || -1 === Tn.hash.indexOf(n) && (kn = !0);
            var i = Tn.href.split("#")[0] + "#" + n;
            _n ? "#" + n !== window.location.hash && history[wn ? "replaceState" : "pushState"]("", document.title, i) : wn ? Tn.replace(i) : Tn.hash = n, wn = !0, mn = setTimeout(function () {
                vn = !1
            }, 60)
        };
        Ce("History", {
            publicMethods: {
                initHistory: function () {
                    if (o.extend(a, Sn, !0), a.history) {
                        Tn = window.location, kn = !1, Cn = !1, wn = !1, xn = En(), _n = "pushState" in history, xn.indexOf("gid=") > -1 && (xn = xn.split("&gid=")[0], xn = xn.split("?gid=")[0]), _e("afterChange", r.updateURL), _e("unbindEvents", function () {
                            o.unbind(window, "hashchange", r.onHashChange)
                        });
                        var e = function () {
                            bn = !0, Cn || (kn ? history.back() : xn ? Tn.hash = xn : _n ? history.pushState("", document.title, Tn.pathname + Tn.search) : Tn.hash = ""), An()
                        };
                        _e("unbindEvents", function () {
                            u && e()
                        }), _e("destroy", function () {
                    ...
                    return En() === xn ? (Cn = !0, void r.close()) : void(vn || (yn = !0, r.goTo(In().pid), yn = !1))
                }, updateURL: function () {
    ...
    "use strict";
    return function (e, t) {
        var n, i, o, r, a, s, l, u, c, d, f, h, p, m, g, v, y, b, x, w = this, C = !1, k = !0, T = !0, _ = {
            barsSize: {
                top: 44,
                bottom: "auto"
            },
            ...
            if (E()) {
                var a = g.barsSize;
                if (g.captionEl && "auto" === a.bottom)if (r || (r = t.createEl("pswp__caption pswp__caption--fake"), r.appendChild(t.createEl("pswp__caption__center")), i.insertBefore(r, o), t.addClass(i, "pswp__ui--fit")), g.addCaptionHTMLFn(e, r, !0)) {
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (e) {
    e.fn.sticky = function (t) {
        ...
        return this.each(function () {
            function t() {
                var t = h.scrollTop(), s = f, p = n.parent().width();
                if (d.width(p), r && "string" == typeof f) {
            ...
            var n = e(this), a = n.outerHeight(), s = n.outerWidth(), l = i.topSpacing, u = i.zIndex, c = n.offset().top - l, d = e("<div></div>").width(s).height(a).addClass("sticky-placeholder"), f = i.stopper, h = e(window);
    ...
    10: [function (e, t, n) {
        ...
        function i(e, t) {
            ...
            t.event.bind(t.scrollbarY, "click", i), t.event.bind(t.scrollbarYRail, "click", function (i) {
                var o = i.pageY - window.pageYOffset - n(t.scrollbarYRail).top, s = o > t.scrollbarYTop ? 1 : -1;
                a(e, "top", e.scrollTop + s * t.containerHeight), r(e), i.stopPropagation()
            }), t.event.bind(t.scrollbarX, "click", i), t.event.bind(t.scrollbarXRail, "click", function (i) {
                var o = i.pageX - window.pageXOffset - n(t.scrollbarXRail).left, s = o > t.scrollbarXLeft ? 1 : -1;
                a(e, "left", e.scrollLeft + s * t.containerWidth), r(e), i.stopPropagation()
            })
        }
    ...
    11: [function (e, t, n) {
        ...
        function i(e, t) {
            function n(n) {
                var o = i + n * t.railXRatio, a = Math.max(0, t.scrollbarXRail.getBoundingClientRect().left) + t.railXRatio * (t.railXWidth - t.scrollbarXWidth);
                t.scrollbarXLeft = o < 0 ? 0 : o > a ? a : o, u(e, "left", r.toInt(t.scrollbarXLeft * (t.contentWidth - t.containerWidth) / (t.containerWidth - t.railXRatio * t.scrollbarXWidth)) - t.negativeScrollAdjustment)
            }

            var i = null, o = null, s = function (t) {
            ...
            t.event.bind(t.scrollbarX, "mousedown", function (n) {
                o = n.pageX, i = r.toInt(a.css(t.scrollbarX, "left")) * t.railXRatio, r.startScrolling(e, "x"), t.event.bind(t.ownerDocument, "mousemove", s), t.event.once(t.ownerDocument, "mouseup", c), n.stopPropagation(), n.preventDefault()
            })
        }

        function o(e, t) {
            function n(n) {
                var o = i + n * t.railYRatio, a = Math.max(0, t.scrollbarYRail.getBoundingClientRect().top) + t.railYRatio * (t.railYHeight - t.scrollbarYHeight);
                t.scrollbarYTop = o < 0 ? 0 : o > a ? a : o, u(e, "top", r.toInt(t.scrollbarYTop * (t.contentHeight - t.containerHeight) / (t.containerHeight - t.railYRatio * t.scrollbarYHeight)))
            }
            ...
            t.event.bind(t.scrollbarY, "mousedown", function (n) {
                o = n.pageY, i = r.toInt(a.css(t.scrollbarY, "top")) * t.railYRatio, r.startScrolling(e, "y"), t.event.bind(t.ownerDocument, "mousemove", s), t.event.once(t.ownerDocument, "mouseup", c), n.stopPropagation(), n.preventDefault()
            })
        }

        var r = e("../../lib/helper"), a = e("../../lib/dom"), s = e("../instances"), l = e("../update-geometry"), u = e("../update-scroll");
        t.exports = function (e) {
            var t = s.get(e);
            i(e, t), o(e, t)
        }
            ...
            t.event.bind(t.ownerDocument, "keydown", function (u) {
                if (!(u.isDefaultPrevented && u.isDefaultPrevented() || u.defaultPrevented)) {
                    ...
                    if (i || c) {
                        ...
                        switch (u.which) {
                            case 37:
                                f = u.metaKey ? -t.contentWidth : u.altKey ? -t.containerWidth : -30;
                                break;
                            case 38:
                                h = u.metaKey ? t.contentHeight : u.altKey ? t.containerHeight : 30;
                                break;
                            case 39:
                                f = u.metaKey ? t.contentWidth : u.altKey ? t.containerWidth : 30;
                                break;
                            ...
                            case 34:
                                ...
                                break;
                            case 35:
                                h = u.ctrlKey ? -t.contentHeight : -t.containerHeight;
                                break;
                            case 36:
                                h = u.ctrlKey ? e.scrollTop : t.containerHeight;
                                break;
                            default:
                                return
                        }
                        l(e, "top", e.scrollTop - h), l(e, "left", e.scrollLeft + f), s(e), (a = n(f, h)) && u.preventDefault()
                    }
                }
            })
        }

        var o = e("../../lib/helper"), r = e("../../lib/dom"), a = e("../instances"), s = e("../update-geometry"), l = e("../update-scroll");
        t.exports = function (e) {
            i(e, a.get(e))
        }
    }, {
        ...
        function i(e, t) {
            ...
            function i() {
                u || (u = setInterval(function () {
                    return r.get(e) ? (s(e, "top", e.scrollTop + c.top), s(e, "left", e.scrollLeft + c.left), void a(e)) : void clearInterval(u)
                }, 50))
            }

            function l() {
                u && (clearInterval(u), u = null), o.stopScrolling(e)
            }
            ...
            t.event.bind(t.ownerDocument, "selectionchange", function () {
                ...
                if (d) {
                    ...
                    n.x < r.left + 3 ? (c.left = -5, o.startScrolling(e, "x")) : n.x > r.right - 3 ? (c.left = 5, o.startScrolling(e, "x")) : c.left = 0, n.y < r.top + 3 ? (r.top + 3 - n.y < 5 ? c.top = -5 : c.top = -20, o.startScrolling(e, "y")) : n.y > r.bottom - 3 ? (n.y - r.bottom + 3 < 5 ? c.top = 5 : c.top = 20, o.startScrolling(e, "y")) : c.top = 0, 0 === c.top && 0 === c.left ? l() : i()
                }
            })
        }
        ...
        function i(e, t, n, i) {
            ...
            function p(e) {
                if (!w && t.settings.swipePropagation && h(e), !x && w && f(e)) {
                    var n = d(e), i = {pageX: n.pageX, pageY: n.pageY}, r = i.pageX - g.pageX, a = i.pageY - g.pageY;
                    l(r, a), g = i;
                    var s = (new Date).getTime(), u = s - v;
                    u > 0 && (y.x = r / u, y.y = a / u, v = s), o(r, a) && (e.stopPropagation(), e.preventDefault())
                }
            }
            ...
            n ? (t.event.bind(window, "touchstart", u), t.event.bind(window, "touchend", c), t.event.bind(e, "touchstart", h), t.event.bind(e, "touchmove", p), t.event.bind(e, "touchend", m)) : i && (window.PointerEvent ? (t.event.bind(window, "pointerdown", u), t.event.bind(window, "pointerup", c), t.event.bind(e, "pointerdown", h), t.event.bind(e, "pointermove", p), t.event.bind(e, "pointerup", m)) : window.MSPointerEvent && (t.event.bind(window, "MSPointerDown", u), t.event.bind(window, "MSPointerUp", c), t.event.bind(e, "MSPointerDown", h), t.event.bind(e, "MSPointerMove", p), t.event.bind(e, "MSPointerUp", m)))
        }
    ...
    18: [function (e, t, n) {
        ...
        function i(e) {
            ...
            var i = this;
            i.settings = s.clone(u), i.containerWidth = null, i.containerHeight = null, i.contentWidth = null, i.contentHeight = null, i.isRtl = "rtl" === c.css(e, "direction"), i.isNegativeScroll = function () {
        ...
        var s = e("../lib/helper"), l = e("../lib/class"), u = e("./default-setting"), c = e("../lib/dom"), d = e("../lib/event-manager"), f = e("../lib/guid"), h = {};
        n.add = function (e) {
            var t = f();
            return r(e, t), h[t] = new i(e), h[t]
        }, n.remove = function (e) {
            delete h[o(e)], a(e)
        }, n.get = function (e) {
            return h[o(e)]
    ...
    19: [function (e, t, n) {
        ...
        var r = e("../lib/helper"), a = e("../lib/class"), s = e("../lib/dom"), l = e("./instances"), u = e("./update-scroll");
        t.exports = function (e) {
            var t = l.get(e);
            ...
            e.contains(t.scrollbarXRail) || (n = s.queryChildren(e, ".ps__scrollbar-x-rail"), n.length > 0 && n.forEach(function (e) {
                ...
                s.remove(e)
            }), s.appendTo(t.scrollbarYRail, e)), !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? (t.scrollbarXActive = !0, t.railXWidth = t.containerWidth - t.railXMarginWidth, t.railXRatio = t.containerWidth / t.railXWidth, t.scrollbarXWidth = i(t, r.toInt(t.railXWidth * t.containerWidth / t.contentWidth)), t.scrollbarXLeft = r.toInt((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1,
    ...
    21: [function (e, t, n) {
        "use strict";
        var i = e("../lib/helper"), o = e("../lib/dom"), r = e("./instances"), a = e("./update-geometry"), s = e("./update-scroll");
        t.exports = function (e) {
            var t = r.get(e);
        ...
        return this.$el = e(this), this.$document = e(document), this.SELS = {
            ...
            o.$document.on("click", t.CHIPS, function (n) {
                ...
                if (!e(n.target).is("input, textarea")) {
                    var i, r = o.$document.find(t.CHIP + t.SELECTED_CHIP), a = r.closest(t.CHIPS), s = r.siblings(t.CHIP).length;
                    if (r.length) {
                        var l = 8 === n.which || 46 === n.which, u = 37 === n.which, c = 39 === n.which;
                        if (l) {
                            n.preventDefault();
                            var d = a.data("index");
                            i = r.index(), o.deleteChip(d, i, a);
                            var f = null;
                            i + 1 < s ? f = i : i !== s && i + 1 !== s || (f = s - 1), f < 0 && (f = null), null !== f && o.selectChip(d, f, a), s || a.find("input").focus()
                        } else if (u) {
                ...
                var i = e(n.target), r = i.closest(t.CHIPS), a = r.data("index"), s = r.children(t.CHIP).length;
                if (13 === n.which)return n.preventDefault(), o.addChip(a, {tag: i.val()}, r), void i.val("");
                var l = 8 === n.keyCode || 37 === n.keyCode, u = "" === i.val();
                return l && u && s ? (o.selectChip(a, s - 1, r), void i.blur()) : void 0
            }), o.$document.on("click", t.CHIPS + " " + t.DELETE, function (n) {
                var i = e(n.target), r = i.closest(t.CHIPS), a = i.closest(t.CHIP);
            ...
            for (var n = e.data("chips"), i = !1, o = 0; o < n.length; o++)if (n[o].tag === t.tag)return void(i = !0);
            return "" !== t.tag && !i
    ...
    var r, a, s = document.createElement("div"), l = t("transform"), u = t("perspective"), c = navigator.userAgent, d = c.toLowerCase().indexOf("android") > -1, f = /iPad|iPhone|iPod/.test(c) && !e.MSStream, h = c.toLowerCase().indexOf("firefox") > -1, p = c.indexOf("MSIE ") > -1 || c.indexOf("Trident/") > -1 || c.indexOf("Edge/") > -1, m = document.all && !e.atob;
    n();
    var g = [], v = function () {
        function e(e, n) {
            var i, o = this;
            if (o.$item = e, o.defaults = {
                    ...
                    onDestroy: null,
                    onCoverImage: null
                }, i = JSON.parse(o.$item.getAttribute("data-jarallax") || "{}"), o.options = o.extend({}, o.defaults, i, n), !(!l || d && o.options.noAndroid || f && o.options.noIos)) {
                o.options.speed = Math.min(2, Math.max(-1, parseFloat(o.options.speed)));
                var r = o.options.elementInViewport;
                r && "object" == typeof r && void 0 !== r.length && (r = r[0]), !r instanceof Element && (r = null), o.options.elementInViewport = r, o.instanceID = t++, o.image = {
    ...
    v.prototype.css = function (t, n) {
        ...
        n.transform && (u && (n.transform += " translateZ(0)"), n.WebkitTransform = n.MozTransform = n.msTransform = n.OTransform = n.transform);
        ...
        for (var o = 0, r = t.$item; null !== r && r !== document && 0 === o;) {
            ...
            a && "none" !== a && (o = 1, t.css(t.image.$container, {transform: "translateX(0) translateY(0)"})), r = r.parentNode
        }
        ...
        if (e.image.width && e.image.height) {
            var t = e.image.$container.getBoundingClientRect(), n = t.width, i = t.height, o = t.left, r = e.image.width, s = e.image.height, l = e.options.speed, u = "scroll" === e.options.type || "scroll-opacity" === e.options.type, c = 0, d = 0, f = i, h = 0, p = 0;
            u && (c = l < 0 ? l * Math.max(i, a) : l * (i + a), l > 1 ? f = Math.abs(c - a) : l < 0 ? f = c / l + Math.abs(c) : f += Math.abs(a - i) * (1 - l), c /= 2), d = f * r / s, d < n && (d = n, f = d * s / r), u ? (h = o + (n - d) / 2, p = (a - f) / 2) : (h = (n - d) / 2, p = (i - f) / 2), "absolute" === e.image.position && (h -= o), e.parallaxScrollDistance = c, e.css(e.image.$item, {
                width: d + "px",
                height: f + "px",
                marginLeft: h + "px",
                marginTop: p + "px"
        ...
        if (t.image.width && t.image.height) {
            var n = t.$item.getBoundingClientRect(), i = n.top, o = n.height, s = {
                visibility: "visible",
            ...
            if (t.options.elementInViewport && (l = t.options.elementInViewport.getBoundingClientRect()), t.isElementInViewport = l.bottom >= 0 && l.right >= 0 && l.top <= a && l.left <= r, e || t.isElementInViewport) {
                var u = Math.max(0, i), c = Math.max(0, o + i), d = Math.max(0, -i), f = Math.max(0, i + o - a), h = Math.max(0, o - (i + o - a)), p = Math.max(0, -i + a - o), m = 1 - 2 * (a - i) / (a + o), g = 1;
                if (o < a ? g = 1 - (d || f) / o : c <= a ? g = c / a : h <= a && (g = h / a), "opacity" !== t.options.type && "scale-opacity" !== t.options.type && "scroll-opacity" !== t.options.type || (s.transform = "", s.opacity = g), "scale" === t.options.type || "scale-opacity" === t.options.type) {
                    var v = 1;
    ...
    var y = function (e) {
        ...
        var t, n = arguments[1], i = Array.prototype.slice.call(arguments, 2), o = e.length, r = 0;
        for (r; r < o; r++)if ("object" == typeof n || void 0 === n ? e[r].jarallax || (e[r].jarallax = new v(e[r], n)) : e[r].jarallax && (t = e[r].jarallax[n].apply(e[r].jarallax, i)), void 0 !== t)return t;
        return e
    };
    y.constructor = v;
    var b = e.jarallax;
    ...
    var o = function () {
        function e(e, i) {
            ...
            o.url = e, o.options_default = {
                ...
                startTime: 0,
                endTime: 0
            }, o.options = t({}, o.options_default, i), o.videoID = o.parseURL(e), o.videoID && (o.ID = n++, o.loadAPI(), o.init())
        }
    ...
    o.prototype.parseURL = function (e) {
        ...
        if (this.userEventsList && this.userEventsList[e])if (t)for (var n = 0; n < this.userEventsList[e].length; n++)this.userEventsList[e][n] === t && (this.userEventsList[e][n] = !1); else delete this.userEventsList[e]
    }, o.prototype.fire = function (e) {
        var t = [].slice.call(arguments, 1);
        if (this.userEventsList && void 0 !== this.userEventsList[e])for (var n in this.userEventsList[e])this.userEventsList[e][n] && this.userEventsList[e][n].apply(this, t)
        ...
        n.onAPIready(function () {
            var o;
            if (n.$iframe || (o = document.createElement("div"), o.style.display = "none"), "youtube" === n.type) {
            ...
            if ("vimeo" === n.type) {
                ...
                n.player.on("timeupdate", function (e) {
                    u || n.fire("started", e), u = 1, n.options.endTime && n.options.endTime && e.seconds >= n.options.endTime && (n.options.loop ? n.play(n.options.startTime) : n.pause())
            ...
            if ("local" === n.type) {
                if (!n.$iframe) {
                    ...
                    for (var c in n.videoID)!function (e, t, n) {
                        var i = document.createElement("source");
                        i.src = t, i.type = n, e.appendChild(i)
                    }(n.$iframe, n.videoID[c], "video/" + c)
                }
    ...
    var s = 0, l = 0, u = new n, c = new n;
    o.prototype.onAPIready = function (t) {
        var n = this;
        if ("youtube" === n.type && ("undefined" != typeof YT && 0 !== YT.loaded || s ? "object" == typeof YT && 1 === YT.loaded ? t() : u.done(function () {
                t()
            }) : (s = 1, e.onYouTubeIframeAPIReady = function () {
                e.onYouTubeIframeAPIReady = null, u.resolve("done"), t()
            })), "vimeo" === n.type)if ("undefined" != typeof Vimeo || l)"undefined" != typeof Vimeo ? t() : c.done(function () {
            t()
        }); else {
            l = 1;
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}, Prism = function () {
    var e = /\blang(?:uage)?-(\w+)\b/i, t = 0, n = _self.Prism = {
        util: {
            ...
            for (var o, r = i.elements || document.querySelectorAll(i.selector), a = 0; o = r[a++];)n.highlightElement(o, e === !0, i.callback)
            ...
            var l = t.textContent, u = {element: t, language: r, grammar: a, code: l};
            ...
            } else u.highlightedCode = n.highlight(u.code, u.grammar, u.language), n.hooks.run("before-insert", u), u.element.innerHTML = u.highlightedCode, o && o.call(t), n.hooks.run("after-highlight", u), n.hooks.run("complete", u)
        }, highlight: function (e, t, o) {
            var r = n.tokenize(e, t);
            return i.stringify(n.util.encode(r), o)
        }, tokenize: function (e, t) {
            var i = n.Token, o = [e], r = t.rest;
            if (r) {
            ...
            e:for (var a in t)if (t.hasOwnProperty(a) && t[a]) {
                ...
                for (var l = 0; l < s.length; ++l) {
                    var u = s[l], c = u.inside, d = !!u.lookbehind, f = !!u.greedy, h = 0, p = u.alias;
                    u = u.pattern || u;
                    for (var m = 0; m < o.length; m++) {
                        ...
                        if (!(g instanceof i)) {
                            ...
                            var v = u.exec(g), y = 1;
                            if (!v && f && m != o.length - 1) {
                                var b = o[m + 1].matchedStr || o[m + 1], x = g + b;
                                if (m < o.length - 2 && (x += o[m + 2].matchedStr || o[m + 2]), u.lastIndex = 0, !(v = u.exec(x)))continue;
                                var w = v.index + (d ? v[1].length : 0);
                                if (w >= g.length)continue;
                                var C = v.index + v[0].length, k = g.length + b.length;
                                if (y = 3, k >= C) {
                            ...
                            if (v) {
                                d && (h = v[1].length);
                                var w = v.index + h, v = v[0].slice(h), C = w + v.length, T = g.slice(0, w), _ = g.slice(C), S = [m, y];
                                T && S.push(T);
                                var E = new i(a, c ? n.tokenize(v, c) : v, p, v, f);
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
    ...
    "use strict";
    var n, i, o, r = e, a = r.document, s = r.navigator, l = r.setTimeout, u = r.clearTimeout, c = r.setInterval, d = r.clearInterval, f = r.getComputedStyle, h = r.encodeURIComponent, p = r.ActiveXObject, m = r.Error, g = r.Number.parseInt || r.parseInt, v = r.Number.parseFloat || r.parseFloat, y = r.Number.isNaN || r.isNaN, b = r.Date.now, x = r.Object.keys, w = r.Object.defineProperty, C = r.Object.prototype.hasOwnProperty, k = r.Array.prototype.slice, T = function () {
        var e = function (e) {
            return e
        };
        if ("function" == typeof r.wrap && "function" == typeof r.unwrap)try {
            var t = a.createElement("div"), n = r.unwrap(t);
        ...
        var e, n, i, o, r, a = _(arguments), s = a[0] || {};
        for (e = 1, n = a.length; n > e; e++)if (null != (i = a[e]))for (o in i)C.call(i, o) && (s[o], r = i[o], s !== r && r !== t && (s[o] = r));
        return s
    }, E = function (e) {
        var t, n, i, o;
        if ("object" != typeof e || null == e || "number" == typeof e.nodeType)t = e; else if ("number" == typeof e.length)for (t = [], n = 0, i = e.length; i > n; n++)C.call(e, n) && (t[n] = E(e[n])); else {
            t = {};
        ...
        for (e = o.length; e--;) {
            ...
            if (i = P(i), null == n)n = i; else if (n !== i) {
                n = null;
                break
            }
        }
    ...
    }, X = ["flash-unavailable", "flash-degraded", "flash-overdue", "version-mismatch", "config-mismatch", "clipboard-error"], U = ["flash-disabled", "flash-outdated", "flash-sandboxed", "flash-unavailable", "flash-degraded", "flash-deactivated", "flash-overdue"], Q = new RegExp("^flash-(" + U.map(function (e) {
            return e.replace(/^flash-/, "")
        }).join("|") + ")$"), G = new RegExp("^flash-(" + U.slice(1).map(function (e) {
            return e.replace(/^flash-/, "")
        }).join("|") + ")$"), K = {
        swfPath: function () {
            return (P(F()) || N() || "") + "ZeroClipboard.swf"
        }(),
        ...
        if ("object" == typeof e && null !== e)for (var t in e)if (C.call(e, t))if (/^(?:forceHandCursor|title|zIndex|bubbleEvents|fixLineEndings)$/.test(t))K[t] = e[t]; else if (null == H.bridge)if ("containerId" === t || "swfObjectId" === t) {
        ...
        return Ye(), {
            ...
            flash: I(H, ["bridge"]),
            zeroclipboard: {version: Ue.version, config: Ue.config()}
        }
    }, ee = function () {
        return !!(H.disabled || H.outdated || H.sandboxed || H.unavailable || H.degraded || H.deactivated)
    }, te = function (e, i) {
        var o, r, a, s = {};
        if ("string" == typeof e && e)a = e.toLowerCase().split(/\s+/); else if ("object" == typeof e && e && void 0 === i)for (o in e)C.call(e, o) && "string" == typeof o && o && "function" == typeof e[o] && Ue.on(o, e[o]);
        if (a && a.length) {
            for (o = 0, r = a.length; r > o; o++)e = a[o].replace(/^on/, ""), s[e] = !0, j[e] || (j[e] = []), j[e].push(i);
            if (s.ready && H.ready && Ue.emit({type: "ready"}), s.error) {
                for (o = 0, r = U.length; r > o; o++)if (H[U[o].replace(/^flash-/, "")] === !0) {
                    Ue.emit({type: "error", name: U[o]});
                    break
                }
        ...
        var n, i, o, r, a;
        if (0 === arguments.length)r = x(j); else if ("string" == typeof e && e)r = e.split(/\s+/); else if ("object" == typeof e && e && void 0 === t)for (n in e)C.call(e, n) && "string" == typeof n && n && "function" == typeof e[n] && Ue.off(n, e[n]);
        if (r && r.length)for (n = 0, i = r.length; i > n; n++)if (e = r[n].toLowerCase().replace(/^on/, ""), (a = j[e]) && a.length)if (t)for (o = a.indexOf(t); -1 !== o;)a.splice(o, 1), o = a.indexOf(t, o); else a.length = 0;
        return Ue
    }, ie = function (e) {
        return "string" == typeof e && e ? E(j[e]) || null : E(j)
    }, oe = function (e) {
        var t, n, i;
        return e = pe(e), e && !we(e) ? "ready" === e.type && H.overdue === !0 ? Ue.emit({
            type: "error",
            name: "flash-overdue"
        }) : (t = S({}, e), be.call(this, t), "copy" === e.type && (i = Ie(B), n = i.data, z = i.formatMap), n) : void 0
    }, re = function () {
        var e = H.sandboxed;
        if (Ye(), "boolean" != typeof H.ready && (H.ready = !1), H.sandboxed !== e && H.sandboxed === !0)H.ready = !1, Ue.emit({
            type: "error",
            name: "flash-sandboxed"
        }); else if (!Ue.isFlashUnusable() && null === H.bridge) {
            var t = K.flashLoadTimeout;
            "number" == typeof t && t >= 0 && (q = l(function () {
                "boolean" != typeof H.deactivated && (H.deactivated = !0), H.deactivated === !0 && Ue.emit({
                    type: "error",
        ...
        var n;
        if ("object" == typeof e && e && void 0 === t)n = e, Ue.clearData(); else {
        ...
        if ("string" == typeof e && e ? (t = e, e = {}) : "object" == typeof e && e && "string" == typeof e.type && e.type && (t = e.type), t) {
            ...
            return "error" === e.type && e.name && n && (n = n[e.name]), n && (e.message = n), "ready" === e.type && S(e, {
                ...
                target: null,
                minimumVersion: V
            }), G.test(e.name) && S(e, {version: H.version})), "copy" === e.type && (e.clipboardData = {
                setData: Ue.setData,
        ...
        if (e && /^_(?:click|mouse(?:over|out|down|up|move))$/.test(e.type)) {
            var n = e.target, i = "_mouseover" === e.type && e.relatedTarget ? e.relatedTarget : t, o = "_mouseout" === e.type && e.relatedTarget ? e.relatedTarget : t, s = He(n), l = r.screenLeft || r.screenX || 0, u = r.screenTop || r.screenY || 0, c = a.body.scrollLeft + a.documentElement.scrollLeft, d = a.body.scrollTop + a.documentElement.scrollTop, f = s.left + ("number" == typeof e._stageX ? e._stageX : 0), h = s.top + ("number" == typeof e._stageY ? e._stageY : 0), p = f - c, m = h - d, g = l + p, v = u + m, y = "number" == typeof e.movementX ? e.movementX : 0, b = "number" == typeof e.movementY ? e.movementY : 0;
        ...
        if ("object" == typeof e && e && e.type) {
            var t = ve(e), n = j["*"] || [], i = j[e.type] || [], o = n.concat(i);
            if (o && o.length) {
                var a, s, l, u, c, d = this;
                for (a = 0, s = o.length; s > a; a++)l = o[a], u = d, "string" == typeof l && "function" == typeof r[l] && (l = r[l]), "object" == typeof l && l && "function" == typeof l.handleEvent && (u = l, l = l.handleEvent), "function" == typeof l && (c = S({}, e), ye(l, u, [c], t))
            }
            return this
        }
    }, xe = function (e) {
        var t = null;
        return (W === !1 || e && "error" === e.type && e.name && -1 !== X.indexOf(e.name)) && (t = !1), t
    }, we = function (e) {
        var t = e.target || i || null, r = "swf" === e._source;
        switch (delete e._source, e.type) {
            ...
            case"aftercopy":
                ...
                break;
            case"_mouseover":
                Ue.focus(t), K.bubbleEvents === !0 && r && (t && t !== e.relatedTarget && !O(e.relatedTarget, t) && ke(S({}, e, {
                    type: "mouseenter",
                    bubbles: !1,
                    cancelable: !1
                })), ke(S({}, e, {type: "mouseover"})));
                break;
            case"_mouseout":
                Ue.blur(), K.bubbleEvents === !0 && r && (t && t !== e.relatedTarget && !O(e.relatedTarget, t) && ke(S({}, e, {
                    type: "mouseleave",
                    bubbles: !1,
                    cancelable: !1
                })), ke(S({}, e, {type: "mouseout"})));
                break;
            case"_mousedown":
                Ne(t, K.activeClass), K.bubbleEvents === !0 && r && ke(S({}, e, {type: e.type.slice(1)}));
                break;
            case"_mouseup":
                Re(t, K.activeClass), K.bubbleEvents === !0 && r && ke(S({}, e, {type: e.type.slice(1)}));
                break;
            case"_click":
                o = null, K.bubbleEvents === !0 && r && ke(S({}, e, {type: e.type.slice(1)}));
                break;
            case"_mousemove":
                K.bubbleEvents === !0 && r && ke(S({}, e, {type: e.type.slice(1)}))
        }
        ...
        if (e && "string" == typeof e.type && e) {
            var t, n = e.target || null, i = n && n.ownerDocument || a, o = {
        ...
        if ("number" == typeof e && e >= 0) {
            ...
            $ = c(function () {
                Ve(a.getElementById(n)) && (je(), H.deactivated = null, Ue.emit({type: "error", name: "swf-not-found"}))
            }, t)
        }
    }, _e = function () {
        ...
        var e, t = H.bridge, n = Se(t);
        if (!t) {
            var i = Le(r.location.host, K), o = "never" === i ? "none" : "all", s = Pe(S({jsVersion: Ue.version}, K)), l = K.swfPath + Oe(K.swfPath, K);
            n = _e();
            var u = a.createElement("div");
            n.appendChild(u), a.body.appendChild(n);
            var c = a.createElement("div"), d = "activex" === H.pluginType;
            c.innerHTML = '<object id="' + K.swfObjectId + '" name="' + K.swfObjectId + '" width="100%" height="100%" ' + (d ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"' : 'type="application/x-shockwave-flash" data="' + l + '"') + ">" + (d ? '<param name="movie" value="' + l + '"/>' : "") + '<param name="allowScriptAccess" value="' + i + '"/><param name="allowNetworking" value="' + o + '"/><param name="menu" value="false"/><param name="wmode" value="transparent"/><param name="flashvars" value="' + s + '"/><div id="' + K.swfObjectId + '_fallbackContent">&nbsp;</div></object>', t = c.firstChild, c = null, T(t).ZeroClipboard = Ue, n.replaceChild(t, u), Te()
        }
        ...
        if ("object" == typeof e && e) {
            for (var i in e)if (i && C.call(e, i) && "string" == typeof e[i] && e[i])switch (i.toLowerCase()) {
                case"text/plain":
                case"text":
                case"air:text":
                case"flash:text":
        ...
        var n = {};
        for (var i in e)if (C.call(e, i))if ("errors" === i) {
            n[i] = e[i] ? e[i].slice() : [];
            for (var o = 0, r = n[i].length; r > o; o++)n[i][o].format = t[n[i][o].format]
        } else if ("success" !== i && "data" !== i)n[i] = e[i]; else {
            n[i] = {};
            var a = e[i];
        ...
        var t, n, i, o, a = "", s = [];
        if (e.trustedDomains && ("string" == typeof e.trustedDomains ? o = [e.trustedDomains] : "object" == typeof e.trustedDomains && "length" in e.trustedDomains && (o = e.trustedDomains)), o && o.length)for (t = 0, n = o.length; n > t; t++)if (C.call(o, t) && o[t] && "string" == typeof o[t]) {
        ...
        var e = function (e) {
            ...
            for (t = 0, n = e.length; n > t; t++)if (C.call(e, t) && (i = Me(e[t]))) {
                if ("*" === i) {
                    o.length = 0, o.push("*");
                    break
                }
        ...
        if (e.getBoundingClientRect) {
            var n = e.getBoundingClientRect(), i = r.pageXOffset, o = r.pageYOffset, s = a.documentElement.clientLeft || 0, l = a.documentElement.clientTop || 0, u = 0, c = 0;
            if ("relative" === We(a.body, "position")) {
                var d = a.body.getBoundingClientRect(), f = a.documentElement.getBoundingClientRect();
                u = d.left - f.left || 0, c = d.top - f.top || 0
            }
            t.left = n.left + i - s - u, t.top = n.top + o - l - c, t.width = "width" in n ? n.width : n.right - n.left, t.height = "height" in n ? n.height : n.bottom - n.top
        }
        return t
    }, Ve = function (e) {
        if (!e)return !1;
        var t = f(e, null);
        if (!t)return !1;
        var n = v(t.height) > 0, i = v(t.width) > 0, o = v(t.top) >= 0, r = v(t.left) >= 0, a = n && i && o && r, s = a ? null : He(e);
        ...
        if (t = t === !0, W === !1)a = !1; else {
            try {
                i = e.frameElement || null
            } catch (e) {
                o = {name: e.name, message: e.message}
            }
        ...
        var o, r, a, l = !1, u = !1, c = !1, d = "";
        if (s.plugins && s.plugins.length)o = s.plugins["Shockwave Flash"], i(o), s.plugins["Shockwave Flash 2.0"] && (l = !0, d = "2.0.0.11"); else if (s.mimeTypes && s.mimeTypes.length)a = s.mimeTypes["application/x-shockwave-flash"], o = a && a.enabledPlugin, i(o); else if (void 0 !== e) {
            u = !0;
            try {
        ...
        H.disabled = l !== !0, H.outdated = d && v(d) < v(V), H.version = d || "0.0.0", H.pluginType = c ? "pepper" : u ? "activex" : l ? "netscape" : "unknown"
    };
    Xe(p), Ye(!0);
    var Ue = function () {
    ...
    var et = function (e) {
        ...
        var o, r, a, s = {}, l = Ge[this.id], u = l && l.handlers;
        if (!l)throw new Error("Attempted to add new listener(s) to a destroyed ZeroClipboard client instance");
        if ("string" == typeof e && e)a = e.toLowerCase().split(/\s+/); else if ("object" == typeof e && e && void 0 === i)for (o in e)C.call(e, o) && "string" == typeof o && o && "function" == typeof e[o] && this.on(o, e[o]);
        if (a && a.length) {
            for (o = 0, r = a.length; r > o; o++)e = a[o].replace(/^on/, ""), s[e] = !0, u[e] || (u[e] = []), u[e].push(i);
        ...
        var n, i, o, r, a, s = Ge[this.id], l = s && s.handlers;
        if (!l)return this;
        if (0 === arguments.length)r = x(l); else if ("string" == typeof e && e)r = e.split(/\s+/); else if ("object" == typeof e && e && void 0 === t)for (n in e)C.call(e, n) && "string" == typeof n && n && "function" == typeof e[n] && this.off(n, e[n]);
        if (r && r.length)for (n = 0, i = r.length; i > n; n++)if (e = r[n].toLowerCase().replace(/^on/, ""), (a = l[e]) && a.length)if (t)for (o = a.indexOf(t); -1 !== o;)a.splice(o, 1), o = a.indexOf(t, o); else a.length = 0;
        return this
    }, it = function (e) {
        var t = null, n = Ge[this.id] && Ge[this.id].handlers;
        return n && (t = "string" == typeof e && e ? n[e] ? n[e].slice(0) : [] : E(n)), t
    }, ot = function (e) {
        if (ut.call(this, e)) {
            "object" == typeof e && e && "string" == typeof e.type && e.type && (e = S({}, e));
            var t = S({}, pe(e), {client: this});
            ct.call(this, t)
        }
        return this
    }, rt = function (e) {
        ...
        for (var t = 0; t < e.length; t++)if (C.call(e, t) && e[t] && 1 === e[t].nodeType) {
            ...
            var n = Ge[this.id] && Ge[this.id].elements;
        ...
        for (var o = e.length; o--;)if (C.call(e, o) && e[o] && 1 === e[o].nodeType) {
            for (n = 0; -1 !== (n = i.indexOf(e[o], n));)i.splice(n, 1);
            var r = Ze[e[o].zcClippingId];
            if (r) {
                for (n = 0; -1 !== (n = r.indexOf(this.id, n));)r.splice(n, 1);
                0 === r.length && (K.autoActivate === !0 && ht(e[o]), delete e[o].zcClippingId)
            }
        }
        return this
    }, st = function () {
        ...
        var t = Ge[this.id], n = t && t.elements, i = !!n && n.length > 0, o = !e.target || i && -1 !== n.indexOf(e.target), r = e.relatedTarget && i && -1 !== n.indexOf(e.relatedTarget), a = e.client && e.client === this;
        return !(!t || !(o || r || a))
    }, ct = function (e) {
        var t = Ge[this.id];
        if ("object" == typeof e && e && e.type && t) {
            var n = ve(e), i = t && t.handlers["*"] || [], o = t && t.handlers[e.type] || [], a = i.concat(o);
            if (a && a.length) {
                var s, l, u, c, d, f = this;
                for (s = 0, l = a.length; l > s; s++)u = a[s], c = f, "string" == typeof u && "function" == typeof r[u] && (u = r[u]), "object" == typeof u && u && "function" == typeof u.handleEvent && (c = u, u = u.handleEvent), "function" == typeof u && (d = S({}, e), ye(u, c, [d], n))
            }
        }
    }, dt = function (e) {
    ...
    e.extend(e.fn, {
            ...
            if (t)switch (i = e.data(u.form, "validator").settings, o = i.rules, r = e.validator.staticRules(u), t) {
                ...
                case"remove":
                    return n ? (l = {}, e.each(n.split(/\s/), function (t, n) {
                        l[n] = r[n], delete r[n], "required" === n && e(u).removeAttr("aria-required")
                    }), l) : (delete o[u.name], r)
            }
        ...
        prototype: {
            init: function () {
                function t(t) {
                    var n = e.data(this[0].form, "validator"), i = "on" + t.type.replace(/^validate/, ""), o = n.settings;
        ...
        methods: {
            required: function (t, n, i) {
                ...
                return this.settings.messages[n.name] || (this.settings.messages[n.name] = {}), a.originalMessage = this.settings.messages[n.name].remote, this.settings.messages[n.name].remote = a.message, i = "string" == typeof i && {url: i} || i, a.old === t ? a.valid : (a.old = t, o = this, this.startRequest(n), r = {}, r[n.name] = t, e.ajax(e.extend(!0, {
                    url: i,
                    mode: "abort",
                    ...
                    success: function (i) {
                        var r, s, l, u = i === !0 || "true" === i;
                        o.settings.messages[n.name].remote = a.originalMessage, u ? (l = o.formSubmitted, o.prepareElement(n), o.formSubmitted = l, o.successList.push(n), delete o.invalid[n.name], o.showErrors()) : (r = {}, s = i || o.defaultMessage(n, "remote"), r[n.name] = a.message = e.isFunction(s) ? s(t) : s, o.invalid[n.name] = !0, o.showErrors(r)), a.valid = u, o.stopRequest(n, u)
                    }
                }, i)), "pending")
            }
        }
